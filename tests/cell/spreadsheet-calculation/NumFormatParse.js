...
$(function () {
    ...
    QUnit.test('formatRecognitionWithSelectedFormat', function (assert) {
        let testCases = [
            ...
            // ["1/2", "m/d/yyyy", 45659, formatTypes.Date, "yyyy-mm-dd"],
            // ["3/4", "m/d/yyyy", 45720, formatTypes.Date, "yyyy-mm-dd"],
            // ["15/20", null, "15/20", formatTypes.Date, "yyyy-mm-dd"], 
            // [" 1/2", null, " 1/2", formatTypes.Date, "yyyy-mm-dd"],
            // ["1 1/2", "# ?/?", 1.5, formatTypes.Date, "yyyy-mm-dd"],
            // ["2 3/4", "# ?/?", 2.75, formatTypes.Date, "yyyy-mm-dd"],
            // ["15/3", null, "15/3", formatTypes.Date, "yyyy-mm-dd"],
            // ["150/200", null, "150/200", formatTypes.Date, "yyyy-mm-dd"],
            // ["1/5/5", "m/d/yyyy", 38357, formatTypes.Date, "yyyy-mm-dd"],
            // ["0 1/2", "# ?/?", 0.5, formatTypes.Date, "yyyy-mm-dd"],
            // ["0 1/10", "# ??/??", 0.1, formatTypes.Date, "yyyy-mm-dd"],
            // ["0 1/100", "# ??/??", 0.01, formatTypes.Date, "yyyy-mm-dd"],
