...
$(function () {
    ...
    QUnit.test('formatRecognitionWithSelectedFormat', function (assert) {
        let testCases = [
            ...
            ["2 3/4", "# ?/?", 2.75, 0],
            ["15/3", null, "15/3", 0],
            ["150/200", null, "150/200", 0],
            ["1/5/5", "m/d/yyyy", 38357, 0],
            ["0 1/2", "# ?/?", 0.5, 0],
            ["0 1/10", "# ??/??", 0.1, 0],
            ["0 1/100", "# ??/??", 0.01, 0],
            ...
            ["1/2", "m/d/yyyy", 45658, 5],
            ["3/4", "m/d/yyyy", 45719, 5],
            ["15/20", "m/d/yyyy", "15/20", 5], 
            [" 1/2", "m/d/yyyy", " 1/2", 5],
            ["1 1/2", "# ?/?", 1.5, 5],
            ["2 3/4", "# ?/?", 2.75, 5],
            ["15/3", "m/d/yyyy", "15/3", 5],
            ["150/200", "m/d/yyyy", "150/200", 5],
            ["1/5/5", "m/d/yyyy", 38357, 5],
            ["0 1/2", "# ?/?", 0.5, 5],
            ["0 1/10", "# ??/??", 0.1, 5],
            ["0 1/100", "# ??/??", 0.01, 5],
            
            // appliedFormat = 6 (LongDate - dddd, mmmm d, yyyy)
            ["1/2", "dddd, mmmm d, yyyy", 45658, 6],
            ["3/4", "dddd, mmmm d, yyyy", 45719, 6],
            ["15/20", "dddd, mmmm d, yyyy", "15/20", 6],
            [" 1/2", "dddd, mmmm d, yyyy", " 1/2", 6],
            ["1 1/2", "dddd, mmmm d, yyyy", 1, 6],
            ["2 3/4", "dddd, mmmm d, yyyy", 2, 6],
            ["15/3", "dddd, mmmm d, yyyy", "15/3", 6],
            ["150/200", "dddd, mmmm d, yyyy", "150/200", 6],
            ["1/5/5", "dddd, mmmm d, yyyy", 38357, 6],
            ["0 1/2", "dddd, mmmm d, yyyy", 0, 6], 
            ["0 1/10", "dddd, mmmm d, yyyy", 0, 6],   
            ["0 1/100", "dddd, mmmm d, yyyy", 0, 6],  
            
            // appliedFormat = 7 (Time - h:mm:ss)
            ["1/2", "d-mmm", 45659, 7],
            ["3/4", "d-mmm", 45720, 7],
            ["15/20", "h:mm:ss", "15/20", 7],
            [" 1/2", "h:mm:ss", " 1/2", 7],
            ["1 1/2", "# ?/?", 1.5, 7],
            ["2 3/4", "# ?/?", 2.75, 7],
            ["15/3", "h:mm:ss", "15/3", 7],
            ["150/200", "h:mm:ss", "150/200", 7],
            ["1/5/5", "m/d/yyyy", 38357, 7],
            ["0 1/2", "# ?/?", 0.5, 7],
            ["0 1/10", "# ??/??", 0.1, 7],
            ["0 1/100", "# ??/??", 0.01, 7],
