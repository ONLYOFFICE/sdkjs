...
$(function () {
	...
	QUnit.test('CSeriesSettings: method prepare for prepare data in UI', function (assert) {
		...
		assert.strictEqual(oSeriesSettings.trend, false, 'oSeriesSettings: "Trend" is detected as "false".');
		clearData(0, 0, 3, 0);
		// Type Date. Date unit - Month. Step - 2.  Vertical. Bug #65671.
		testData = [
			['01/01/1900'],
			['03/01/1900'],
			['05/01/1900'],
		...
		getFilledData(0, 0, 0, 4, testData, [0,0]);
		oSeriesSettings = api.asc_GetSeriesSettings();
		assert.ok(oSeriesSettings, 'Type Date. Date unit - Month. Selected cells: A1:A5. Step - 2. Bug #65671.');
		...
		assert.strictEqual(oSeriesSettings.trend, false, 'oSeriesSettings: "Trend" is detected as "false".');
		clearData(0, 0, 0, 4);
		// Type Date. Date unit - Day. Step - -334.  Horizontal. Bug #65671.
		testData = [
			['01/01/1901', '02/02/1900', '03/01/1900', '04/01/1900']
		];
		getFilledData(0, 0, 4, 0, testData, [0,0]);
		oSeriesSettings = api.asc_GetSeriesSettings();
		assert.ok(oSeriesSettings, 'Type Date. Date unit - Day. Selected cells: A1:E1. Step - -334. Bug #65671.');

		assert.strictEqual(oSeriesSettings.seriesIn, oSeriesInType.rows, 'oSeriesSettings: "Series in" is detected as "Rows".');
		assert.strictEqual(oSeriesSettings.type, oSeriesType.date, 'oSeriesSettings: "Type" is detected as "Date".');
		assert.strictEqual(oSeriesSettings.dateUnit, oSeriesDateUnitType.day, 'oSeriesSettings: "Date unit" is detected as "Day".');
		assert.strictEqual(oSeriesSettings.stepValue, -334, 'oSeriesSettings: "Step" is detected as -334.');
		assert.strictEqual(oSeriesSettings.stopValue, null, 'oSeriesSettings: "Stop value" is detected as empty.');
		assert.strictEqual(oSeriesSettings.trend, false, 'oSeriesSettings: "Trend" is detected as "false".');
		clearData(0, 0, 4, 0);
		// Type Date. Date unit - Day. Step - 60. Vertical. Bug #65671.
		testData = [
			['01/01/1900'],
			['03/01/1900'],
			['05/02/1900'],
		...
		getFilledData(0, 0, 0, 4, testData, [0,0]);
		oSeriesSettings = api.asc_GetSeriesSettings();
		assert.ok(oSeriesSettings, 'Type Date. Date unit - Day. Selected cells: A1:A5. Step - 60. Bug #65671.');
		...
		assert.strictEqual(oSeriesSettings.trend, false, 'oSeriesSettings: "Trend" is detected as "false".');
		clearData(0, 0, 0, 4);
		// Type Date. Date unit - Month. Step - 1. Horizontal. Bug #65671.
		testData = [
			['01/01/1900', '02/01/1900', '03/01/1900', '04/05/1900']
		];
		getFilledData(0, 0, 4, 0, testData, [0,0]);
		oSeriesSettings = api.asc_GetSeriesSettings();
		assert.ok(oSeriesSettings, 'Type Date. Date unit - Month. Selected cells: A1:E1. Step - 1. Bug #65671.');
		...
		assert.strictEqual(oSeriesSettings.trend, false, 'oSeriesSettings: "Trend" is detected as "false".');
		clearData(0, 0, 4, 0);
		// Type Date. Date unit - Month. Step - 1. Vertical. Bug #65671.
		testData = [
			['02/01/1900'],
			['03/01/1900'],
			['01/01/1900']
		...
		getFilledData(0, 0, 0, 3, testData, [0,0]);
		oSeriesSettings = api.asc_GetSeriesSettings();
		assert.ok(oSeriesSettings, 'Type Date. Date unit - Month. Selected cells: A1:D1. Step - 1. Bug #65671.');
