...
(function(window, builder)
{
	...
	ApiDocument.prototype.CreateSection = function(oParagraph)
	{
		if (!(oParagraph instanceof ApiParagraph))
			return null;
		if (oParagraph.Paragraph.LogicDocument !== oParagraph.Paragraph.Parent || !(oParagraph.Paragraph.Parent instanceof AscCommonWord.CDocument) || !oParagraph.Paragraph.Is_UseInDocument())
			return null;
