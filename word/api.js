...
(function (window, document) {
  ...
  var changestype_Paragraph_Properties =
    AscCommon.changestype_Paragraph_Properties;
  ...
  function CHeaderProp(obj) {
    ...
    if (obj) {
      ...
      this.DifferentFirst =
        undefined != obj.DifferentFirst ? obj.DifferentFirst : null;
      this.DifferentEvenOdd =
        undefined != obj.DifferentEvenOdd ? obj.DifferentEvenOdd : null;
      this.LinkToPrevious =
        undefined != obj.LinkToPrevious ? obj.LinkToPrevious : null;
      this.Locked = undefined != obj.Locked ? obj.Locked : false;
      this.StartPageNumber =
        undefined != obj.StartPageNumber ? obj.StartPageNumber : -1;
  ...
  var DocumentPageSize = new (function () {
    this.oSizes = [
      { name: "US Letter", w_mm: 215.9, h_mm: 279.4, w_tw: 12240, h_tw: 15840 },
    ...
    this.getSize = function (widthMm, heightMm) {
      for (var index in this.oSizes) {
        ...
        if (
          Math.abs(widthMm - item.w_mm) < this.sizeEpsMM &&
          Math.abs(heightMm - item.h_mm) < this.sizeEpsMM
        )
          return item;
      }
  ...
  function CContentControlPluginWorker(_api, _docs) {
    ...
    this.checkCurrentSelectionLockCallback = function (isLocked, type) {
      ...
      if (isLocked && type === 0) {
        ...
        LogicDocument.IsSelectionLocked(
          AscCommon.changestype_ContentControl_Properties,
          undefined,
          false,
          false,
          function (isLocked) {
            window.g_asc_plugins.api.__content_control_worker.checkCurrentSelectionLockCallback(
              isLocked,
              1
            );
          }
      ...
      if (0 === type) {
        ...
        if (_current["Url"] !== undefined || _current["Script"] !== undefined) {
          ...
          if (undefined !== _current["Props"]["InternalId"]) {
            _blockStd = LogicDocument.GetContentControl(
              _current["Props"]["InternalId"]
            );
          ...
          AscCommon.readContentControlCommonPr(
            _content_control_pr,
            _current["Props"]
          );
          ...
          // Page Size
          if (
            undefined !== _current["Props"]["PageSizeW"] ||
            undefined !== _current["Props"]["PageSizeH"]
          ) {
          ...
          if (undefined !== _current["Props"]["Orient"]) {
            if (
              _current["Props"]["Orient"] === 0 ||
              _current["Props"]["Orient"] === 1
            ) {
              LogicDocument.Set_DocumentOrientation(
                _current["Props"]["Orient"]
              );
            }
          }
          ...
          // Margins
          if (
            undefined !== _current["Props"]["MarginT"] ||
            undefined !== _current["Props"]["MarginL"] ||
            undefined !== _current["Props"]["MarginR"] ||
            undefined !== _current["Props"]["MarginB"]
          ) {
            var oMargins = {
          ...
          if (null === _blockStd) {
            ...
            if (curPara) {
              ...
              if (paraParent && paraParent.IsBlockLevelSdtContent()) {
                ...
                else paraParent.AddNewParagraph(true);
              } else if (!curPara.IsCursorAtBegin()) {
                LogicDocument.AddNewParagraph(false, true);
              }
            }

            _blockStd = LogicDocument.AddContentControl(
              c_oAscSdtLevelType.Block
            );
          }
        ...
        if (_current["Url"] !== undefined) {
          ...
          this.api.insertDocumentUrlsData = {
            imageMap: null,
            documents: [
              {
                url: _current["Url"],
              ...
              AscCommon.loadFileContent(
                ...
                function (httpRequest) {
                  ...
                  _api.asc_PasteData(
                    ...
                    true,
                    function () {
                      _api.WordControl.m_oLogicDocument.MoveCursorRight(
                        false,
                        false,
                        true
                      );
                      ...
                      if (_api.insertDocumentUrlsData.documents.length > 0) {
                        var options = new Asc.asc_CDownloadOptions(
                          Asc.c_oAscFileType.CANVAS_WORD
                        );
            ...
            endCallback: function (_api) {
              if (_isReplaced) _blockStd.MoveCursorToContentControl(false);
              else _blockStd.MoveCursorOutsideForm(false);

              var _worker = _api.__content_control_worker;
              if (_worker.documents[_worker.current]["Props"])
                _blockStd.SetContentControlPr({
                  Lock: _worker.documents[_worker.current]["Props"]["Lock"],
                });
              _worker = null;
              _blockStd = null;
          ...
          AscCommon.Check_LoadingDataBeforePrepaste(
            window.g_asc_plugins.api,
            _fonts,
            _images,
            function () {
              var _api = window.g_asc_plugins.api;
              _api.WordControl.m_oLogicDocument.Reassign_ImageUrls(
      ...
      if (1 === type) {
        if (
          _current["Props"] &&
          _current["Url"] === undefined &&
          _current["Script"] === undefined
        ) {
          // change properties
          var _blockStd = LogicDocument.GetContentControl(
            _current["Props"]["InternalId"]
          );
    ...
    this.run = function () {
      ...
      var _current = this.documents[this.current];
      if (undefined === _current["Props"]) _current["Props"] = {};

      var _internalId = _current["Props"]["InternalId"];
      var _contentControl = _internalId
        ? g_oTableId.Get_ById(_internalId)
        : null;
      if (
        (_current["Url"] !== undefined || _current["Script"] !== undefined) &&
        _contentControl
      ) {
        LogicDocument.IsSelectionLocked(
          AscCommon.changestype_None,
          {
          ...
          false,
          false,
          private_CheckLockCallback
        );
      } else {
        LogicDocument.IsSelectionLocked(
          AscCommon.changestype_Document_Content_Add,
          undefined,
          false,
          false,
          private_CheckLockCallback
    ...
    this.delete = function () {
      ...
      for (var i = 0; i < this.documents.length; i++) {
        var oContentControl = g_oTableId.Get_ById(
          this.documents[i]["InternalId"]
        );
        if (
          oContentControl &&
          ...
          arrContentControl.push(
            g_oTableId.Get_ById(this.documents[i]["InternalId"])
          );
      }
      ...
      if (
        false ===
        LogicDocument.Document_Is_SelectionLocked(AscCommon.changestype_None, {
          Type: AscCommon.changestype_2_ElementsArray_and_Type,
  ...
  function asc_docs_api(config) {
    ...
    this.headingsColor = config["headings-color"]
  ...
  asc_docs_api.prototype.getEditorErrorInfo = function () {
    ...
    if (!logicDocument) return "DocumentInfo: no logic document";
  ...
  asc_docs_api.prototype.SetCollaborativeMarksShowType = function (Type) {
    if (
      c_oAscCollaborativeMarksShowType.None !==
        this.CollaborativeMarksShowType &&
      c_oAscCollaborativeMarksShowType.None === Type &&
      this.WordControl &&
  ...
  asc_docs_api.prototype.isLongAction = function () {
    if (this.WordControl.m_oLogicDocument)
      return (
        ...
        this.WordControl.m_oLogicDocument.IsActionStarted()
      );
  ...
  asc_docs_api.prototype.asc_getCanUndo = function () {
    if (!this.canUndoRedoByRestrictions()) return false;

    if (AscCommon.History.Can_Undo()) return true;

    if (
      AscCommon.CollaborativeEditing &&
      AscCommon.CollaborativeEditing.Is_Fast() &&
  ...
  asc_docs_api.prototype.sync_ChangeLastSelectedElement = function (type, obj) {
    ...
    if (!bIsFound) {
      this.SelectedObjectsStack[this.SelectedObjectsStack.length] =
        new asc_CSelectedObject(type, oUnkTypeObj);
    }
  };
  ...
  asc_docs_api.prototype.SetReaderModeOnly = function () {
    ...
    if (this.ImageLoader) this.ImageLoader.bIsAsyncLoadDocumentImages = false;
  };
  ...
  asc_docs_api.prototype.SetMobileTopOffset = function (
    offset,
    offsetScrollTop
  ) {
    if (!this.WordControl) {
      this.startMobileOffset = {
        offset: offset,
...
background-repeat: no-repeat;\
  ...
  asc_docs_api.prototype.CreateComponents = function () {
    ...
    if (this.HtmlElement != null)
      this.HtmlElement.innerHTML =
        '<div id="id_main" class="block_elem" style="touch-action:none;-ms-touch-action: none;-moz-user-select:none;-khtml-user-select:none;user-select:none;background-color:' +
        AscCommon.GlobalSkin.BackgroundColor +
        ';overflow:hidden;" UNSELECTABLE="on">\
								<div id="id_panel_left" class="block_elem">\
                                    ...
                                    <div id="id_main_view" class="block_elem" style="touch-action:none;overflow:hidden">\
                                        <canvas id="id_viewer" class="block_elem" style="touch-action:none;-ms-touch-action: none;-webkit-user-select: none; background-color:' +
        AscCommon.GlobalSkin.BackgroundColor +
        ';z-index:1"></canvas>\
									...
									<div id="id_panel_right" class="block_elem" style="touch-action:none;margin-right:1px;background-color:' +
        AscCommon.GlobalSkin.ScrollBackgroundColor +
        ';">\
									...
									<div id="id_horscrollpanel" class="block_elem" style="touch-action:none;margin-bottom:1px;background-color:' +
        AscCommon.GlobalSkin.ScrollBackgroundColor +
        ';">\
  ...
  asc_docs_api.prototype.asc_setSkin = function (theme) {
    ...
    if (obj_id_main) {
      ...
      document.getElementById("id_viewer").style.backgroundColor =
        AscCommon.GlobalSkin.BackgroundColor;
      document.getElementById("id_panel_right").style.backgroundColor =
        AscCommon.GlobalSkin.ScrollBackgroundColor;
      document.getElementById("id_horscrollpanel").style.backgroundColor =
        AscCommon.GlobalSkin.ScrollBackgroundColor;
    }
    ...
    if (this.WordControl && this.WordControl.m_oBody) {
      ...
      if (
        this.WordControl.m_oEditor &&
        this.WordControl.m_oEditor.HtmlElement
      ) {
  ...
  asc_docs_api.prototype.GetCopyPasteDivId = function () {
    if (this.isMobileVersion) return this.WordControl.Name;
    return "";
  };

  asc_docs_api.prototype.ContentToHTML = function () {
    if (!this.WordControl || !this.WordControl.m_oLogicDocument) return "";
  ...
  asc_docs_api.prototype.InitEditor = function () {
    this.WordControl.m_oLogicDocument = new AscCommonWord.CDocument(
      this.WordControl.m_oDrawingDocument
    );
    this.WordControl.m_oDrawingDocument.m_oLogicDocument =
      this.WordControl.m_oLogicDocument;
    if (
      !this.isSpellCheckEnable ||
      this.isRestrictionComments() ||
      this.isRestrictionForms()
    )
      this.WordControl.m_oLogicDocument.TurnOffSpellCheck();

    if (this.WordControl.MobileTouchManager)
      this.WordControl.MobileTouchManager.delegate.LogicDocument =
        this.WordControl.m_oLogicDocument;
  ...
  asc_docs_api.prototype.canUndoRedoByRestrictions = function () {
    ...
    return (
      ...
      this.isRestrictionComments() ||
      this.isRestrictionForms() ||
      this.isRestrictionView()
    );
  };

  asc_docs_api.prototype["asc_setViewerThumbnailsZoom"] = function (value) {
    if (
      this.WordControl.m_oDrawingDocument.m_oDocumentRenderer &&
      this.WordControl.m_oDrawingDocument.m_oDocumentRenderer.Thumbnails
    )
      this.WordControl.m_oDrawingDocument.m_oDocumentRenderer.Thumbnails.setZoom(
        value
      );
  };
  asc_docs_api.prototype["asc_setViewerThumbnailsUsePageRect"] = function (
    value
  ) {
    if (
      this.WordControl.m_oDrawingDocument.m_oDocumentRenderer &&
      ...
      this.WordControl.m_oDrawingDocument.m_oDocumentRenderer.Thumbnails.setIsDrawCurrentRect(
        value
      );
  };
  ...
  asc_docs_api.prototype["asc_setViewerTargetType"] =
  ...
  function AfterOpenDocument(data, size) {
    ...
    AscCommon.pptx_content_loader.CheckImagesNeeds(
      this.WordControl.m_oLogicDocument
    );
    ...
    //callback
    editor.DocumentOrientation =
      null == editor.WordControl.m_oLogicDocument
        ? true
        : !editor.WordControl.m_oLogicDocument.Orientation;
    var sizeMM;
    if (editor.DocumentOrientation)
      sizeMM = DocumentPageSize.getSize(
        AscCommon.Page_Width,
        AscCommon.Page_Height
      );
    else
      sizeMM = DocumentPageSize.getSize(
        AscCommon.Page_Height,
  ...
  asc_docs_api.prototype.OpenDocumentFromBin = function (url, gObject) {
    ...
    var openParams = {};
    var oBinaryFileReader = new AscCommonWord.BinaryFileReader(
      this.WordControl.m_oLogicDocument,
      openParams
    );
    if (!oBinaryFileReader.Read(gObject))
      editor.sendEvent(
        "asc_onError",
        c_oAscError.ID.MobileUnexpectedCharCount,
        c_oAscError.Level.Critical
      );

    AfterOpenDocument.call(
      this,
      oBinaryFileReader.stream.data,
      oBinaryFileReader.stream.size
    );
    return true;
  };
  ...
  asc_docs_api.prototype.OpenDocumentFromZipNoInit = function (data) {
    ...
    let reader,
      openParams = {};
    let oBinaryFileReader = new AscCommonWord.BinaryFileReader(
      this.WordControl.m_oLogicDocument,
      openParams
    );
    ...
    this.WordControl.m_oLogicDocument.fromZip(
      jsZlib,
      xmlParserContext,
  ...
  asc_docs_api.prototype.asc_registerCallback = function (name, callback) {
    if (!_callbacks.hasOwnProperty(name)) _callbacks[name] = [];
  ...
  asc_docs_api.prototype.asc_unregisterCallback = function (name, callback) {
    if (_callbacks.hasOwnProperty(name)) {
      for (var i = _callbacks[name].length - 1; i >= 0; --i) {
        if (_callbacks[name][i] == callback) _callbacks[name].splice(i, 1);
      }
    }
  };
  ...
  asc_docs_api.prototype.get_PropertyThemeColors = function () {
    return [
      this._gui_control_colors.Colors,
      this._gui_control_colors.StandartColors,
    ];
  };
  // -------
  ...
  asc_docs_api.prototype._goToComment = function (data) {
    if (this.WordControl && this.WordControl.m_oLogicDocument && data) {
      var commentId =
        this.WordControl.m_oLogicDocument.Comments.GetCommentIdByGuid(data);
      if (commentId) {
  ...
  asc_docs_api.prototype._coAuthoringInitEnd = function () {
    ...
    this.CoAuthoringApi.onCursor = function (e) {
      if (true === AscCommon.CollaborativeEditing.Is_Fast()) {
        t.WordControl.m_oLogicDocument.Update_ForeignCursor(
          e[e.length - 1]["cursor"],
          e[e.length - 1]["user"],
          true,
          e[e.length - 1]["useridoriginal"]
        );
      }
    };
    this.CoAuthoringApi.onConnectionStateChanged = function (e) {
      if (
        true === AscCommon.CollaborativeEditing.Is_Fast() &&
        false === e["state"]
      ) {
    ...
    this.CoAuthoringApi.onLocksAcquired = function (e) {
      if (
        t._coAuthoringCheckEndOpenDocument(t.CoAuthoringApi.onLocksAcquired, e)
      ) {
        return;
      }
    ...
    this.CoAuthoringApi.onLocksReleased = function (e, bChanges) {
      if (
        t._coAuthoringCheckEndOpenDocument(
          t.CoAuthoringApi.onLocksReleased,
          e,
          bChanges
        )
      ) {
      ...
      if (null != Class) {
        ...
        if ("undefined" != typeof Lock) {
          ...
          if (CurType === locktype_Other) {
            ...
            CurType === locktype_Other2 ||
            CurType === locktype_Other3
          ) {
            NewType = locktype_Other2;
          }
    ...
    this.CoAuthoringApi.onSaveChanges = function (e, userId, bFirstLoad) {
      ...
      if (
        t.CollaborativeMarksShowType === c_oAscCollaborativeMarksShowType.None
      ) {
        bUseColor = false;
      }
    ...
    this.CoAuthoringApi.onChangesIndex = function (changesIndex) {
      let count =
        AscCommon.CollaborativeEditing.GetAllChangesCount() - changesIndex;
      if (count < 0) {
    ...
    this.CoAuthoringApi.onRecalcLocks = function (e) {
      if (e && true === AscCommon.CollaborativeEditing.Is_Fast()) {
        AscCommon.CollaborativeEditing.UpdateForeignCursorByAdditionalInfo(
          JSON.parse(e)
        );
      }
    };
  ...
  asc_docs_api.prototype.startCollaborationEditing = function () {
    ...
    if (
      ...
      AscCommon.CollaborativeEditing.m_bFast
    ) {
  ...
  asc_docs_api.prototype.SpellCheck_CallBack = function (Obj) {
    if (undefined != Obj && undefined != Obj["ParagraphId"]) {
      ...
      if (null != Paragraph) {
        ...
        this.WordControl.m_oLogicDocument.Spelling.RemoveWaitingParagraphById(
          ParaId
        );
      }
    }
  ...
  asc_docs_api.prototype._onUpdateDocumentCanSave = function () {
    ...
    var isCanSave =
      ...
      (true !== CollEditing.Is_SingleUser() &&
        0 !== CollEditing.getOwnLocksLength());
  ...
  asc_docs_api.prototype.put_FramePr = function (Obj) {
    if (undefined != Obj.FontFamily) {
      ...
      var isasync = loader.LoadFont(
        fontinfo,
        editor.asyncFontEndLoaded_DropCap,
        Obj
      );
      Obj.FontFamily = new asc_CTextFontFamily({
        Name: fontinfo.Name,
        Index: -1,
      });
      ...
      if (false === isasync) {
        if (
          false ===
          this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
            changestype_Paragraph_Properties
          )
        ) {
          this.WordControl.m_oLogicDocument.StartAction(
            AscDFH.historydescription_Document_SetFramePrWithFontFamily
          );
      ...
      if (
        ...
        this.WordControl.m_oLogicDocument.StartAction(
          AscDFH.historydescription_Document_SetFramePr
        );
        this.WordControl.m_oLogicDocument.SetParagraphFramePr(Obj);
        this.WordControl.m_oLogicDocument.FinalizeAction();
      }
  ...
  asc_docs_api.prototype.asyncFontEndLoaded_DropCap = function (Obj) {
    this.sync_EndAction(
      c_oAscAsyncActionType.Information,
      c_oAscAsyncAction.LoadFont
    );
    if (
      false ===
      this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetFramePrWithFontFamilyLong
      );
      this.WordControl.m_oLogicDocument.SetParagraphFramePr(Obj);
      this.WordControl.m_oLogicDocument.FinalizeAction();
    }
  ...
  asc_docs_api.prototype.select_Element = function (Index) {
    ...
    if (true === Document.Selection.Use) Document.RemoveSelection();
    ...
    Document.Content[Index].Selection.StartPos =
      Document.Content[Index].Internal_GetStartPos();
    Document.Content[Index].Selection.EndPos =
      Document.Content[Index].Content.length - 1;
  ...
  asc_docs_api.prototype.UpdateParagraphProp = function (ParaPr) {
    ...
    if (undefined !== ParaPr.FramePr && undefined !== ParaPr.FramePr.Wrap) {
      ...
      else ParaPr.FramePr.Wrap = undefined;
    }
    ...
    if (undefined === bidi) {
      let paragraph = logicDocument.GetCurrentParagraph(false, false, {
        FirstInSelection: true,
      });
      bidi = paragraph ? paragraph.GetParagraphBidi() : undefined;

      ParaPr.Jc = undefined;
    } else if (bidi) {
      if (AscCommon.align_Left === ParaPr.Jc) ParaPr.Jc = AscCommon.align_Right;
  ...
  asc_docs_api.prototype._printDesktop = function (options) {
    ...
    if (options && options.advancedOptions)
      desktopOptions["nativeOptions"] =
        options.advancedOptions.asc_getNativeOptions();
    ...
    if (!this.isPdfEditor()) {
      if (
        ...
        Asc.c_oAscPrintType.Selection ===
          options.advancedOptions.asc_getPrintType()
      ) {
        desktopOptions["printOptions"] = { selection: 1 };
      }
      desktopOptions["documentLayout"] = {
  ...
  asc_docs_api.prototype.Undo = function () {
    if (!this.canUndoRedoByRestrictions()) return;
  ...
  asc_docs_api.prototype.Paste = function () {
    if (!this.WordControl.m_oLogicDocument) return false;

    if (AscCommon.g_clipboardBase.IsWorking()) return false;
  ...
  asc_docs_api.prototype.asc_CheckCopy = function (
    _clipboard /* CClipboardData */,
    _formats
  ) {
    if (!this.WordControl.m_oLogicDocument) {
      var _text_object =
        AscCommon.c_oAscClipboardDataFormat.Text & _formats
          ? { Text: "" }
          : null;
      var _html_data =
        this.WordControl.m_oDrawingDocument.m_oDocumentRenderer.Copy(
          _text_object
        );
  ...
  asc_docs_api.prototype.asc_SelectionCut = function () {
    if (AscCommon.CollaborativeEditing.Get_GlobalLock()) return;

    var _logicDoc = this.WordControl.m_oLogicDocument;
    if (!_logicDoc || _logicDoc.IsSelectionEmpty(true)) return;

    if (
      !_logicDoc.IsSelectionLocked(
        AscCommon.changestype_Remove,
        null,
        true,
        _logicDoc.IsFormFieldEditing()
      )
    ) {
  ...
  asc_docs_api.prototype.asc_PasteData = function (
    _format,
    data1,
    data2,
    text_data,
    ...
    if (isPasteImage) oCC = _logicDoc.GetContentControl();

    if (false !== checkLocks) {
      if (oCC && oCC.IsPicture())
        isLocked = _logicDoc.IsSelectionLocked(
          AscCommon.changestype_Image_Properties,
          null,
          true,
          _logicDoc.IsFormFieldEditing()
        );
  ...
  asc_docs_api.prototype.asc_SpecialPasteData = function (props) {
    ...
    if (
      false ===
      _logicDoc.Document_Is_SelectionLocked(
  ...
  asc_docs_api.prototype.asc_specialPasteShowButton = function () {
    ...
    var specialPasteShowOptions = specialPasteHelper.buttonInfo
      ? specialPasteHelper.buttonInfo
      : null;
    if (
      specialPasteShowOptions &&
      null !== specialPasteHelper.showButtonIdParagraph
    ) {
      ...
      specialPasteHelper.buttonInfo.fixPosition = {
        x: _X,
        y: _Y,
        pageNum: _PageNum,
      };
      ...
      var _coord =
        this.WordControl.m_oLogicDocument.DrawingDocument.ConvertCoordsToCursorWR(
          _X,
          _Y,
          _PageNum
        );
  ...
  asc_docs_api.prototype._onSaveCallbackInner = function () {
    ...
    if (
      c_oAscCollaborativeMarksShowType.LastChanges ===
      this.CollaborativeMarksShowType
    ) {
  ...
  asc_docs_api.prototype._autoSaveInner = function () {
    ...
    if (
      ...
      if (
        AscCommon.History.Points &&
        AscCommon.History.Index >= 0 &&
        AscCommon.History.Index < AscCommon.History.Points.length
      ) {
        if (
          _curTime - AscCommon.History.Points[AscCommon.History.Index].Time <
          this.intervalWaitAutoSave
        ) {
          _bIsWaitScheme = true;
        }
      }
      ...
      if (!_bIsWaitScheme) {
        var _interval =
          AscCommon.CollaborativeEditing.m_nUseType <= 0
            ? this.autoSaveGapSlow
  ...
  asc_docs_api.prototype._saveCheck = function () {
    return (
      ...
      !(
        this.WordControl.m_oLogicDocument &&
        this.WordControl.m_oLogicDocument.IsViewModeInReview()
      )
    );
  };
  ...
  asc_docs_api.prototype.asc_DownloadOrigin = function (options) {
    ...
    if (this.isUseNativeViewer && this.isDocumentRenderer()) {
      isCloudLocal = this.isCloudSaveAsLocalToDrawingFormat(
        Asc.c_oAscAsyncAction.DownloadAs,
    ...
    if (changes || this.watermarkDraw) {
      if (changes && isCloudLocal) {
        ...
        this.sync_StartAction(
          Asc.c_oAscAsyncActionType.BlockInteraction,
          Asc.c_oAscAsyncAction.Save
        );

        window["AscDesktopEditor"]["localSaveToDrawingFormat2"](
          this.documentTitle,
          this.DocumentUrl || "",
          "",
          AscCommon.Base64.encode(changes),
          AscCommon.Base64.encode(this.DocumentRenderer.getFileNativeBinary()),
      ...
      (this.documentIsWopi && options.isSaveAs && options.wopiSaveAsPath) ||
      !(this.isUseNativeViewer && this.isDocumentRenderer())
    ) {
      //todo add new server request wopi_putRelativeOrigin
      options.asc_setFileType(
        AscCommon.getFormatByExtention(this.documentFormat)
      );
      this.asc_DownloadAs(options);
      return;
    }
    //скачивание оригинального pdf, djvu, xps
    var downloadType = bIsDownloadEvent
      ? DownloadType.Download
      : DownloadType.None;
    var rData = {
      c: "pathurl",
      title: AscCommon.changeFileExtention(
        this.documentTitle,
        this.documentFormat,
        Asc.c_nMaxDownloadTitleLen
      ),
  ...
  asc_docs_api.prototype.asc_DownloadAsMailMerge = function (
    typeFile,
    StartIndex,
    EndIndex,
    bIsDownload
    ...
    var oDocumentMailMerge =
      this.WordControl.m_oLogicDocument.Get_MailMergedDocument(
        StartIndex,
        EndIndex
      );
  ...
  asc_docs_api.prototype.Resize = function () {
    if (false === this.bInit_word_control) return;
  ...
  asc_docs_api.prototype.SetFontRenderingMode = function (mode) {
    ...
    if (
      AscCommon.g_fontManager2 !== undefined &&
      AscCommon.g_fontManager2 !== null
    )
      AscCommon.g_fontManager2.ClearFontsRasterCache();

    if (this.bInit_word_control) this.WordControl.OnScroll();
  };
  asc_docs_api.prototype.processSavedFile = function (
    url,
    downloadType,
    filetype
  ) {
    ...
    if (this.mailMergeFileData) {
      ...
      AscCommon.loadFileContent(url, function (httpRequest) {
        if (null === httpRequest) {
          t.sendEvent(
            "asc_onError",
            c_oAscError.ID.MailMergeLoadFile,
            c_oAscError.Level.NoCritical
          );
          return;
        }
      ...
      this.insertDocumentUrlsData.convertCallback
    ) {
      this.insertDocumentUrlsData.convertCallback(this, url);
    } else {
      AscCommon.baseEditorsApi.prototype.processSavedFile.call(
        this,
        url,
        downloadType,
        filetype
  ...
  asc_docs_api.prototype.sync_CanUndoCallback = function (canUndo) {
    if (!this.canUndoRedoByRestrictions()) canUndo = false;

    this.sendEvent("asc_onCanUndo", canUndo);
  };
  asc_docs_api.prototype.sync_CanRedoCallback = function (canRedo) {
    if (
      !this.canUndoRedoByRestrictions() ||
      (true === AscCommon.CollaborativeEditing.Is_Fast() &&
        true !== AscCommon.CollaborativeEditing.Is_SingleUser())
    )
      canRedo = false;
  ...
  asc_docs_api.prototype.asc_GetDefaultTableStyles = function () {
    if (!this.WordControl.m_oLogicDocument) return;

    this.WordControl.m_oDrawingDocument.StartTableStylesCheck();
    this.WordControl.m_oDrawingDocument.TableStylesCheckLook =
      new AscCommon.CTableLook(true, true, false, false, true, false);
    this.WordControl.m_oDrawingDocument.EndTableStylesCheck();
  };
  ...
  asc_docs_api.prototype.sync_ChangeActiveHeaderCallback = function (
    position,
    header
  ) {
    this.sendEvent(
      "asc_onChangeActiveHeader",
      position,
      new Asc.CHeader(header)
    );
  };
  ...
  asc_docs_api.prototype.asc_searchEnabled = function (bIsEnabled) {
    if (null != this.WordControl.m_oDrawingDocument.m_oDocumentRenderer) {
      this.WordControl.m_oDrawingDocument.m_oDocumentRenderer.SearchResults.IsSearch =
        bIsEnabled;
  ...
  asc_docs_api.prototype.asc_findText = function (oProps, isNext, callback) {
    ...
    if (null != this.WordControl.m_oDrawingDocument.m_oDocumentRenderer) {
      ...
      if (oViewer.SearchResults.CurrentPage === 0)
        ...
        for (
          var nPage = 0;
          nPage <= oViewer.SearchResults.CurrentPage;
          nPage++
        ) {
          for (
            var nMatch = 0;
            nMatch < oViewer.SearchResults.Pages[nPage].length;
            nMatch++
          ) {
            if (
              nPage == oViewer.SearchResults.CurrentPage &&
              nMatch == oViewer.SearchResults.Current
            )
              break;
            CurMatchIdx++;
          }
      ...
      if (null != Id) this.WordControl.m_oLogicDocument.SelectSearchElement(Id);

      result = SearchEngine.Count;
    }

    if (!isAsync && callback) callback(result);
  ...
  asc_docs_api.prototype.asc_replaceText = function (
    oProps,
    replaceWith,
    isReplaceAll
  ) {
    if (this.asc_GetErrorForReplaceString(replaceWith)) return false;

    if (null == this.WordControl.m_oLogicDocument) return false;

    this.WordControl.m_oLogicDocument.Search(oProps);

    if (true === isReplaceAll)
      this.WordControl.m_oLogicDocument.ReplaceSearchElement(
        replaceWith,
        true,
        -1
      );
  ...
  asc_docs_api.prototype.asc_GetErrorForReplaceString = function (sString) {
    return new AscCommonWord.CSearchPatternEngine().GetErrorForReplaceString(
      sString
    );
  };
  ...
  asc_docs_api.prototype.sync_ReplaceAllCallback = function (
    ReplaceCount,
    OverallCount
  ) {
  ...
  asc_docs_api.prototype.sync_setSearchCurrent = function (
    nCurrent,
    nOverallCount
  ) {
  ...
  asc_docs_api.prototype.put_TextPrFontName = function (name) {
    ...
    if (false === isasync) {
      if (
        false ===
        this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
          AscCommon.changestype_Paragraph_TextProperties
        )
      ) {
        this.WordControl.m_oLogicDocument.StartAction(
          AscDFH.historydescription_Document_SetTextFontName
        );
        this.WordControl.m_oLogicDocument.AddToParagraph(
          new AscCommonWord.ParaTextPr({
            FontFamily: {
              Name: name,
              Index: -1,
            },
  ...
  asc_docs_api.prototype.put_TextPrFontSize = function (size) {
    if (
      ...
      this.WordControl.m_oLogicDocument.AddToParagraph(
        new AscCommonWord.ParaTextPr({ FontSize: Math.min(size, 300) })
      );
      this.WordControl.m_oLogicDocument.Recalculate();
      this.WordControl.m_oLogicDocument.UpdateInterface();
      this.WordControl.m_oLogicDocument.FinalizeAction();
  ...
  asc_docs_api.prototype.put_TextPrBold = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetTextBold
      );
      this.WordControl.m_oLogicDocument.AddToParagraph(
        new AscCommonWord.ParaTextPr({ Bold: value })
      );
      this.WordControl.m_oLogicDocument.Recalculate();
      this.WordControl.m_oLogicDocument.UpdateInterface();
      this.WordControl.m_oLogicDocument.FinalizeAction();
  ...
  asc_docs_api.prototype.put_TextPrItalic = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetTextItalic
      );
      this.WordControl.m_oLogicDocument.AddToParagraph(
        new AscCommonWord.ParaTextPr({ Italic: value })
      );
      this.WordControl.m_oLogicDocument.Recalculate();
      this.WordControl.m_oLogicDocument.UpdateInterface();
      this.WordControl.m_oLogicDocument.FinalizeAction();
  ...
  asc_docs_api.prototype.put_TextPrUnderline = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetTextUnderline
      );
      this.WordControl.m_oLogicDocument.AddToParagraph(
        new AscCommonWord.ParaTextPr({ Underline: value })
      );
      this.WordControl.m_oLogicDocument.Recalculate();
      this.WordControl.m_oLogicDocument.UpdateInterface();
      this.WordControl.m_oLogicDocument.FinalizeAction();
  ...
  asc_docs_api.prototype.put_TextPrDStrikeout = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetTextDStrikeout
      );
      this.WordControl.m_oLogicDocument.AddToParagraph(
        new AscCommonWord.ParaTextPr({
          DStrikeout: value,
  ...
  asc_docs_api.prototype.put_TextPrSpacing = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetTextSpacing
      );
      this.WordControl.m_oLogicDocument.AddToParagraph(
        new AscCommonWord.ParaTextPr({ Spacing: value })
      );
      this.WordControl.m_oLogicDocument.Recalculate();
      this.WordControl.m_oLogicDocument.UpdateInterface();
      this.WordControl.m_oLogicDocument.FinalizeAction();
  ...
  asc_docs_api.prototype.put_TextPrPosition = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetTextPosition
      );
      this.WordControl.m_oLogicDocument.AddToParagraph(
        new AscCommonWord.ParaTextPr({ Position: value })
      );
      this.WordControl.m_oLogicDocument.Recalculate();
      this.WordControl.m_oLogicDocument.UpdateInterface();
      this.WordControl.m_oLogicDocument.FinalizeAction();
  ...
  asc_docs_api.prototype.put_TextPrLang = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetTextLang
      );
      this.WordControl.m_oLogicDocument.AddToParagraph(
        new AscCommonWord.ParaTextPr({ Lang: { Val: value } })
      );
  ...
  asc_docs_api.prototype._addRemoveSpaceBeforeAfterParagraph = function (
    event
  ) {
    let logicDocument = this.private_GetLogicDocument();
    if (!logicDocument) return;
    ...
    logicDocument.StartAction(
      AscDFH.historydescription_Document_AddRemoveBeforeAfterParagraph
    );
  ...
  asc_docs_api.prototype.asc_addSpaceBeforeParagraph = function () {
    this._addRemoveSpaceBeforeAfterParagraph({
      ...
      getNewValue: function (stylePr) {
        ...
        if (stylePr.Spacing.Before > 0.001) val = stylePr.Spacing.Before;
  ...
  asc_docs_api.prototype.asc_addSpaceAfterParagraph = function () {
    this._addRemoveSpaceBeforeAfterParagraph({
      ...
      getNewValue: function (stylePr) {
        let val = 12 * AscCommonWord.g_dKoef_pt_to_mm;
        if (stylePr.Spacing.After > 0.001) val = stylePr.Spacing.After;
  ...
  asc_docs_api.prototype.put_PrLineSpacing = function (Type, Value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphLineSpacing
      );
  ...
  asc_docs_api.prototype.put_LineSpacingBeforeAfter = function (
    type,
    value //"type == 0" means "Before", "type == 1" means "After"
  ) {
    if (
      false ===
      this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphLineSpacingBeforeAfter
      );
      switch (type) {
        case 0: {
  ...
  asc_docs_api.prototype.FontSizeIn = function () {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_IncFontSize
      );
  ...
  asc_docs_api.prototype.FontSizeOut = function () {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_DecFontSize
      );
  ...
  asc_docs_api.prototype.put_Borders = function (Obj) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphBorders
      );
  ...
  asc_docs_api.prototype.sync_TextPrFontFamilyCallBack = function (FontFamily) {
    if (undefined != FontFamily)
      ...
      this.sendEvent(
        "asc_onFontFamily",
        new asc_CTextFontFamily({ Name: "", Index: -1 })
      );
  };
  ...
  asc_docs_api.prototype.asc_getTableStylesPreviews = function (
    ...
    let oDrawingDocument = this.WordControl
      ? this.WordControl.m_oDrawingDocument
      : null;
    let oLogicDocument = this.private_GetLogicDocument();
    if (!oDrawingDocument || !oLogicDocument) return [];
    ...
    if (arrIds && arrIds.length) {
      ...
      arrPreviews =
        this.TableStylesPreviewGenerator.GetAllPreviews(bUseDefault);
    }

    return arrPreviews;
  };
  asc_docs_api.prototype.asc_generateTableStylesPreviews = function (
    bUseDefault
  ) {
    this.private_CheckTableStylesPreviewGenerator();
    this.TableStylesPreviewGenerator.Begin(bUseDefault);
  };
  asc_docs_api.prototype.private_CheckTableStylesPreviewGenerator =
    function () {
      if (!this.TableStylesPreviewGenerator)
        this.TableStylesPreviewGenerator =
          new AscCommon.CTableStylesPreviewGenerator(
            this.private_GetLogicDocument()
          );
    };
  ...
  asc_docs_api.prototype.paraApply = function (Props) {
    ...
    if (
      !oLogicDocument.IsSelectionLocked(
        changestype_Paragraph_Properties,
        arrAdditional
      )
    ) {
      ...
      if (
        "undefined" != typeof Props.ContextualSpacing &&
        null != Props.ContextualSpacing
      )
        this.WordControl.m_oLogicDocument.SetParagraphContextualSpacing(
      ...
      if ("undefined" != typeof Props.KeepLines && null != Props.KeepLines)
        this.WordControl.m_oLogicDocument.SetParagraphKeepLines(
          Props.KeepLines
        );
      ...
      if (undefined != Props.WidowControl && null != Props.WidowControl)
        this.WordControl.m_oLogicDocument.SetParagraphWidowControl(
          Props.WidowControl
        );

      if (
        "undefined" != typeof Props.PageBreakBefore &&
        null != Props.PageBreakBefore
      )
        this.WordControl.m_oLogicDocument.SetParagraphPageBreakBefore(
      ...
      if (undefined !== Props.OutlineLvl)
        this.WordControl.m_oLogicDocument.SetParagraphOutlineLvl(
          Props.OutlineLvl
        );
      ...
      if (Props.Shd) {
        ...
        Unifill.fill.color = AscFormat.CorrectUniColor(
          Props.Shd.Color,
          Unifill.fill.color,
          1
        );
      ...
      if ("undefined" != typeof Props.Brd && null != Props.Brd) {
        if (Props.Brd.Left && Props.Brd.Left.Color) {
          Props.Brd.Left.Unifill = AscFormat.CreateUnifillFromAscColor(
            Props.Brd.Left.Color,
            1
          );
        }
        if (Props.Brd.Top && Props.Brd.Top.Color) {
          Props.Brd.Top.Unifill = AscFormat.CreateUnifillFromAscColor(
            Props.Brd.Top.Color,
            1
          );
        }
        if (Props.Brd.Right && Props.Brd.Right.Color) {
          Props.Brd.Right.Unifill = AscFormat.CreateUnifillFromAscColor(
            Props.Brd.Right.Color,
            1
          );
        }
        if (Props.Brd.Bottom && Props.Brd.Bottom.Color) {
          Props.Brd.Bottom.Unifill = AscFormat.CreateUnifillFromAscColor(
            Props.Brd.Bottom.Color,
            1
          );
        }
        if (Props.Brd.InsideH && Props.Brd.InsideH.Color) {
          Props.Brd.InsideH.Unifill = AscFormat.CreateUnifillFromAscColor(
            Props.Brd.InsideH.Color,
            1
          );
        }
        if (Props.Brd.InsideV && Props.Brd.InsideV.Color) {
          Props.Brd.InsideV.Unifill = AscFormat.CreateUnifillFromAscColor(
            Props.Brd.InsideV.Color,
            1
          );
        }
      ...
      if (undefined != Props.DefaultTab) {
        this.WordControl.m_oLogicDocument.Set_DocumentDefaultTab(
          Props.DefaultTab
        );
      }

      if (undefined !== Props.SuppressLineNumbers)
        oLogicDocument.SetParagraphSuppressLineNumbers(
          Props.SuppressLineNumbers
        );

      if (undefined !== Props.Bidi) oLogicDocument.SetParagraphBidi(Props.Bidi);
      ...
      if (undefined != Props.DStrikeout) {
        ...
        if (true === TextPr.DStrikeout) TextPr.Strikeout = false;
      }
      ...
      if (undefined != Props.AllCaps) {
        ...
        if (true === TextPr.AllCaps) TextPr.SmallCaps = false;
      }

      if (undefined != Props.TextSpacing) TextPr.Spacing = Props.TextSpacing;

      if (undefined != Props.Position) TextPr.Position = Props.Position;

      if (undefined !== Props.Ligatures) TextPr.Ligatures = Props.Ligatures;
  ...
  asc_docs_api.prototype.asc_IsShowListIndentsSettings = function () {
    ...
    if (!oLogicDocument) return false;
  ...
  asc_docs_api.prototype.put_TextPrBaseline = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.AddToParagraph(
        new AscCommonWord.ParaTextPr({ VertAlign: value })
      );
      this.WordControl.m_oLogicDocument.Recalculate();
      this.WordControl.m_oLogicDocument.UpdateInterface();
      this.WordControl.m_oLogicDocument.FinalizeAction();
  ...
  asc_docs_api.prototype.put_ListTypeCustom = function (value) {
    ...
    return new Promise(function (resolve) {
      ...
      if (
        ...
        let num = numPr
          ? logicDocument.GetNumbering().GetNum(numPr.NumId)
          : null;
        if (!num) oRes = null;
        else if (
          (!numInfo.HaveLvl() || numInfo.IsSingleLevel()) &&
          undefined !== numPr.Lvl
        )
          oRes = AscWord.CNumInfo.FromNum(num, numPr.Lvl).ToJson();
        else
          oRes = AscWord.CNumInfo.FromNum(
            num,
            null,
            logicDocument.GetStyles()
          ).ToJson();
      }
      return oRes;
    });
  };
  asc_docs_api.prototype.asc_CompareNumberingPresets = function (
    value1,
    value2
  ) {
    let numInfo1 = AscWord.CNumInfo.Parse(value1);
    let numInfo2 = AscWord.CNumInfo.Parse(value2);
    if (!numInfo1 || !numInfo2) return false;

    return numInfo1.IsEqual(numInfo2);
  };
  asc_docs_api.prototype.asc_IsCurrentNumberingPreset = function (
    value,
    singleLevel
  ) {
    let logicDocument = this.private_GetLogicDocument();
    ...
    if (!numPr || !numPr.IsValid()) return numInfo.IsNone();
  ...
  asc_docs_api.prototype.asc_GetCurrentNumberingJson = function (singleLevel) {
    ...
    return AscWord.CNumInfo.FromNum(
      num,
      singleLevel ? 0 : null,
      logicDocument.GetStyles()
    ).ToJson();
  ...
  asc_docs_api.prototype.asc_GetCurrentNumberingLvl = function () {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    if (!oLogicDocument) return -1;

    var oNumPr = oLogicDocument.GetSelectedNum(true);
    if (!oNumPr || undefined === oNumPr.Lvl || null === oNumPr.Lvl) return -1;
  ...
  asc_docs_api.prototype.asc_AddNewNumbering = function (
    oAscNumbering,
    isApply
  ) {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    ...
    if (isApply) {
      ...
      if (
        oLogicDocument.Document_Is_SelectionLocked(AscCommon.changestype_None, {
          Type: AscCommon.changestype_2_ElementsArray_and_Type,
    ...
    if (arrParagraphs) {
      for (
        var nIndex = 0, nCount = arrParagraphs.length;
        nIndex < nCount;
        ++nIndex
      ) {
        var oPara = arrParagraphs[nIndex];
        var oNumPr = oPara.GetNumPr();
        if (!oNumPr) oPara.ApplyNumPr(sNumId, 0);
        else oPara.ApplyNumPr(sNumId, oNumPr.Lvl);
      }
  ...
  asc_docs_api.prototype.asc_ChangeNumberingLvl = function (
    sNumId,
    oAscNumberingLvl,
    nLvl
  ) {
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_ChangeNumLvl
      );

      if (oAscNumberingLvl instanceof Asc.CAscNumberingLvl) {
        oNum.SetAscLvl(oAscNumberingLvl, nLvl);
      } else if (
        undefined !== oAscNumberingLvl.length &&
        oAscNumberingLvl.length === nLvl.length
      ) {
        for (
          var nIndex = 0, nCount = oAscNumberingLvl.length;
          nIndex < nCount;
          ++nIndex
        ) {
  ...
  asc_docs_api.prototype.asc_SetNumberingLvl = function (nLvl) {
    ...
    if (arrSelectedParagraphs.length <= 0) return;
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetNumberingLvl
      );

      for (
        var nIndex = 0, nCount = arrSelectedParagraphs.length;
        nIndex < nCount;
        ++nIndex
      ) {
        ...
        if (-1 === _nLvl) oParagraph.RemoveNumPr();
        else oParagraph.SetNumPr(oNumPr.NumId, _nLvl);
      }
  ...
  asc_docs_api.prototype.put_Style = function (sName) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphStyle
      );
      this.WordControl.m_oLogicDocument.SetParagraphStyle(sName, true);
      this.WordControl.m_oLogicDocument.FinalizeAction();
    }
  };
  asc_docs_api.prototype.asc_SetParagraphSuppressLineNumbers = function (
    isSuppress
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument) return;
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphSuppressLineNumbers
      );
  ...
  asc_docs_api.prototype.SetDeviceInputHelperId = function (idKeyboard) {
    if (
      ...
      this.WordControl.m_oMainView != null
    ) {
  ...
  asc_docs_api.prototype.put_ShowParaMarks = function (isShow) {
    ...
    if (true === this.isMarkerFormat) this.sync_MarkerFormatCallback(false);
  ...
  asc_docs_api.prototype.put_PageBreak = function (isBreak) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphPageBreakBefore
      );
  ...
  asc_docs_api.prototype.put_KeepNext = function (isKeepNext) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphKeepNext
      );
  ...
  asc_docs_api.prototype.put_LineHighLight = function (is_flag, r, g, b) {
    if (
      ...
      if (false === is_flag) {
        this.WordControl.m_oLogicDocument.StartAction(
          AscDFH.historydescription_Document_SetTextHighlightNone
        );
        this.WordControl.m_oLogicDocument.AddToParagraph(
          new AscCommonWord.ParaTextPr({
            HighLight: AscCommonWord.highlight_None,
          })
        );
        this.WordControl.m_oLogicDocument.FinalizeAction();
      } else {
  ...
  asc_docs_api.prototype.put_TextColor = function (color) {
    ...
    if (
      false ===
      oLogicDocument.Document_Is_SelectionLocked(
        AscCommon.changestype_Paragraph_TextProperties
      )
    ) {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetTextColor
      );

      if (true === color.Auto) {
        oLogicDocument.AddToParagraph(
          new AscCommonWord.ParaTextPr({
            Color: {
              Auto: true,
              r: 0,
        ...
        if (
          color &&
          color.asc_getType &&
          color.asc_getType() === Asc.c_oAscColor.COLOR_TYPE_SRGB
        ) {
          var oColor = new AscCommonWord.CDocumentColor(
            color.r,
            color.g,
            color.b,
            false
          ...
          oLogicDocument.AddToParagraph(
            new AscCommonWord.ParaTextPr({ Color: oColor, Unifill: undefined })
          );
        } else {
          var Unifill = new AscFormat.CUniFill();
          Unifill.fill = new AscFormat.CSolidFill();
          ...
          oLogicDocument.AddToParagraph(
            new AscCommonWord.ParaTextPr({ Unifill: Unifill })
          );
        }
      }
  ...
  asc_docs_api.prototype.put_ParagraphShade = function (
    is_flag,
    color,
    isOnlyPara
  ) {
    if (
      !this.WordControl.m_oLogicDocument.IsSelectionLocked(
        AscCommon.changestype_Paragraph_Properties,
        {
          Type: AscCommon.changestype_2_AdditionalTypes,
          Types: [AscCommon.changestype_Paragraph_TextProperties],
  ...
  asc_docs_api.prototype.put_PrIndent = function (value, levelValue) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphIndent
      );
  ...
  asc_docs_api.prototype.put_ParagraphOutlineLvl = function (nLvl) {
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphOutlineLvl
      );
  ...
  // signatures
  asc_docs_api.prototype.asc_addSignatureLine = function (
    oPr,
    Width,
    Height,
    sImgUrl
    ...
    if (
      ...
      if (sGuid) {
        ...
        var ret = [],
          allSpr = [];
        allSpr = allSpr.concat(
          allSpr.concat(
            oDrawingObjects.getAllSignatures2(
              ret,
              oDrawingObjects.getDrawingArray()
            )
          )
        );
      ...
      if (!oSpToEdit) {
        var oSignature = AscFormat.fCreateSignatureShape(
          oPr,
          true,
          null,
          Width,
        ...
        var Drawing = new AscCommonWord.ParaDrawing(
          oSignature.spPr.xfrm.extX,
          oSignature.spPr.xfrm.extY,
          null,
          this.WordControl.m_oDrawingDocument,
          null,
          null
  ...
  asc_docs_api.prototype.asc_RemoveSignature = function (guid) {
    ...
    if (logicDocument) {
      for (let i = 0; i < this.signatures.length; ++i) {
        ...
        if (sign.guid === guid && sign.isForm) {
          if (
            !logicDocument.IsSelectionLocked(
              AscCommon.changestype_Document_Settings
            )
          ) {
            logicDocument.StartAction(
              AscDFH.historydescription_OForm_CancelFilling
            );
            ...
            this.sendEvent(
              ...
              this.asc_getSignatures(),
              this.asc_getRequestSignatures()
            );
            return true;
          }
        }
    ...
    return AscCommon.baseEditorsApi.prototype.asc_RemoveSignature.apply(
      this,
      arguments
    );
  };
  ...
  asc_docs_api.prototype.put_PrIndentRight = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetParagraphIndentRight
      );
  ...
  asc_docs_api.prototype.put_Margins = function (left, top, right, bottom) {
    this.WordControl.m_oLogicDocument.SetDocumentMargin({
      Left: left,
      Top: top,
      Right: right,
      Bottom: bottom,
  ...
  asc_docs_api.prototype.sync_TextColor = function (TextPr) {
    if (
      TextPr.Unifill &&
      TextPr.Unifill.fill &&
      TextPr.Unifill.fill.type === c_oAscFill.FILL_TYPE_SOLID &&
      TextPr.Unifill.fill.color
    ) {
      this.sendEvent(
        "asc_onTextColor",
        AscCommon.CreateAscColor(TextPr.Unifill.fill.color)
      );
    } else if (undefined != TextPr.Color) {
      this.sendEvent(
        "asc_onTextColor",
        AscCommon.CreateAscColorCustom(
          TextPr.Color.r,
          TextPr.Color.g,
          TextPr.Color.b,
          TextPr.Color.Auto
  ...
  asc_docs_api.prototype.sync_TextHighLight = function (HighLight) {
    if (undefined != HighLight)
      this.sendEvent(
        "asc_onTextHighLight",
        new AscCommon.CColor(HighLight.r, HighLight.g, HighLight.b)
      );
  };
  ...
  asc_docs_api.prototype.sync_ParaSpacingLine = function (SpacingLine) {
    ...
    this.sendEvent(
      ...
      new AscCommon.asc_CParagraphSpacing(SpacingLine)
    );
  };
  ...
  asc_docs_api.prototype.sync_RangePermPropCallback = function (pr) {
    this.sync_ChangeLastSelectedElement(
      Asc.c_oAscTypeSelectElement.UnProtectedRegion,
      pr
    );
  };
  asc_docs_api.prototype.sync_PrPropCallback = function (prProp) {
    ...
    if (_len > 0) {
      if (
        this.SelectedObjectsStack[_len - 1].Type ==
        c_oAscTypeSelectElement.Paragraph
      ) {
        this.SelectedObjectsStack[_len - 1].Value =
          new Asc.asc_CParagraphProperty(prProp);
        return;
      }
    }

    this.SelectedObjectsStack[this.SelectedObjectsStack.length] =
      new asc_CSelectedObject(
        c_oAscTypeSelectElement.Paragraph,
        new Asc.asc_CParagraphProperty(prProp)
      );
  };
  ...
  asc_docs_api.prototype.sync_MathPropCallback = function (MathProp) {
    this.SelectedObjectsStack[this.SelectedObjectsStack.length] =
      new asc_CSelectedObject(c_oAscTypeSelectElement.Math, MathProp);
  };

  asc_docs_api.prototype.sync_EndAddShape = function () {
    editor.sendEvent("asc_onEndAddShape");
    if (
      this.WordControl.m_oDrawingDocument.m_sLockedCursorType == "crosshair"
    ) {
  ...
  asc_docs_api.prototype.SetDrawingFreeze = function (bIsFreeze) {
    ...
    if (!bIsFreeze) this.WordControl.OnScroll();
  };
  ...
  asc_docs_api.prototype["asc_SetMathProps"] =
    asc_docs_api.prototype.asc_SetMathProps;
  //----------------------------------------------------------------------------------------------------------------------
  ...
  asc_docs_api.prototype.change_PageOrient = function (isPortrait) {
    if (
      false ===
      this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
        AscCommon.changestype_Document_SectPr
      )
    ) {
      this.WordControl.m_oLogicDocument.StartAction(
      ...
      if (isPortrait) {
        this.WordControl.m_oLogicDocument.Set_DocumentOrientation(
          Asc.c_oAscPageOrientation.PagePortrait
        );
        this.DocumentOrientation = isPortrait;
      } else {
        this.WordControl.m_oLogicDocument.Set_DocumentOrientation(
          Asc.c_oAscPageOrientation.PageLandscape
        );
        this.DocumentOrientation = isPortrait;
      }
  ...
  asc_docs_api.prototype["asc_SetSectionProps"] =
    asc_docs_api.prototype.asc_SetSectionProps;
  asc_docs_api.prototype["asc_GetSectionProps"] =
    asc_docs_api.prototype.asc_GetSectionProps;
  asc_docs_api.prototype["asc_GetCurrentColumnWidth"] =
    asc_docs_api.prototype.asc_GetCurrentColumnWidth;
  ...
  asc_docs_api.prototype["asc_SetColumnsProps"] =
    asc_docs_api.prototype.asc_SetColumnsProps;
  asc_docs_api.prototype["asc_GetColumnsProps"] =
    asc_docs_api.prototype.asc_GetColumnsProps;

  asc_docs_api.prototype.asc_SetLineNumbersProps = function (
    nApplyType,
    oLineNumbersProps
  ) {
    this.WordControl.m_oLogicDocument.SetLineNumbersProps(
      nApplyType,
      oLineNumbersProps
    );
  };
  ...
  asc_docs_api.prototype["asc_SetLineNumbersProps"] =
    asc_docs_api.prototype.asc_SetLineNumbersProps;
  asc_docs_api.prototype["asc_GetLineNumbersProps"] =
    asc_docs_api.prototype.asc_GetLineNumbersProps;
  ...
  asc_docs_api.prototype.sync_LineNumbersPropsCollback = function (
    oLineNumbersProps
  ) {
    this.sendEvent("asc_onLineNumbersProps", oLineNumbersProps);
  };
  asc_docs_api.prototype.asc_SetFootnoteProps = function (
    oFootnotePr,
    bApplyToAll
  ) {
  ...
  asc_docs_api.prototype.asc_SetEndnoteProps = function (
    oEndnotePr,
    bApplyToAll
  ) {
  ...
  asc_docs_api.prototype["asc_AddFootnote"] =
    asc_docs_api.prototype.asc_AddFootnote;
  asc_docs_api.prototype["asc_RemoveAllFootnotes"] =
    asc_docs_api.prototype.asc_RemoveAllFootnotes;
  asc_docs_api.prototype["asc_GetFootnoteProps"] =
    asc_docs_api.prototype.asc_GetFootnoteProps;
  ...
  asc_docs_api.prototype["asc_IsCursorInFootnote"] =
    asc_docs_api.prototype.asc_IsCursorInFootnote;
  asc_docs_api.prototype["asc_AddEndnote"] =
    asc_docs_api.prototype.asc_AddEndnote;
  asc_docs_api.prototype["asc_GetEndnoteProps"] =
    asc_docs_api.prototype.asc_GetEndnoteProps;
  asc_docs_api.prototype["asc_SetEndnoteProps"] =
    asc_docs_api.prototype.asc_SetEndnoteProps;
  asc_docs_api.prototype["asc_GotoEndnote"] =
    asc_docs_api.prototype.asc_GotoEndnote;
  asc_docs_api.prototype["asc_IsCursorInEndnote"] =
    asc_docs_api.prototype.asc_IsCursorInEndnote;
  asc_docs_api.prototype["asc_ConvertFootnoteType"] =
    asc_docs_api.prototype.asc_ConvertFootnoteType;
  ...
  asc_docs_api.prototype.put_AddPageBreak = function () {
    if (
      ...
      if (null === Document.IsCursorInHyperlink(false)) {
        this.WordControl.m_oLogicDocument.StartAction(
          AscDFH.historydescription_Document_AddPageBreak
        );
        this.WordControl.m_oLogicDocument.AddToParagraph(
          new AscWord.CRunBreak(AscWord.break_Page)
        );
        this.WordControl.m_oLogicDocument.FinalizeAction();
      }
    }
  ...
  asc_docs_api.prototype.put_AddColumnBreak = function () {
    ...
    if (
      ...
      if (null === Document.IsCursorInHyperlink(false)) {
        ...
        this.WordControl.m_oLogicDocument.AddToParagraph(
          new AscWord.CRunBreak(AscWord.break_Column)
        );
        this.WordControl.m_oLogicDocument.FinalizeAction();
      }
    }
  ...
  asc_docs_api.prototype.Update_ParaInd = function (paraInd, isRtl) {
    ...
    if (updateFlag & 2) this.WordControl.UpdateHorRulerBack(true);
    if (updateFlag & 1) this.WordControl.UpdateHorRuler();
  };
  ...
  asc_docs_api.prototype.put_PageNum = function (where, align) {
    ...
    if (where >= 0) {
      if (
        logicDocument.IsSelectionLocked(AscCommon.changestype_None, {
          Type: AscCommon.changestype_2_HdrFtr,
        })
      )
        return;

      logicDocument.StartAction(
        AscDFH.historydescription_Document_AddPageNumToHdrFtr
      );
  ...
  asc_docs_api.prototype.put_HeadersAndFootersDistance = function (value) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetHdrFtrDistance
      );
  ...
  asc_docs_api.prototype.HeadersAndFooters_DifferentFirstPage = function (
    ...
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetHdrFtrFirstPage
      );
  ...
  asc_docs_api.prototype.HeadersAndFooters_DifferentOddandEvenPage = function (
    isOn
  ) {
    if (
      false ===
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetHdrFtrEvenAndOdd
      );
      this.WordControl.m_oLogicDocument.Document_SetHdrFtrEvenAndOddHeaders(
        isOn
      );
      this.WordControl.m_oLogicDocument.FinalizeAction();
    }
  ...
  asc_docs_api.prototype.HeadersAndFooters_LinkToPrevious = function (isOn) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetHdrFtrLink
      );
  ...
  asc_docs_api.prototype.asc_SetSectionStartPage = function (nStartPage) {
    ...
    if (false === oLogicDocument.Document_Is_SelectionLocked()) {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SectionStartPage
      );
  ...
  asc_docs_api.prototype.asc_SetSectionPageNumFormat = function (format) {
    ...
    return new Promise(function (resolve) {
      ...
      if (logicDocument.IsSelectionLocked(AscCommon.changestype_HdrFtr)) return;

      logicDocument.StartAction(
        AscDFH.historydescription_Document_SectionPageNumFormat
      );
  ...
  asc_docs_api.prototype.sync_HeadersAndFootersPropCallback = function (
    hafProp
  ) {
    if (true === hafProp) hafProp.Locked = true;

    this.SelectedObjectsStack[this.SelectedObjectsStack.length] =
      new asc_CSelectedObject(
        c_oAscTypeSelectElement.Header,
        new CHeaderProp(hafProp)
      );
  };
  ...
  asc_docs_api.prototype.put_Table = function (col, row, sStyleId) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_AddTable
      );
  ...
  asc_docs_api.prototype.addRowAbove = function (nCount) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_TableAddRowAbove
      );
  ...
  asc_docs_api.prototype.addColumnLeft = function (nCount) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_TableAddColumnLeft
      );
  ...
  asc_docs_api.prototype.addColumnRight = function (nCount) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_TableAddColumnRight
      );
  ...
  asc_docs_api.prototype.remRow = function () {
    ...
    if (
      !oLogicDocument.Document_Is_SelectionLocked(AscCommon.changestype_Remove)
    ) {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_TableRemoveRow
      );
  ...
  asc_docs_api.prototype.selectColumn = function () {
    this.WordControl.m_oLogicDocument.SelectTable(
      c_oAscTableSelectionType.Column
    );
  };
  asc_docs_api.prototype.selectCell = function () {
    this.WordControl.m_oLogicDocument.SelectTable(
      c_oAscTableSelectionType.Cell
    );
  };
  asc_docs_api.prototype.selectTable = function () {
    this.WordControl.m_oLogicDocument.SelectTable(
      c_oAscTableSelectionType.Table
    );
  };
  asc_docs_api.prototype.setColumnWidth = function (width) {};
  asc_docs_api.prototype.setRowHeight = function (height) {};
  asc_docs_api.prototype.set_TblDistanceFromText = function (
    left,
    top,
    right,
    bottom
  ...
  asc_docs_api.prototype.SplitCell = function (Cols, Rows) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SplitTableCells
      );
  ...
  asc_docs_api.prototype.asc_DistributeTableCells = function (isHorizontally) {
    ...
    if (
      false ===
      oLogicDocument.Document_Is_SelectionLocked(changestype_Table_Properties)
    ) {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_DistributeTableCells
      );
  ...
  asc_docs_api.prototype.asc_RemoveTableCells = function () {
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_RemoveTableCells
      );
      oLogicDocument.RemoveTableCells();
      oLogicDocument.FinalizeAction();
  ...
  asc_docs_api.prototype.put_CellsMargin = function (
    left,
    top,
    right,
    bottom
    ...
    if (
      ...
      if (obj.CellBorders) {
        if (obj.CellBorders.Left && obj.CellBorders.Left.Color) {
          obj.CellBorders.Left.Unifill = AscFormat.CreateUnifillFromAscColor(
            obj.CellBorders.Left.Color,
            1
          );
        }
        if (obj.CellBorders.Top && obj.CellBorders.Top.Color) {
          obj.CellBorders.Top.Unifill = AscFormat.CreateUnifillFromAscColor(
            obj.CellBorders.Top.Color,
            1
          );
        }
        if (obj.CellBorders.Right && obj.CellBorders.Right.Color) {
          obj.CellBorders.Right.Unifill = AscFormat.CreateUnifillFromAscColor(
            obj.CellBorders.Right.Color,
            1
          );
        }
        if (obj.CellBorders.Bottom && obj.CellBorders.Bottom.Color) {
          obj.CellBorders.Bottom.Unifill = AscFormat.CreateUnifillFromAscColor(
            obj.CellBorders.Bottom.Color,
            1
          );
        }
        if (obj.CellBorders.InsideH && obj.CellBorders.InsideH.Color) {
          obj.CellBorders.InsideH.Unifill = AscFormat.CreateUnifillFromAscColor(
            obj.CellBorders.InsideH.Color,
            1
          );
        }
        if (obj.CellBorders.InsideV && obj.CellBorders.InsideV.Color) {
          obj.CellBorders.InsideV.Unifill = AscFormat.CreateUnifillFromAscColor(
            obj.CellBorders.InsideV.Color,
            1
          );
        }
      }
      if (obj.CellsBackground && obj.CellsBackground.Color) {
        obj.CellsBackground.Unifill = AscFormat.CreateUnifillFromAscColor(
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_ApplyTablePr
      );
  ...
  asc_docs_api.prototype.sync_TblPropCallback = function (tblProp) {
    ...
    if (tblProp.CellsBackground && tblProp.CellsBackground.Unifill) {
      ...
      tblProp.CellsBackground.Unifill.check(
        LogicDocument.Get_Theme(),
        LogicDocument.Get_ColorMap()
      );
      var RGBA = tblProp.CellsBackground.Unifill.getRGBAColor();
      tblProp.CellsBackground.Color = new AscCommonWord.CDocumentColor(
        RGBA.R,
        RGBA.G,
        RGBA.B,
        false
    ...
    this.SelectedObjectsStack[this.SelectedObjectsStack.length] =
      new asc_CSelectedObject(
        c_oAscTypeSelectElement.Table,
        new Asc.CTableProp(tblProp)
      );
  };
  ...
  asc_docs_api.prototype._addImageUrl = function (arrUrls, oOptionObject) {
    if (oOptionObject) {
      if (oOptionObject.sendUrlsToFrameEditor && this.isOpenedChartFrame) {
        ...
        oOptionObject.isImageChangeUrl ||
        oOptionObject.isShapeImageChangeUrl ||
        oOptionObject["obj"] ||
        (oOptionObject instanceof AscCommon.CContentControlPr &&
          oOptionObject.GetInternalId()) ||
        oOptionObject.fAfterUploadOleObjectImage
      ) {
    ...
    if (this.ImageLoader) {
      const oApi = this;
      this.ImageLoader.LoadImagesWithCallback(
        arrUrls,
        function () {
          const sContentControlId = oApi.asc_GetCurrentContentControl();
          const oContentControl =
            AscCommon.g_oTableId.Get_ById(sContentControlId);
          if (
            oContentControl &&
            oContentControl.IsPicture() &&
            arrUrls &&
            arrUrls.length
          ) {
            ...
            if (arrImages.length) {
              oApi.WordControl.m_oLogicDocument.AddPlaceholderImages(
                arrImages,
                oOptionObject
              );
            }
            ...
            this.isPdfEditor() &&
            oOptionObject &&
            oOptionObject.GetType() === AscPDF.FIELD_TYPES.button
          ) {
  ...
  asc_docs_api.prototype.AddImageUrlAction = function (url, imgProp, obj) {
    ...
    if (null != _image) {
      ...
      if (_image.Image != null) {
        ...
        var __h = Math.max(
          _image.Image.height * AscCommon.g_dKoef_pix_to_mm,
          1
        );
      ...
      if (obj && obj.isShapeImageChangeUrl) {
        ...
        if (
          ...
          if (
            undefined === imgProp ||
            undefined === imgProp.WrappingStyle ||
            0 == imgProp.WrappingStyle
          )
            this.WordControl.m_oLogicDocument.AddInlineImage(_w, _h, src);
          else
            this.WordControl.m_oLogicDocument.AddInlineImage(
              _w,
              _h,
              src,
              null,
      ...
      this.asyncImageEndLoaded2 = function (_image) {
        ...
        if (_image.Image != null) {
          var __w = Math.max(
            _image.Image.width * AscCommon.g_dKoef_pix_to_mm,
            1
          );
          var __h = Math.max(
            _image.Image.height * AscCommon.g_dKoef_pix_to_mm,
        ...
        if (obj && obj.isShapeImageChangeUrl) {
          ...
          this.ImgApply(
            new asc_CImgProperty({ ShapeProperties: AscShapeProp })
          );
        } else if (obj && obj.isImageChangeUrl) {
          var AscImageProp = new asc_CImgProperty();
          AscImageProp.ImageUrl = src;
          ...
          obj instanceof AscCommon.CContentControlPr &&
          obj.GetInternalId()
        ) {
  ...
  /*
	 ...
	 */
  asc_docs_api.prototype.AddImageToPage = function (
    sUrl,
    nPageIndex,
    dX,
    dY,
    ...
    if (
      ...
      let oDrawing = new AscCommonWord.ParaDrawing(
        dW,
        dH,
        oImage,
        LogicDocument.DrawingDocument,
        null,
        null
      );
      oImage.setParent(oDrawing);
      oDrawing.Set_GraphicObject(oImage);
      let oNearestPos = LogicDocument.Get_NearestPos(
        nPageIndex,
        dX,
        dY,
        true,
  ...
  asc_docs_api.prototype.ImgApply = function (obj) {
    if (!AscCommon.isRealObject(obj)) return;
    var ImagePr = obj,
      AdditionalData,
      LogicDocument = this.WordControl.m_oLogicDocument;

    /*проверка корректности данных для биржевой диаграммы*/
    if (
      obj.ChartProperties &&
      obj.ChartProperties.type === Asc.c_oAscChartTypeSettings.stock
    ) {
      if (
        !AscFormat.CheckStockChart(
          this.WordControl.m_oLogicDocument.DrawingObjects,
          this
        )
      ) {
        return;
    ...
    var aParagraphs = [],
      aSelectedObjects =
        this.WordControl.m_oLogicDocument.DrawingObjects.selectedObjects,
      i,
      j,
      oParentParagraph;
    ...
    if (ImagePr.Group === 1 || ImagePr.Group === -1) {
      if (
        false ==
        this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
          AscCommon.changestype_Drawing_Props,
          AdditionalData
        )
      ) {
        this.WordControl.m_oLogicDocument.StartAction(
          AscDFH.historydescription_Document_GroupUnGroup
        );
        if (ImagePr.Group === 1) {
    ...
    if (
      ...
      if (ImagePr.ShapeProperties) ImagePr.ImageUrl = "";

      var sImageUrl = null,
        fReplaceCallback = null,
        bImageUrl = false,
        sImageToDownLoad = "",
        sToken = undefined;
      if (!AscCommon.isNullOrEmptyString(ImagePr.ImageUrl)) {
        ...
        ImagePr.ShapeProperties &&
        ImagePr.ShapeProperties.fill &&
        ImagePr.ShapeProperties.fill.fill &&
        !AscCommon.isNullOrEmptyString(ImagePr.ShapeProperties.fill.fill.url)
      ) {
        if (
          !g_oDocumentUrls.getImageLocal(ImagePr.ShapeProperties.fill.fill.url)
        ) {
      ...
      if (!AscCommon.isNullOrEmptyString(sImageToDownLoad)) {
        var fApplyCallback = function () {
          ...
          if (null != _img) {
            oApi.WordControl.m_oLogicDocument.StartAction(
              AscDFH.historydescription_Document_ApplyImagePrWithUrl
            );
        ...
        if (sImageUrl) {
          if (
            ...
            var _url =
              window["AscDesktopEditor"]["LocalFileGetImageUrl"](
                sImageToDownLoad
              );
  ...
  asc_docs_api.prototype.set_ImgDistanceFromText = function (
    left,
    top,
    right,
    bottom
  ...
  asc_docs_api.prototype.get_OriginalSizeImage = function () {
    for (var i = 0; i < this.SelectedObjectsStack.length; ++i) {
      if (
        this.SelectedObjectsStack[i].Type == c_oAscTypeSelectElement.Image &&
        this.SelectedObjectsStack[i].Value &&
        this.SelectedObjectsStack[i].Value.ImageUrl
      ) {
  ...
  asc_docs_api.prototype.ShapeApply = function (shapeProps) {
    ...
    if (shapeProps.fill != null) {
      if (
        shapeProps.fill.fill != null &&
        shapeProps.fill.type == c_oAscFill.FILL_TYPE_BLIP
      ) {
        ...
        if (
          null != _tx_id &&
          0 <= _tx_id &&
          _tx_id < AscCommon.g_oUserTexturePresets.length
        ) {
    ...
    if (image_url != "") {
      ...
      if (null != _image) {
        ...
        this.WordControl.m_oDrawingDocument.DrawImageTextureFillShape(
          image_url
        );
      } else {
        this.sync_StartAction(
  ...
  asc_docs_api.prototype.sync_ImgPropCallback = function (imgProp) {
    ...
    this.SelectedObjectsStack[this.SelectedObjectsStack.length] =
      new asc_CSelectedObject(
        c_oAscTypeSelectElement.Image,
        new asc_CImgProperty(imgProp)
      );
  };
  ...
  asc_docs_api.prototype.asc_addOleObjectAction = function (
    sLocalUrl,
    sData,
    sApplicationId,
    fWidth,
    ...
    nHeightPix,
    bSelect,
    arrImagesForAddToHistory
  ) {
    var _image = this.ImageLoader.LoadImage(
      AscCommon.getFullImageSrc2(sLocalUrl),
      1
    );
    if (null != _image) {
      //картинка уже должна быть загружена
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_PasteHotKey
      );
      let oDrawing = this.WordControl.m_oLogicDocument.AddOleObject(
        fWidth,
        fHeight,
        nWidthPix,
        nHeightPix,
  ...
  asc_docs_api.prototype.asc_editOleObjectAction = function (
    oOleObject,
    sImageUrl,
    sData,
    fWidthMM,
    ...
    if (oOleObject) {
      ...
      this.WordControl.m_oLogicDocument.EditOleObject(
        oOleObject,
        sData,
        sImageUrl,
        fWidthMM,
  ...
  function CContextMenuData(obj) {
    if (obj) {
      this.Type =
        undefined != obj.Type ? obj.Type : Asc.c_oAscContextMenuTypes.Common;
  ...
  asc_docs_api.prototype.sync_ShowForeignCursorLabel = function (
    UserId,
    X,
    Y,
    Color
    ...
    this.sendEvent(
      ...
      X,
      Y,
      new AscCommon.CColor(Color.r, Color.g, Color.b, 255)
    );
  };
  ...
  asc_docs_api.prototype.can_AddHyperlink = function () {
    if (!this.WordControl.m_oLogicDocument.CanAddHyperlink(true)) return false;
  ...
  asc_docs_api.prototype.add_Hyperlink = function (oHyperProps) {
    ...
    if (null !== oHyperProps.Text && undefined !== oHyperProps.Text) {
      AscFonts.FontPickerByCharacter.checkText(
        oHyperProps.Text,
        this,
        function () {
  ...
  asc_docs_api.prototype.private_CheckHeadingHyperlinkProps = function (
    oHyperProps
  ) {
    ...
    if (oHeading) {
      var oBookmarksManager =
        this.WordControl.m_oLogicDocument.GetBookmarksManager();
      ...
      if (oBookmark && oBookmark[0].GetParagraph() === oHeading) {
        ...
        if (oBookmark) {
          var nCounter = 1;
          while (
            oBookmarksManager.GetBookmarkByName(sBookmarkName + "_" + nCounter)
          ) {
            nCounter++;
          }
  ...
  asc_docs_api.prototype.private_AddHyperlink = function (
    oHyperProps,
    sBookmarkName,
    oParagraph
  ) {
    var isLocked = false;
    if (sBookmarkName) {
      isLocked = this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
        changestype_Paragraph_Content,
        {
          Type: AscCommon.changestype_2_Element_and_Type,
    ...
    if (!isLocked) {
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_AddHyperlink
      );
  ...
  asc_docs_api.prototype.change_Hyperlink = function (oHyperProps) {
    if (!oHyperProps || !oHyperProps.get_InternalHyperlink()) return;
  ...
  asc_docs_api.prototype.private_ChangeHyperlink = function (
    hyperProps,
    bookmarkName
  ) {
    let logicDocument = this.private_GetLogicDocument();
    ...
    logicDocument.StartAction(
      AscDFH.historydescription_Document_ChangeHyperlink
    );
  ...
  asc_docs_api.prototype.remove_Hyperlink = function (hyperProps) {
    ...
    if (logicDocument.IsSelectionLocked(changestype_Paragraph_Content)) return;
  ...
  asc_docs_api.prototype.sync_HyperlinkPropCallback = function (hyperProp) {
    this.SelectedObjectsStack[this.SelectedObjectsStack.length] =
      new asc_CSelectedObject(
        c_oAscTypeSelectElement.Hyperlink,
        new Asc.CHyperlinkProperty(hyperProp)
      );
  };
  ...
  //-----------------------------------------------------------------
  asc_docs_api.prototype.sync_SpellCheckCallback = function (
    Word,
    Checked,
    Variants,
    ParaId,
    ...
    this.SelectedObjectsStack[this.SelectedObjectsStack.length] =
      new asc_CSelectedObject(
        ...
        new AscCommon.asc_CSpellCheckProperty(
          Word,
          Checked,
          Variants,
          ParaId,
  ...
  asc_docs_api.prototype.asc_replaceMisspelledWord = function (
    Word,
    SpellCheckProperty
  ) {
  ...
  asc_docs_api.prototype.asc_ignoreMisspelledWord = function (
    SpellCheckProperty,
    bAll
  ) {
    if (false === bAll) {
  ...
  asc_docs_api.prototype.asc_setDefaultLanguage = function (Lang) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetDefaultLanguage
      );
  ...
  asc_docs_api.prototype.asc_getInputLanguage = function () {
    ...
    if (-1 !== keyboardLang) return keyboardLang;

    let logicDocument = this.private_GetLogicDocument();
    if (!logicDocument) return lcid_enUS;

    let run = logicDocument.GetCurrentRun();
    if (!run) return lcid_enUS;
  ...
  asc_docs_api.prototype.asc_restartCheckSpelling = function () {
    let oLogicDocument = this.private_GetLogicDocument();
    if (oLogicDocument) oLogicDocument.RestartSpellCheck();
  };
  ...
  asc_docs_api.prototype.asc_setSpellCheckSettings = function (oSettings) {
    ...
    if (oSpellCheck.SetSettings(oSettings)) oLogicDocument.RestartSpellCheck();
  };
  asc_docs_api.prototype.asc_getSpellCheckSettings = function () {
    let oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument) return new AscCommon.CSpellCheckSettings();
  ...
  function asc_CCommentDataWord(obj) {
    if (obj) {
      ...
      this.m_sProviderId =
        undefined != obj.m_sProviderId ? obj.m_sProviderId : "";
      this.m_sQuoteText =
        undefined != obj.m_sQuoteText ? obj.m_sQuoteText : null;
      this.m_bSolved = undefined != obj.m_bSolved ? obj.m_bSolved : false;
      this.m_sUserName = undefined != obj.m_sUserName ? obj.m_sUserName : "";
      this.m_sInitials =
        undefined != obj.m_sInitials
          ? obj.m_sInitials
          : this.asc_makeInitials(this.m_sUserName);
      this.m_nDurableId =
        undefined != obj.m_nDurableId
          ? obj.m_nDurableId
          : AscCommon.CreateDurableId();
  ...
  asc_CCommentDataWord.prototype.fromCValue = function (value) {
    ...
    if (Array.isArray(value["asc_getReplies"])) {
      for (let nIdx = 0; nIdx < value["asc_getReplies"].length; ++nIdx) {
        let reply = Asc.asc_CCommentData.prototype.fromCValue(
          value["asc_getReplies"][nIdx]
        );
        if (reply) {
  ...
  asc_docs_api.prototype.asc_showComments = function (isShowSolved) {
    if (null == this.WordControl.m_oLogicDocument) return;
  ...
  asc_docs_api.prototype.asc_addComment = function (AscCommentData) {
    if (true === AscCommon.CollaborativeEditing.Get_GlobalLock()) return null;
    ...
    if (
      true !== this.can_AddQuotedComment() ||
      false ===
        oLogicDocument.Document_Is_SelectionLocked(
          AscCommon.changestype_Paragraph_Content,
          null,
          true,
          oLogicDocument.IsEditCommentsMode()
        )
    ) {
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_AddComment
      );
      var oComment = this.WordControl.m_oLogicDocument.AddComment(
        CommentData,
        AscCommentData.asc_getDocumentFlag()
      );
      if (oComment) this.sync_AddComment(oComment.GetId(), CommentData);

      this.WordControl.m_oLogicDocument.FinalizeAction();

      if (oComment) return oComment.GetId();
    }
  ...
  asc_docs_api.prototype.asc_removeComment = function (Id) {
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_RemoveComment
      );
  ...
  asc_docs_api.prototype.asc_showComment = function (Id) {
    if (Id instanceof Array) this.WordControl.m_oLogicDocument.ShowComment(Id);
    else this.WordControl.m_oLogicDocument.ShowComment([Id]);
  };
  ...
  asc_docs_api.prototype.asc_GetCommentsReportByAuthors = function () {
    ...
    function privateProcessCommentData(isTopComment, oCommentData) {
      ...
      if (!oReport[sUserName]) oReport[sUserName] = [];
      ...
      while (nPos < nLen) {
        if (nDateTime < arrUserComments[nPos].Data.GetDateTime()) break;

        nPos++;
      }

      arrUserComments.splice(nPos, 0, {
        Top: isTopComment,
        Data: oCommentData,
      });

      for (
        var nIndex = 0, nCount = oCommentData.GetRepliesCount();
        nIndex < nCount;
        ++nIndex
      ) {
    ...
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    if (!oLogicDocument) return oReport;
  ...
  asc_docs_api.prototype.sync_AddComment = function (Id, CommentData) {
    ...
    if (window.g_asc_plugins)
      window.g_asc_plugins.onPluginEvent("onAddComment", {
        Id: Id,
        Data: CommentData.ConvertToSimpleObject(),
      });
  };
  ...
  asc_docs_api.prototype.sync_ChangeCommentData = function (Id, CommentData) {
    ...
    if (window.g_asc_plugins)
      window.g_asc_plugins.onPluginEvent("onChangeCommentData", {
        Id: Id,
        Data: CommentData.ConvertToSimpleObject(),
      });
  };
  ...
  asc_docs_api.prototype.asc_RemoveAllComments = function (
    isMine,
    isCurrent,
    arrIds
  ) {
    ...
    var arrCommentsId =
      undefined !== arrIds
        ? arrIds
        : oLogicDocument.GetAllComments(isMine, isCurrent);
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_RemoveAllComments
      );

      for (
        var nIndex = 0, nCount = arrCommentsId.length;
        nIndex < nCount;
        ++nIndex
      ) {
        ...
        if (
          oComment &&
          AscCommon.UserInfoParser.canDeleteComment(oComment.GetUserName())
        )
  ...
  asc_docs_api.prototype.asc_ResolveAllComments = function (
    isMine,
    isCurrent,
    arrIds
  ) {
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_ResolveAllComments
      );
      ...
      for (
        ...
        if (
          oComment &&
          AscCommon.UserInfoParser.canEditComment(oComment.GetUserName()) &&
          !oComment.IsSolved() &&
          oComment.GetData()
        ) {
  ...
  asc_docs_api.prototype.asc_GetCommentLogicPosition = function (sId) {
    ...
    if (!oComment) return -1;

    return oComment.GetPosition();
  };
  asc_docs_api.prototype.sync_ChangeCommentLogicalPosition = function (
    oChangedComments,
    nOverallCount
  ) {
    var isChanged = false;
  ...
  asc_docs_api.prototype.sync_CollaborativeChanges = function () {
    if (
      true !== AscCommon.CollaborativeEditing.Is_Fast() &&
      (true !== this.WordControl.m_oLogicDocument.IsViewModeInReview() ||
        true !==
          this.WordControl.m_oLogicDocument.IsFastCollaborationBeforeViewModeInReview())
    )
  ...
  asc_docs_api.prototype.sync_zoomChangeCallback = function (percent, type) {
    ...
    if (this.WordControl) {
      if (
        percent > this.WordControl.m_nZoomValueMax ||
        this.WordControl.m_nZoomValueMax === -1
      )
        this.WordControl.m_nZoomValueMax = percent;
      if (
        percent < this.WordControl.m_nZoomValueMin ||
        this.WordControl.m_nZoomValueMin === -1
      )
  ...
  asc_docs_api.prototype.asc_IsFocus = function (bIsNaturalFocus) {
    var _ret = false;
    if (this.WordControl.IsFocus) _ret = true;
    ...
    if (this.isPasteFonts_Images)
      ...
      this.sync_StartAction(
        undefined === blockType
          ? c_oAscAsyncActionType.BlockInteraction
          : blockType,
        c_oAscAsyncAction.LoadDocumentFonts
      );

      if (undefined !== this.asyncMethodCallback) return;
      ...
      if (_loader_object !== undefined && _loader_object != null) {
        for (var i in _loader_object.ImageMap) {
          if (this.DocInfo.get_OfflineApp()) {
            ...
            g_oDocumentUrls.addImageUrl(
              localUrl,
              this.documentUrl + "media/" + localUrl
            );
          }
          ++_count;
        }
  ...
  asc_docs_api.prototype.GenerateStyles = function () {
    if (window["NATIVE_EDITOR_ENJINE"] === true) {
      if (!this.asc_checkNeedCallback("asc_onInitEditorStyles")) return;
    }

    if (!this.stylePainter)
      this.stylePainter = new AscCommonWord.CStylesPainter();

    this.stylePainter.GenerateStyles(
      this,
      null == this.LoadedObject
        ? this.WordControl.m_oLogicDocument.Get_Styles().Style
        : this.LoadedObjectDS
    );
  };
  asc_docs_api.prototype.asyncFontsDocumentEndLoaded = function (blockType) {
    ...
    if (this.isPasteFonts_Images) {
      var _count = 0;
      for (var i in this.pasteImageMap) ++_count;
      ...
      var _count = 0;
      for (var i in this.saveImageMap) ++_count;
    ...
    if (_count > 0) {
      ...
      this.sync_StartAction(
        c_oAscAsyncActionType.BlockInteraction,
        c_oAscAsyncAction.LoadDocumentImages
      );
    }
  ...
  asc_docs_api.prototype.sync_SendThemeColors = function (
    colors,
    standart_colors
  ) {
  ...
  asc_docs_api.prototype.getCurrentTheme = function () {
    if (null == this.WordControl.m_oLogicDocument) return null;
  ...
  asc_docs_api.prototype.getGraphicController = function () {
    ...
    return (
      document &&
      document.DrawingsController &&
      document.DrawingsController.DrawingObjects
    );
  };
  ...
  asc_docs_api.prototype.ChangeColorScheme = function (sSchemeName) {
    ...
    if (
      this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
        AscCommon.changestype_ColorScheme
      ) === false
    ) {
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_ChangeColorScheme
      );
  ...
  asc_docs_api.prototype.asyncImagesDocumentEndLoaded = function () {
    ...
    if (null != this.WordControl.m_oDrawingDocument.m_oDocumentRenderer) {
      ...
      if (false === this.isPasteFonts_Images) this.onDocumentContentReady();

      this.WordControl.InitControl();

      if (this.isViewMode) this.asc_setViewMode(true);
      return;
    }
    ...
    if (
      false === this.isPasteFonts_Images &&
      false === this.isSaveFonts_Images &&
      false === this.isLoadImagesCustom
    ) {
  ...
  asc_docs_api.prototype._openDocumentEndCallback = function () {
    ...
    if (0 == this.DocumentType)
      ...
      if (this.LoadedObject) {
        ...
        if (this.isApplyChangesOnOpenEnabled) {
          if (AscCommon.EncryptionWorker) {
            ...
            if (!AscCommon.EncryptionWorker.isChangesHandled)
              return AscCommon.EncryptionWorker.handleChanges(
          ...
          AscCommon.CollaborativeEditing.Apply_Changes(function () {
            ...
            if (OtherChanges) {
              AscCommon.sendClientLog(
                "debug",
                AscCommon.getClientInfoString(
                  "onApplyChanges",
                  perfEnd - perfStart
                ),
                oThis
        ...
        if (!this.isOnlyReaderMode) {
          ...
          if (!this.WordControl.IsReaderMode()) this.ChangeReaderMode();
          else this.WordControl.UpdateReaderContent();
        }
      }
    }
    ...
    if (!this.isViewMode) {
      ...
      if (this.shapeElementId) {
        this.WordControl.m_oDrawingDocument.InitGuiCanvasShape(
          this.shapeElementId
        );
      }
    }
  ...
  asc_docs_api.prototype.asyncFontEndLoaded = function (fontinfo) {
    ...
    if (_fontSelections.CurrentLoadedObj != null) {
      var _rfonts = _fontSelections.getSetupRFonts(
        _fontSelections.CurrentLoadedObj
      );
      this.WordControl.m_oLogicDocument.TextBox_Put(
        _fontSelections.CurrentLoadedObj.text,
        _rfonts
      );
  ...
  asc_docs_api.prototype.asyncImageEndLoaded = function (_image) {
    // отжать заморозку меню
    if (this.asyncImageEndLoaded2) this.asyncImageEndLoaded2(_image);
    else {
      if (
        false ===
        this.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
        ...
        this.WordControl.m_oLogicDocument.StartAction(
          AscDFH.historydescription_Document_AddImage
        );
  ...
  asc_docs_api.prototype.openDocument = function (file) {
    ...
    if (file.bSerFormat) {
      ...
      this.isOpenOOXInBrowser =
        this["asc_isSupportFeature"]("ooxml") &&
        AscCommon.checkOOXMLSignature(file.data);
      if (this.isOpenOOXInBrowser) {
        this.openOOXInBrowserZip = file.data;
        this.OpenDocumentFromZip(file.data);
      } else this.OpenDocument(file.url, file.data);
    }
    let perfEnd = performance.now();
    AscCommon.sendClientLog(
      "debug",
      AscCommon.getClientInfoString("onOpenDocument", perfEnd - perfStart),
      this
    );
  };
  ...
  asc_docs_api.prototype.pre_Paste = function (_fonts, _images, callback) {
    if (
      undefined !== window["native"] &&
      undefined !== window["native"]["GetImageUrl"]
    ) {
      callback();
      return;
    }
    ...
    if (
      0 == _count &&
      false === this.FontLoader.CheckFontsNeedLoading(_fonts)
    ) {
  ...
  asc_docs_api.prototype.asc_SetDocumentPlaceChangedEnabled = function (
    bEnabled
  ) {
    if (this.WordControl)
  ...
  asc_docs_api.prototype.asc_SetDocumentUnits = function (_units) {
    if (
      this.WordControl &&
      this.WordControl.m_oHorRuler &&
      this.WordControl.m_oVerRuler
    ) {
  ...
  asc_docs_api.prototype.GoToHeader = function (pageNumber) {
    if (this.WordControl.m_oDrawingDocument.IsFreezePage(pageNumber)) return;
  ...
  asc_docs_api.prototype.GoToFooter = function (pageNumber) {
    ...
    LogicDocument.OnMouseDown(
      global_mouseEvent,
      0,
      AscCommon.Page_Height,
      pageNumber
    );
    LogicDocument.OnMouseUp(
      global_mouseEvent,
      0,
      AscCommon.Page_Height,
      pageNumber
  ...
  asc_docs_api.prototype.ExitHeader_Footer = function (pageNumber) {
    ...
    this.WordControl.m_oLogicDocument.OnMouseDown(
      global_mouseEvent,
      0,
      AscCommon.Page_Height / 2,
      pageNumber
    );
    this.WordControl.m_oLogicDocument.OnMouseUp(
      global_mouseEvent,
      0,
      AscCommon.Page_Height / 2,
      pageNumber
  ...
  asc_docs_api.prototype.SetPaintFormat = function (_value) {
    ...
    if (this.isDrawTablePen || this.isDrawTableErase) {
      ...
      oLogicDocument.UpdateCursorType(
        oLogicDocument.CurPos.RealX,
        oLogicDocument.CurPos.RealY,
        oLogicDocument.CurPage,
        new AscCommon.CMouseEventHandler()
      );
  ...
  asc_docs_api.prototype.asc_SendForm = function () {
    let logicDocument = this.private_GetLogicDocument();
    let oform = logicDocument ? logicDocument.GetOFormDocument() : null;
    if (!logicDocument || !oform) return false;
  ...
  asc_docs_api.prototype.setCurrentRoleFilled = function () {
    ...
    let userName = this.DocInfo
      ? AscCommon.UserInfoParser.getParsedName(this.DocInfo.get_UserName())
      : undefined;
  ...
  asc_docs_api.prototype._sendForm = function () {
    ...
    this.sync_StartAction(
      c_oAscAsyncActionType.BlockInteraction,
      c_oAscAsyncAction.Submit
    );
    var data = {
      type: "sendForm",
      userconnectionid: this.CoAuthoringApi.getUserConnectionId(),
      formdata: {
        formsdata: this.asc_GetAllFormsData(true),
      },
    };
    this.saveFromChanges(
      data,
      ...
      function (isTimeout, response) {
        if (
          !(
            response &&
            AscCommon.c_oAscServerCommandErrors.NoError === response.code
          )
        ) {
          t.sendEvent(
            "asc_onError",
            Asc.c_oAscError.ID.Submit,
            c_oAscError.Level.NoCritical
          );
        }
        t.sync_EndAction(
  ...
  asc_docs_api.prototype.SetTableDrawMode = function (value) {
    ...
    if (this.isDrawTablePen)
      this.WordControl.m_oDrawingDocument.LockCursorType(
        AscCommon.Cursors.TablePen
      );
  };
  ...
  asc_docs_api.prototype.AddShapeOnCurrentPage = function (_type) {
    if (!this.WordControl.m_oLogicDocument) return;
    this.WordControl.m_oLogicDocument.DrawingObjects.addShapeOnPage(
      _type,
      this.GetCurrentVisiblePage()
    );
  };
  ...
  asc_docs_api.prototype.asc_startEditCrop = function () {
    const bRes =
      this.WordControl.m_oLogicDocument.DrawingObjects.startImageCrop();
    if (bRes) {
      this.WordControl.m_oLogicDocument.UpdateInterface();
    }
    return bRes;
  ...
  asc_docs_api.prototype.asc_endEditCrop = function () {
    const bRes =
      this.WordControl.m_oLogicDocument.DrawingObjects.endImageCrop();
    if (bRes) {
      this.WordControl.m_oLogicDocument.UpdateInterface();
    }
    return bRes;
  ...
  asc_docs_api.prototype.AddTextArt = function (nStyle) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_AddTextArt
      );
  ...
  asc_docs_api.prototype.ClearFormating = function () {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_ClearFormatting
      );
  ...
  asc_docs_api.prototype.add_SectionBreak = function (_Type) {
    if (
      ...
      this.WordControl.m_oLogicDocument.StartAction(
        AscDFH.historydescription_Document_AddSectionBreak
      );
  ...
  asc_docs_api.prototype.SetDrawImagePlaceParagraph = function (
    element_id,
    props
  ) {
    ...
    if (opt_isPassword) {
      if (this.asc_checkNeedCallback("asc_onAdvancedOptions")) {
        t.sendEvent(
          ...
          c_oAscAdvancedOptionsID.DRM,
          data ? data.message : undefined
        );
      } else {
        t.sendEvent(
          "asc_onError",
          c_oAscError.ID.ConvertationPassword,
          c_oAscError.Level.Critical
        );
      }
    } else {
      if (this.asc_checkNeedCallback("asc_onAdvancedOptions")) {
          ...
          AscCommon.loadFileContent(
            ...
            function (httpRequest) {
              if (httpRequest && httpRequest.response) {
                ...
                t.sendEvent(
                  "asc_onAdvancedOptions",
                  c_oAscAdvancedOptionsID.TXT,
                  new AscCommon.asc_CAdvancedOptions(cp)
                );
              } else {
                t.sendEvent(
                  "asc_onError",
        ...
        this.asc_setAdvancedOptions(
          c_oAscAdvancedOptionsID.TXT,
          new Asc.asc_CTextOptions(AscCommon.c_oAscCodePageUtf8)
        );
      }
    }
  };
  asc_docs_api.prototype._waitPrint = function (actionType, options) {
    if (
      this.WordControl &&
      this.WordControl.m_oDrawingDocument &&
      (c_oAscFileType.PDF === options.fileType ||
        c_oAscFileType.PDFA === options.fileType)
    ) {
      return this.WordControl.m_oDrawingDocument.CheckPrint([
        actionType,
        options,
      ]);
    }
  ...
  asc_docs_api.prototype._downloadAs = function (
    actionType,
    options,
    oAdditionalData,
    dataContainer,
    ...
    if (
      this.WordControl.m_oLogicDocument &&
      this.isCloudSaveAsLocalToDrawingFormat(actionType, fileType)
    ) {
      if (this.isUseNativeViewer && this.isDocumentRenderer()) {
        ...
        window["AscDesktopEditor"]["localSaveToDrawingFormat2"](
          ...
          this.DocumentUrl || "",
          "",
          changes ? AscCommon.Base64.encode(changes) : "",
          AscCommon.Base64.encode(
            this.getDocumentRenderer().getFileNativeBinary()
          ),
          this.currentPassword || "",
          fileType
        );
      } else {
        this.localSaveToDrawingFormat(
          this.WordControl.m_oDrawingDocument.ToRendererPart(
            false,
            options.isPdfPrint || (fileType & 0x0400) === 0x0400
          ),
          fileType
        );
      }
    ...
    let canDownloadFromBytes =
      null == options.oDocumentMailMerge &&
      null == options.oMailMergeSendData &&
      !window.isCloudCryptoDownloadAs &&
      DownloadType.None === downloadType &&
    ...
    if ("savefromorigin" === oAdditionalData["c"]) {
      ...
      if (options.pdfChanges) {
        ...
        dataContainer.data =
          this.WordControl.m_oDrawingDocument.m_oDocumentRenderer.Save();
      }
    } else if (
      (c_oAscFileType.PDF === fileType || c_oAscFileType.PDFA === fileType) &&
      null == options.oDocumentMailMerge &&
      (options.isPdfPrint ||
        !(this.DocInfo && this.DocInfo.isFormatWithForms()))
    ) {
      ...
      if (isSelection) dd.GenerateSelectionPrint();

      let isPrintedVersion =
        options.isPdfPrint || this.asc_isFinalizedVersion();
      ...
      var data =
        window["asc_docs_api"].prototype["asc_nativeGetHtml"].call(this);
        ...
        if (data) {
          if (c_oAscFileType.DOCX === fileType && canDownloadFromBytes) {
            AscCommon.DownloadFileFromBytes(
              data,
              title,
              AscCommon.openXml.GetMimeType("docx")
            );
          } else {
            ...
            if (window.isCloudCryptoDownloadAs) {
              var sParamXml =
                "<m_nCsvTxtEncoding>" +
                oAdditionalData["codepage"] +
                "</m_nCsvTxtEncoding>";
              window["AscDesktopEditor"]["CryptoDownloadAs"](
                dataContainer.data,
                fileType,
                sParamXml
              );
      ...
      else oLogicDocument = this.WordControl.m_oLogicDocument;
      var oBinaryFileWriter;
      if (
        null != options.oMailMergeSendData &&
        c_oAscFileType.HTML === options.oMailMergeSendData.get_MailFormat()
      )
        oBinaryFileWriter = new AscCommonWord.BinaryFileWriter(
          oLogicDocument,
          false,
          true,
          options.compatible
    ...
    if (null != options.oMailMergeSendData) {
      ...
      if (MailMergeMap) {
        if (MailMergeMap.length > 0) {
          ...
          var aRowOut = [];
          for (var i in oFirstRow) aRowOut.push(i);
        ...
        for (var i = 0; i < MailMergeMap.length; ++i) {
          ...
          var aRowOut = [];
          for (var j in oRow) aRowOut.push(oRow[j]);
          aJsonOut.push(aRowOut);
        }
      }
      ...
      options.callback = function (incomeObject) {
        ...
        AscCommon.saveWithParts(
          function (fCallback1, oAdditionalData1, dataContainer1) {
  ...
  asc_docs_api.prototype.asc_editChartDrawingObject = function (chartBinary) {
    ...
    if (AscFormat.isObject(chartBinary)) {
      if (
        ...
        this.WordControl.m_oLogicDocument.StartAction(
          AscDFH.historydescription_Document_EditChart
        );
  ...
  asc_docs_api.prototype.asc_AddMath2 = function (nType) {
    ...
    if (
      !oLogicDocument.IsSelectionLocked(AscCommon.changestype_Paragraph_Content)
    ) {
  ...
  asc_docs_api.prototype.asc_ConvertMathView = function (isToLinear, isAll) {
    ...
    if (isAll) logicDocument.ConvertAllMathView(isToLinear);
    else logicDocument.ConvertMathView(isToLinear);
  };
  ...
  asc_docs_api.prototype.asc_StartMailMerge = function (oData) {
    ...
    if (oData) {
      ...
      this.downloadAs(
        Asc.c_oAscAsyncAction.MailMergeLoadFile,
        new Asc.asc_CDownloadOptions(Asc.c_oAscFileType.JSON)
      );
    } else {
  ...
  function trimMailMergeList(aList) {
    ...
    if (!aList || !aList.length || aList.length <= 0) aList = [[]];
  ...
  asc_docs_api.prototype.asc_StartMailMergeByList = function (aList) {
    ...
    var aFields = aList[0];
    if (!aFields || !aFields.length || aFields.length <= 0) aFields = [];
    ...
    for (var Pos = 0, Count = aFields.length; Pos < Count; Pos++) {
      if ("" === aFields[Pos]) aFields[Pos] = "F" + (Pos + 1);
  ...
  asc_docs_api.prototype.asc_GetMailMergeFiledValue = function (nIndex, sName) {
    return this.WordControl.m_oLogicDocument.Get_MailMergeFieldValue(
      nIndex,
      sName
    );
  };
  ...
  asc_docs_api.prototype.asc_SetGlobalTrackRevisions = function (bTrack) {
    ...
    if (
      !oLogicDocument.IsSelectionLocked(AscCommon.changestype_Document_Settings)
    ) {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetTrackRevisions
      );
  ...
  asc_docs_api.prototype.sync_OnTrackRevisionsChange = function (
    localFlag,
    globalFlag,
    userId
  ) {
  ...
  asc_docs_api.prototype.asc_AcceptChanges = function (oChange) {
    ...
    else this.WordControl.m_oLogicDocument.AcceptRevisionChangesBySelection();
  };
  asc_docs_api.prototype.asc_RejectChanges = function (oChange) {
    if (oChange)
      this.WordControl.m_oLogicDocument.RejectRevisionChange(oChange);
    else this.WordControl.m_oLogicDocument.RejectRevisionChangesBySelection();
  };
  asc_docs_api.prototype.asc_AcceptChangesBySelection = function (moveToNext) {
    ...
    if (moveToNext) logicDocument.GetNextRevisionChange();
  };
  ...
  asc_docs_api.prototype.asc_HaveRevisionsChanges = function (
    ...
    if (!this.WordControl.m_oLogicDocument) return false;
    return this.WordControl.m_oLogicDocument.HaveRevisionChanges(
      isCheckOwnChanges
    );
  };
  ...
  asc_docs_api.prototype.asc_GetTrackRevisionsReportByAuthors = function () {
    var oResult = {};
    var oAllChanges =
      this.WordControl.m_oLogicDocument.TrackRevisionsManager.Get_AllChanges();
    for (var ParaId in oAllChanges) {
      var arrChanges = oAllChanges[ParaId];
      for (
        var nIndex = 0, nCount = arrChanges.length;
        nIndex < nCount;
        ++nIndex
      ) {
        ...
        if (!oResult[sUserName]) oResult[sUserName] = [];
        ...
        while (nPos < nLen) {
          if (nDateTime < arrUserChanges[nPos].get_DateTime()) break;
  ...
  asc_docs_api.prototype.initCollaborativeEditing = function () {
    if (AscCommon.CollaborativeEditing) return;
  ...
  asc_docs_api.prototype.asc_Recalculate = function (bIsUpdateInterface) {
    ...
    return this.WordControl.m_oLogicDocument.RecalculateFromStart(
      bIsUpdateInterface
    );
  };
  ...
  asc_docs_api.prototype.asc_SetBlockChainData = function (arrData) {
    ...
    if (!this.isLongAction()) oLogicDocument.RecalculateFromStart();
  };
  //----------------------------------------------------------------------------------------------------------------------
  // Работаем с ContentControl
  //----------------------------------------------------------------------------------------------------------------------
  asc_docs_api.prototype.asc_AddContentControl = function (
    nType,
    oContentControlPr
  ) {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    ...
    if (c_oAscSdtLevelType.Block === nType) {
      if (
        false ===
        oLogicDocument.Document_Is_SelectionLocked(
          AscCommon.changestype_ContentControl_Add,
          null,
          true,
          false,
          null,
          AscDFH.historydescription_Document_AddBlockLevelContentControl
        )
      ) {
        oLogicDocument.StartAction(
          AscDFH.historydescription_Document_AddBlockLevelContentControl
      ...
      if (
        ...
        oLogicDocument.Document_Is_SelectionLocked(
          ...
          false,
          null,
          AscDFH.historydescription_Document_AddInlineLevelContentControl
        )
      ) {
        oLogicDocument.StartAction(
          AscDFH.historydescription_Document_AddInlineLevelContentControl
  ...
  asc_docs_api.prototype.asc_AddContentControlCheckBox = function (
    oPr,
    oInternalPr,
    oCommonPr
  ) {
    ...
    var nCheckedSymbol =
      oPr && oPr.CheckedSymbol
        ? oPr.CheckedSymbol
        : Asc.c_oAscSdtCheckBoxDefaults.CheckedSymbol;
    var nUncheckedSymbol =
      oPr && oPr.UncheckedSymbol
        ? oPr.UncheckedSymbol
        : Asc.c_oAscSdtCheckBoxDefaults.UncheckedSymbol;
    var sCheckedFont =
      oPr && oPr.CheckedFont
        ? oPr.CheckedFont
        : Asc.c_oAscSdtCheckBoxDefaults.CheckedFont;
    var sUncheckedFont =
      oPr && oPr.UncheckedFont
        ? oPr && oPr.UncheckedFont
        : Asc.c_oAscSdtCheckBoxDefaults.UncheckedFont;
    ...
    function private_PerformAddCheckBox() {
      ...
      if (
        ...
        oLogicDocument.StartAction(
          AscDFH.historydescription_Document_AddContentControlCheckBox
        );

        var oCC = oLogicDocument.AddContentControlCheckBox(oPr);

        if (oCC && oCommonPr) oCC.SetContentControlPr(oCommonPr);
  ...
  asc_docs_api.prototype.asc_AddContentControlPicture = function (
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_AddContentControlPicture
      );
  ...
  asc_docs_api.prototype.asc_AddContentControlList = function (
    isComboBox,
    oPr,
    oInternalPr,
    oCommonPr
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_AddContentControlList
      );

      var oCC;
      if (isComboBox) oCC = oLogicDocument.AddContentControlComboBox(oPr);
      else oCC = oLogicDocument.AddContentControlDropDownList(oPr);
  ...
  asc_docs_api.prototype.asc_AddContentControlDatePicker = function (
    oPr,
    oCommonPr
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
  ...
  asc_docs_api.prototype.asc_RemoveContentControl = function (Id) {
    ...
    if (undefined === Id) {
      ...
      if (oInlineControl) oContentControl = oInlineControl;
      else if (oBlockControl) oContentControl = oBlockControl;
    } else {
    ...
    if (oContentControl && oContentControl.GetContentControlType) {
      ...
      if (oContentControl.IsFixedForm()) {
        ...
        if (!oLogicDocument.IsSelectionLocked(AscCommon.changestype_Remove)) {
          oLogicDocument.StartAction(
            AscDFH.historydescription_Document_RemoveContentControl
          );
      ...
      if (
        ...
        isLocked = oLogicDocument.Document_Is_SelectionLocked(
          AscCommon.changestype_None,
          {
            Type: AscCommon.changestype_2_ElementsArray_and_Type,
  ...
  asc_docs_api.prototype.asc_RemoveContentControlWrapper = function (Id) {
    ...
    oLogicDocument.StartAction(
      AscDFH.historydescription_Document_RemoveContentControlWrapper
    );
  ...
  asc_docs_api.prototype.asc_SetContentControlProperties = function (
    oContentControlPr,
    Id,
    isApplyToAll
  ) {
    ...
    function preSetup() {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_ChangeContentControlProperties
      );
      AscFonts.IsCheckSymbols = true;
    }
    function postSetup() {
    ...
    if (true === isApplyToAll) {
      ...
      var arrCheckElements = [],
        arrCheckTypes = [];
      for (
        var nIndex = 0, nCount = arrContentControls.length;
        nIndex < nCount;
        ++nIndex
      ) {
      ...
      if (oContentControl && oContentControl.GetContentControlType) {
        if (
          (Asc.c_oAscSdtLockType.ContentLocked ===
            oContentControl.GetContentControlLock() ||
            Asc.c_oAscSdtLockType.SdtContentLocked ===
              oContentControl.GetContentControlLock()) &&
          oContentControlPr &&
          ...
          if (
            oContentControl.IsDatePicker() &&
            !oContentControl
              .GetDatePickerPr()
              .IsEqual(oContentControlPr.DateTimePr)
          ) {
            oContentControlPr.DateTimePr = oContentControl
              .GetDatePickerPr()
              .Copy();
          }
        }
  ...
  asc_docs_api.prototype.asc_GetContentControlProperties = function () {
    ...
    return oContentControl && !oContentControl.IsContentControlEquation()
      ? oContentControl.GetContentControlPr()
      : null;
  };
  asc_docs_api.prototype.asc_GetCurrentContentControl = function () {
    ...
    var oContentControl = oLogicDocument.GetContentControl();
    return oContentControl && !oContentControl.IsContentControlEquation()
      ? oContentControl.GetId()
      : null;
  };
  asc_docs_api.prototype.sync_ContentControlCallback = function (
    oContentControlPr
  ) {
    this.SelectedObjectsStack[this.SelectedObjectsStack.length] =
      new asc_CSelectedObject(
        c_oAscTypeSelectElement.ContentControl,
        oContentControlPr
      );
  };
  asc_docs_api.prototype.asc_ClearContentControl = function (sId) {
    ...
    if (
      !oLogicDocument.IsSelectionLocked(
        ...
        undefined,
        false,
        oLogicDocument.IsFormFieldEditing()
      )
    ) {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_ClearContentControl
      );
  ...
  asc_docs_api.prototype.asc_GetContentControlRightAnchorPosition = function (
    sId
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument) return null;
    ...
    var oContentControl = oLogicDocument.GetContentControl(sId);
    if (!oContentControl) return null;

    var oAnchor = oContentControl.GetBoundingRect();

    if (!oAnchor || oAnchor.Page < 0) return null;

    var nX = oAnchor.X + oAnchor.W;
    var nY = oAnchor.Y + oAnchor.H / 2;

    if (oAnchor.Transform) {
      nX = oAnchor.Transform.TransformPointX(
        oAnchor.X + oAnchor.W,
        oAnchor.Y + oAnchor.H / 2
      );
      nY = oAnchor.Transform.TransformPointY(
        oAnchor.X + oAnchor.W,
        oAnchor.Y + oAnchor.H / 2
      );
    }

    var oRealCoords = oLogicDocument
      .GetDrawingDocument()
      .ConvertCoordsToCursorWR(nX, nY, oAnchor.Page);
  ...
  asc_docs_api.prototype.asc_GetContentControlBoundingRect = function (sId) {
    ...
    if (!oRect || oRect.Page < 0) return null;
    ...
    if (oTransform) {
      ...
      var nX2 = oTransform.TransformPointX(
        oRect.X + oRect.W,
        oRect.Y + oRect.H
      );
      var nY2 = oTransform.TransformPointY(
        oRect.X + oRect.W,
        oRect.Y + oRect.H
      );
    ...
    var oRealCoords0 = oLogicDocument
      .GetDrawingDocument()
      .ConvertCoordsToCursorWR(nX, nY, oRect.Page);
    var oRealCoords1 = oLogicDocument
      .GetDrawingDocument()
      .ConvertCoordsToCursorWR(nX + nW, nY + nH, oRect.Page);
    return [oRealCoords0.X, oRealCoords0.Y, oRealCoords1.X, oRealCoords1.Y];
  };
  asc_docs_api.prototype.asc_SetGlobalContentControlHighlightColor = function (
    r,
    g,
    b
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument || !oLogicDocument.CanPerformAction()) return;
    ...
    oLogicDocument.StartAction(
      AscDFH.historydescription_Document_SetGlobalSdtHighlightColor
    );
  ...
  asc_docs_api.prototype.asc_GetGlobalContentControlHighlightColor = function (
    ...
    if (true === isDefault) return new Asc.asc_CColor(220, 220, 220);

    var oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument) return new Asc.asc_CColor(0, 0, 0);

    var oColor = oLogicDocument.GetSdtGlobalColor();
    return new Asc.asc_CColor(oColor.r, oColor.g, oColor.b);
  };
  asc_docs_api.prototype.asc_SetGlobalContentControlShowHighlight = function (
    isShow,
    r,
    g,
    b
    ...
    oLogicDocument.StartAction(
      AscDFH.historydescription_Document_SetGlobalSdtShowHighlight
    );
  ...
  asc_docs_api.prototype.asc_GetGlobalContentControlShowHighlight =
    function () {
      var oLogicDocument = this.private_GetLogicDocument();
      if (!oLogicDocument) return false;
  ...
  asc_docs_api.prototype.asc_SetContentControlCheckBoxPr = function (oPr) {
    var oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument || !oPr) return;

    var oContentControl = oLogicDocument.GetContentControl();
    if (!oContentControl || !oContentControl.IsCheckBox()) return;
    ...
    var nCheckedSymbol = oPr.CheckedSymbol
      ? oPr.CheckedSymbol
      : Asc.c_oAscSdtCheckBoxDefaults.CheckedSymbol;
    var nUncheckedSymbol = oPr.UncheckedSymbol
      ? oPr.UncheckedSymbol
      : Asc.c_oAscSdtCheckBoxDefaults.UncheckedSymbol;
    var sCheckedFont = oPr.CheckedFont
      ? oPr.CheckedFont
      : Asc.c_oAscSdtCheckBoxDefaults.CheckedFont;
    var sUncheckedFont = oPr.UncheckedFont
      ? oPr.UncheckedFont
      : Asc.c_oAscSdtCheckBoxDefaults.UncheckedFont;
    ...
    function private_PeformSetCheckBoxPr() {
      ...
      if (
        ...
        oLogicDocument.StartAction(
          AscDFH.historydescription_Document_SetContentControlCheckBoxPr
        );
  ...
  asc_docs_api.prototype.asc_SetContentControlCheckBoxChecked = function (
    isChecked,
    sId
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
    ...
    if (!isLocked) {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SelectContentControlListItem
      );
  ...
  asc_docs_api.prototype.asc_IsContentControlCheckBoxChecked = function (sId) {
    ...
    var oContentControl = oLogicDocument.GetContentControl(sId);
    if (!oContentControl || !oContentControl.IsCheckBox()) return false;

    return oContentControl.IsCheckBoxChecked();
  };
  asc_docs_api.prototype.asc_SetContentControlPictureUrl = function (
    sUrl,
    sId,
    sToken
  ) {
    ...
    var oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument || AscCommon.isNullOrEmptyString(sUrl)) return;
      ...
      var fApplyCallback = function () {
        var fPropsCallback = function (_img) {
          if (_img && _img.Image && oImagePr) {
            var oDrawingObjects =
              oApi.WordControl.m_oLogicDocument.DrawingObjects;
            if (oDrawingObjects && oDrawingObjects.selectedObjects[0]) {
              ...
              var __w = Math.max(
                _img.Image.width * AscCommon.g_dKoef_pix_to_mm,
                1
              );
              var __h = Math.max(
                _img.Image.height * AscCommon.g_dKoef_pix_to_mm,
                1
              );
          ...
          if (oCC.IsPictureForm()) {
            ...
            if (oShape && oShape.parent instanceof AscCommonWord.ParaDrawing)
              oApi.WordControl.m_oLogicDocument.Select_DrawingObject(
                oShape.parent.GetId()
              );
          }
  ...
  asc_docs_api.prototype.asc_SetContentControlListPr = function (oPr, sId) {
    ...
    if (
      !oContentControl ||
      (!oContentControl.IsComboBox() && !oContentControl.DropDownList())
    )
      return;
    ...
    if (false === isLocked) {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetContentControlListPr
      );

      if (oContentControl.IsComboBox()) oContentControl.SetComboBoxPr(oPr);
      else oContentControl.SetDropDownListPr(oPr);

      oLogicDocument.UpdateInterface();
      oLogicDocument.FinalizeAction();
    }
  };
  asc_docs_api.prototype.asc_SelectContentControlListItem = function (
    sValue,
    sId
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
    ...
    if (
      !oContentControl ||
      (!oContentControl.IsComboBox() && !oContentControl.IsDropDownList())
    )
      return;
  ...
  asc_docs_api.prototype.asc_GetContentControlListCurrentValue = function (
    sId
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument) return null;
    ...
    var oList = oContentControl.IsDropDownList()
      ? oContentControl.GetDropDownListPr()
      : oContentControl.GetComboBoxPr();
    var nIndex = oList.FindByText(oContentControl.GetSelectedText());

    if (-1 === nIndex) return undefined;
  ...
  asc_docs_api.prototype.asc_SetContentControlDatePickerPr = function (
    oPr,
    sId,
    updateDate
  ) {
    ...
    var isLocked = true;
    var oContentControl = oLogicDocument.GetContentControl(sId);
    if (!oContentControl || !oContentControl.IsDatePicker()) return;
  ...
  asc_docs_api.prototype.asc_SetContentControlDatePickerDate = function (
    oPr,
    sId
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
    ...
    if (
      !oContentControl ||
      !oContentControl.IsDatePicker() ||
      !oContentControl.CanBeEdited()
    )
      return;

    this.asc_SetContentControlDatePickerPr(oPr, sId, true);
  };
  asc_docs_api.prototype.asc_SetContentControlTextPlaceholder = function (
    sText,
    sId
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
  ...
  asc_docs_api.prototype.asc_GetTextFormKeys = function () {
    ...
    return oManager
      ? oManager.GetAllKeys({ Text: true, ComboBox: true, DropDownList: true })
      : [];
  };
  ...
  asc_docs_api.prototype.asc_ClearAllSpecialForms = function () {
    ...
    let contentControls;
    if (null !== roleName)
      contentControls = logicDocument
        .GetFormsManager()
        .GetAllFormsByRole(roleName);
    else contentControls = logicDocument.GetAllContentControls();

    logicDocument.ClearAllSpecialForms(contentControls);
  };
  asc_docs_api.prototype.asc_SetSpecialFormsHighlightColor = function (
    r,
    g,
    b
  ) {
    ...
    else oLogicDocument.SetSpecialFormsHighlight(r, g, b);
  ...
  asc_docs_api.prototype.asc_GetSpecialFormsHighlightColor = function () {
    ...
    return oColor && !oColor.IsAuto()
      ? new Asc.asc_CColor(oColor.r, oColor.g, oColor.b)
      : null;
  };
  ...
  asc_docs_api.prototype.asc_SetPerformContentControlActionByClick = function (
    isPerform
  ) {
    // obsolete function
  };
  asc_docs_api.prototype.asc_GetTextFormAutoWidth = function (sId) {
    ...
    if (
      !oContentControl ||
      !oContentControl.IsTextForm() ||
      !oContentControl.IsInlineLevel()
    )
      return null;
  ...
  asc_docs_api.prototype.asc_GetFormsCountByKey = function (sKey) {
    let formManager = this.private_GetFormsManager();
    if (!formManager) return 0;

    return (
      formManager.GetAllFormsByKey(sKey).length +
      formManager.GetRadioButtons(sKey).length
    );
  };
  asc_docs_api.prototype.asc_MoveToFillingForm = function (
    isNext,
    isRequired,
    isNotFilled
  ) {
    ...
    function findNextForm(checkFunc) {
      ...
      while (true) {
        ...
        if (checkFunc(curCC)) break;

        if (!startCC) startCC = curCC;
  ...
  asc_docs_api.prototype.asc_SetHighlightRequiredFields = function (
    isHighlight
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument) return;
  ...
  asc_docs_api.prototype.asc_OnChangeContentControl = function (oControl) {
    ...
    this.sendEvent(
      ...
      oControl.GetContentControlPr().GetEventObject()
    );
  ...
  asc_docs_api.prototype.asc_SetAllFormsData = function (data) {
    let logicDocument = this.private_GetLogicDocument();
    let formManager = this.private_GetFormsManager();
    if (!formManager || !logicDocument) return;

    // TODO: For now we assume that there is no need to check for document selection lock
    logicDocument.StartAction(
      AscDFH.historydescription_Document_SetAllFormsData
    );
  ...
  asc_docs_api.prototype.asc_DisconnectEveryone = function () {
    ...
    if (
      logicDocument.IsSelectionLocked(AscCommon.changestype_Document_Settings)
    )
      return false;
    ...
    logicDocument
      .GetHistory()
      .Add(new AscDFH.CChangesDocumentDisconnectEveryone(logicDocument));
    logicDocument.FinalizeAction();
  ...
  asc_docs_api.prototype.asc_CompletePreparingOForm = function (disconnect) {
    ...
    logicDocument.StartAction(
      AscDFH.historydescription_OForm_CompletePreparation
    );
    logicDocument.GetOFormDocument().setAllRolesNotFilled();
    if (disconnect)
      logicDocument
  ...
  asc_docs_api.prototype.asc_UncheckContentControlButtons = function () {
    var _controls =
      this.WordControl &&
      this.WordControl.m_oDrawingDocument &&
      this.WordControl.m_oDrawingDocument.contentControls
        ? this.WordControl.m_oDrawingDocument.contentControls
            .ContentControlObjects
        : [];
    if (_controls.length === 0) return;
  ...
  asc_docs_api.prototype.asc_BeginViewModeInReview = function (isFinal) {
    this.asc_SetDisplayModeInReview(
      isFinal
        ? Asc.c_oAscDisplayModeInReview.Final
        : Asc.c_oAscDisplayModeInReview.Original
    );
  };
  ...
  asc_docs_api.prototype.asc_SetDisplayModeInReview = function (nMode) {
    var oLogicDocument = this.private_GetLogicDocument();
    if (oLogicDocument) oLogicDocument.SetDisplayModeInReview(nMode);
  };
  asc_docs_api.prototype.asc_GetDisplayModeInReview = function () {
    var oLogicDocument = this.private_GetLogicDocument();
    if (oLogicDocument) return oLogicDocument.GetDisplayModeInReview();
  ...
  asc_docs_api.prototype.sync_OnDocumentOutlineCurrentPosition = function (
    nIndex
  ) {
  ...
  asc_docs_api.prototype.sync_OnDocumentOutlineUpdateChange = function (
    nIndex
  ) {
    this.sendEvent("asc_onDocumentOutlineUpdateChange", nIndex);
  };
  asc_docs_api.prototype.sync_OnDocumentOutlineUpdateRemove = function (
    nIndex
  ) {
  ...
  asc_docs_api.prototype.asc_AddTableOfContents = function (sHeading, oPr) {
    var sReplacementText = AscCommon.translateManager.getValue(
      "No table of contents entries found."
    );
    AscFonts.FontPickerByCharacter.checkText(
      sHeading + sReplacementText,
      this,
      function () {
        var oLogicDocument = this.WordControl.m_oLogicDocument;
        if (!oLogicDocument) return;
        ...
        if (
          oTOC instanceof AscCommonWord.CBlockLevelSdt &&
          oTOC.IsBuiltInUnique()
        ) {
          if (oPr) this.asc_SetTableOfContentsPr(oPr);
  ...
  asc_docs_api.prototype.asc_RemoveTableOfContents = function (oTOC) {
    ...
    if (oTOC instanceof AscCommonWord.CBlockLevelSdt) {
      ...
      if (oBeginChar && oBeginChar.GetRun()) {
        ...
        for (
          var nIndex = 0, nCount = oParentCCs.length;
          nIndex < nCount;
          ++nIndex
        ) {
          if (
            oParentCCs[nIndex].IsBlockLevel() &&
            oParentCCs[nIndex].IsBuiltInTableOfContents()
          ) {
      ...
      if (oTOC) this.asc_RemoveContentControl(oTOC.GetId());
      else this.asc_RemoveComplexField(oCF);
    }
  };
  ...
  asc_docs_api.prototype.asc_SetTableOfContentsPr = function (oPr) {
    if (!(oPr instanceof Asc.CTableOfContentsPr)) return;
    ...
    if (isTOF) {
      isNeedChangeStyles =
        Asc.c_oAscTOFStylesType.Current !== nStylesType &&
        nStylesType !== oStyles.GetTOFStyleType();
    } else {
      isNeedChangeStyles =
        Asc.c_oAscTOCStylesType.Current !== nStylesType &&
        nStylesType !== oStyles.GetTOCStylesType();
    }
    ...
    if (isNeedChangeStyles) {
      isLocked = oLogicDocument.Document_Is_SelectionLocked(
        ...
        {
          Type: AscCommon.changestype_2_AdditionalTypes,
          Types: [AscCommon.changestype_Document_Styles],
        }
      );
    } else {
      isLocked = oLogicDocument.Document_Is_SelectionLocked(
    ...
    if (!isLocked) {
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_SetComplexFieldPr
      );
  ...
  asc_docs_api.prototype.asc_UpdateTableOfContents = function (
    isUpdatePageNumbers,
    oTOC
  ) {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    ...
    if (!oTOC) oTOC = oLogicDocument.GetTableOfContents();
    ...
    if (
      ...
      this.sendEvent(
        "asc_onError",
        c_oAscError.ID.ComplexFieldNoTOC,
        c_oAscError.Level.NoCritical
      );
      return;
    }
    ...
    if (isUpdatePageNumbers) {
      if (
        ...
        oLogicDocument.StartAction(
          AscDFH.historydescription_Document_UpdateTableOfContents
        );

        var arrParagraphs = oLogicDocument.GetCurrentParagraph(false, true);

        for (
          var nParaIndex = 0, nParasCount = arrParagraphs.length;
          nParaIndex < nParasCount;
          ++nParaIndex
        ) {
          var arrPageNumbers = arrParagraphs[
            nParaIndex
          ].GetComplexFieldsArrayByType(AscWord.fieldtype_PAGEREF);
          for (
            var nRefIndex = 0, nRefsCount = arrPageNumbers.length;
            nRefIndex < nRefsCount;
            ++nRefIndex
          ) {
      ...
      if (
        false ===
        oLogicDocument.Document_Is_SelectionLocked(
          AscCommon.changestype_Document_Content
        )
      ) {
        oLogicDocument.StartAction(
          AscDFH.historydescription_Document_UpdateTableOfContents
  ...
  asc_docs_api.prototype.asc_AddParagraphToTOC = function (nLvl) {
    ...
    if (arrParagraphs.length < 0) return;
    ...
    if (
      ...
      oLogicDocument.StartAction(
        AscDFH.historydescription_Document_AddParagraphToTOC
      );

      let oStyles = oLogicDocument.GetStyles();
      if (-1 === nLvl || undefined === nLvl || null === nLvl) {
        for (
          let nIndex = 0, nCount = arrParagraphs.length;
          nIndex < nCount;
          ++nIndex
        ) {
      ...
      if (aTOF.length > 0) {
        if (typeof sCaption === "string" && sCaption.length > 0) {
          for (nIndex = 0; nIndex < aTOF.length; ++nIndex) {
            ...
            sInstrCaption =
              oInstruction.GetCaptionOnlyText() || oInstruction.GetCaption();
  ...
  asc_docs_api.prototype.asc_AddComplexFieldWithInstruction = function (
    instruction
  ) {
    let logicDocument = this.private_GetLogicDocument();
    if (!logicDocument) return;
  ...
  asc_docs_api.prototype.asc_EditComplexFieldInstruction = function (
    instruction
  ) {
    let logicDocument = this.private_GetLogicDocument();
    if (!logicDocument) return false;
    ...
    if (
      ...
      if (
        ...
        oRun.AddToContent(
          nInRunPos,
          oComplexField instanceof AscWord.CRunPageNum
            ? new AscWord.CRunPageNum()
            : new AscWord.CRunPagesCount(oLogicDocument.GetPagesCount())
        );
  ...
  asc_docs_api.prototype.asc_RemoveComplexField = function (oComplexField) {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    if (!oComplexField || !oLogicDocument) return;
    ...
    if (
      ...
      if (
        ...
        oLogicDocument.StartAction(
          AscDFH.historydescription_Document_RemoveComplexField
        );
  ...
  asc_docs_api.prototype.asc_SetComplexFieldPr = function (
    oComplexField,
    oPr,
    isUpdate
  ) {
    ...
    if (
      ...
      if (isUpdate) oComplexField.Update();
  ...
  asc_docs_api.prototype.asc_ParseTableFormulaInstrLine = function (
    sInstrLine
  ) {
    return this.WordControl.m_oLogicDocument.ParseTableFormulaInstrLine(
      sInstrLine
    );
  };

  asc_docs_api.prototype.asc_CreateInstructionLine = function (
    sFormula,
    sFormat
  ) {
    var sRet = sFormula;
  ...
  asc_docs_api.prototype.asc_GetHeadingLevel = function (sStyleName) {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    if (!oLogicDocument || !sStyleName) return -1;
  ...
  asc_docs_api.prototype.asc_SetAutoCorrectSmartQuotes = function (
    isSmartQuotes
  ) {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    if (!oLogicDocument) return;
  ...
  asc_docs_api.prototype.asc_SetAutoCorrectHyphensWithDash = function (
    isReplace
  ) {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    if (!oLogicDocument) return;
  ...
  asc_docs_api.prototype.asc_SetAutoCorrectFirstLetterOfSentences = function (
    isCorrect
  ) {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    if (!oLogicDocument) return;
  ...
  asc_docs_api.prototype.asc_SetAutoCorrectFirstLetterOfCells = function (
    isCorrect
  ) {
    var oLogicDocument = this.WordControl.m_oLogicDocument;
    if (!oLogicDocument) return;
  ...
  asc_docs_api.prototype.asc_SetAutoCorrectDoubleSpaceWithPeriod = function (
    isCorrect
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
    if (!oLogicDocument) return;
  ...
  asc_docs_api.prototype.asc_SetFirstLetterAutoCorrectExceptions = function (
    exceptions,
    lang
  ) {
    let logicDocument = this.private_GetLogicDocument();
    ...
    let exceptionManager = logicDocument
      .GetAutoCorrectSettings()
      .GetFirstLetterExceptionManager();
  ...
  asc_docs_api.prototype.asc_ReplaceCurrentWord = function (
    nDirection,
    sReplace
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
  ...
  asc_docs_api.prototype.asc_ConvertEquationToMath = function (
    oEquation,
    isAll
  ) {
    var oLogicDocument = this.private_GetLogicDocument();
  ...
  asc_docs_api.prototype.asc_IsInlineMath = function () {
    ...
    if (!oMath) return false;

    return oMath.IsInlineMode();
  };
  asc_docs_api.prototype.asc_AddMathML = function (xml) {
    let logicDocument = this.private_GetLogicDocument();
    AscCommon.g_font_loader.LoadFonts(["Cambria Math"], function () {
  ...
  asc_docs_api.prototype.asc_AddCrossRefToParagraph = function (
    oParagraph,
    nType,
    bHyperlink,
    bAboveBelow,
    ...
    var oLogicDocument = this.private_GetLogicDocument();
    oLogicDocument.AddRefToParagraph(
      oParagraph,
      nType,
      bHyperlink,
      bAboveBelow,
  ...
  asc_docs_api.prototype.asc_GetAllHeadingParagraphs = function () {
    var oLogicDocument = this.private_GetLogicDocument();
    var arrOutline = [];
    oLogicDocument.GetOutlineParagraphs(arrOutline, {
  ...
  asc_docs_api.prototype.asc_AddCrossRefToBookmark = function (
    sName,
    nType,
    bHyperlink,
    bAboveBelow,
    ...
    var oLogicDocument = this.private_GetLogicDocument();
    oLogicDocument.AddRefToBookmark(
      sName,
      nType,
      bHyperlink,
      bAboveBelow,
  ...
  asc_docs_api.prototype.asc_AddCrossRefToNote = function (
    oParagraph,
    nType,
    bHyperlink,
    bAboveBelow
    ...
    var oLogicDocument = this.private_GetLogicDocument();
    oLogicDocument.AddNoteRefToParagraph(
      oParagraph,
      nType,
      bHyperlink,
      bAboveBelow
  ...
  asc_docs_api.prototype.asc_AddCrossRefToCaption = function (
    sCaption,
    oParagraph,
    nType,
    bHyperlink,
    ...
    var oLogicDocument = this.private_GetLogicDocument();
    oLogicDocument.AddRefToCaption(
      sCaption,
      oParagraph,
      nType,
      bHyperlink,
  ...
  //comparison
  asc_docs_api.prototype.asc_CompareDocumentUrl = function (
    sUrl,
    oOptions,
    token
  ) {
    ...
    this._CompareDocument(
      { url: sUrl, format: "docx", token: token },
      oOptions
    );
  };
  asc_docs_api.prototype.asc_CompareDocumentFile = function (oOptions) {
    if (this.isLocalMode()) return this.asc_CompareDocumentFile_local(oOptions);
    var t = this;
    AscCommon.ShowDocumentFileDialog(function (error, files) {
      ...
      reader.onload = function () {
        t._CompareDocument(
          { data: new Uint8Array(reader.result), format: format },
          oOptions
        );
      };
      reader.onerror = function () {
  ...
  asc_docs_api.prototype.asc_CompareDocumentUrl_local = function (
    sUrl,
    oOptions,
    token
  ) {
    ...
    window["AscDesktopEditor"]["DownloadFiles"]([sUrl], [], function (files) {
      ...
      if (_files.length == 1) {
        if (t.isCloudModeCrypt()) {
          ...
          window["AscDesktopEditor"]["CompareDocumentUrl"](
            _files[0],
            oOptions,
            fileContent.data,
            fileContent.header
  ...
  asc_docs_api.prototype.getLogicDocument =
    asc_docs_api.prototype.private_GetLogicDocument;
  asc_docs_api.prototype.asc_createSmartArt = function (
    nSmartArtType,
    oPlaceholder
  ) {
    const oThis = this;
    AscCommon.g_oBinarySmartArts
      ...
      .then(function () {
        if (
          false ===
          oThis.WordControl.m_oLogicDocument.Document_Is_SelectionLocked(
            changestype_Paragraph_Content
          )
        ) {
          oThis.WordControl.m_oLogicDocument.StartAction(
          ...
          oThis.WordControl.m_oLogicDocument.AddInlineImage(
            null,
            null,
            null,
            oSmartArt
    ...
    window["AscDesktopEditor"]["OpenFilenameDialog"](
      ...
      function (_file) {
        ...
        if (file && "" != file) {
          if (t.isCloudModeCrypt()) {
            var fileContent = t.getFileAsFromChanges();
            window["AscDesktopEditor"]["CompareDocumentFile"](
              file,
              oOptions,
              fileContent.data,
              fileContent.header
  ...
  asc_docs_api.prototype.asc_MergeDocumentUrl = function (
    sUrl,
    oOptions,
    token
  ) {
  ...
  asc_docs_api.prototype.asc_MergeDocumentFile = function (oOptions) {
    if (this.isLocalMode()) return this.asc_MergeDocumentFile_local(oOptions);
    var t = this;
    AscCommon.ShowDocumentFileDialog(function (error, files) {
      if (Asc.c_oAscError.ID.No !== error) {
        t.sendEvent("asc_onError", error, Asc.c_oAscError.Level.NoCritical);
  ...
  asc_docs_api.prototype.asc_MergeDocumentUrl_local = function (
    sUrl,
    oOptions,
    token
  ) {
    ...
    window["AscDesktopEditor"]["DownloadFiles"]([sUrl], [], function (files) {
      ...
      if (_files.length == 1) {
        if (t.isCloudModeCrypt()) {
          var fileContent = t.getFileAsFromChanges();
          window["AscDesktopEditor"]["MergeDocumentUrl"](
            _files[0],
            oOptions,
            fileContent.data,
            fileContent.header
    ...
    window["AscDesktopEditor"]["OpenFilenameDialog"](
      ...
      function (_file) {
        ...
        if (file && "" != file) {
          if (t.isCloudModeCrypt()) {
            var fileContent = t.getFileAsFromChanges();
            window["AscDesktopEditor"]["MergeDocumentFile"](
              file,
              oOptions,
              fileContent.data,
              fileContent.header
  ...
  asc_docs_api.prototype._ConvertDocuments = function (
    documents,
    isUseDirectUrlError,
    fForEachCallback,
    fEndCallback
    ...
    this.insertDocumentUrlsData = {
      ...
      convertCallback: function (_api, url) {
        ...
        AscCommon.loadFileContent(
          ...
          function (httpRequest) {
            const stream =
              httpRequest && AscCommon.initStreamFromResponse(httpRequest);
            if (stream) {
  ...
  asc_docs_api.prototype._CompareDocument = function (document, oOptions) {
    const oThis = this;
    this._ConvertDocuments(
      [document],
      !!document.url,
      function (stream, imageMap) {
  ...
  window["onDocumentCompare"] = function (
    folder,
    file_content,
    file_content_len,
    image_map,
    ...
    file["GetBinary"] = function () {
      return AscCommon.getBinaryArray(file_content, file_content_len);
    };
    file["GetImageMap"] = function () {
      return image_map;
    };
  ...
  window["onDocumentMerge"] = function (
    folder,
    file_content,
    file_content_len,
    image_map,
  ...
  window["asc_docs_api"].prototype["asc_nativeOpenFile"] = function (
    base64File,
    version
  ) {
    this.SpellCheckUrl = "";
    ...
    if (undefined !== version) AscCommon.CurFileVersion = version;

    this.isOpenOOXInBrowser =
      this["asc_isSupportFeature"]("ooxml") &&
      AscCommon.checkOOXMLSignature(base64File);
    if (this.isOpenOOXInBrowser) {
    ...
    if (
      ...
      AscCommon.CDocsCoApi.prototype.saveChanges = function (
        arrayChanges,
        deleteIndex,
        excelAdditionalInfo
      ) {
        if (window["native"]["SaveChanges"])
          window["native"]["SaveChanges"](
            arrayChanges.join('","'),
            deleteIndex,
            arrayChanges.length
          );
  ...
  window["asc_docs_api"].prototype["asc_nativeCalculateFile"] = function (
    ...
    if (
      ...
      this.isApplyChangesOnOpenEnabled
    ) {
      this.isApplyChangesOnOpenEnabled = false;
    ...
    if (window["IS_NATIVE_EDITOR"]) {
      ...
      if (
        ...
        options["printOptions"]["onlyFirstPage"]
      )
        pagescount = 1;
  ...
  window["asc_docs_api"].prototype["asc_nativeApplyChanges"] = function (
    changes
  ) {
    this._coAuthoringSetChanges(
      changes,
      new AscCommonWord.CDocumentColor(191, 255, 199)
    );
    AscCommon.CollaborativeEditing.Apply_OtherChanges();
  };

  window["asc_docs_api"].prototype.asc_SetSilentMode = function (
    bEnabled,
    bAddition
  ) {
    if (!this.WordControl.m_oLogicDocument) return;
    if (bEnabled) this.WordControl.m_oLogicDocument.Start_SilentMode();
    else this.WordControl.m_oLogicDocument.End_SilentMode(bAddition);
  };

  window["asc_docs_api"].prototype["asc_nativeApplyChanges2"] = function (
    data,
    isFull
  ) {
    ...
    for (var i = 0; i < _count; i++) {
      if (
        window["NATIVE_EDITOR_ENJINE"] === true &&
        window["native"]["CheckNextChange"]
      ) {
        if (!window["native"]["CheckNextChange"]()) break;
      }
      ...
      if (Class) {
        ...
        if (fChangesClass) {
          ...
          if (
            true ===
            AscCommon.CollaborativeEditing.private_AddOverallChange(
              oChange,
              false
            )
          )
    ...
    if (isFull) {
      ...
      if (
        window["NATIVE_EDITOR_ENJINE"] === true &&
        window["native"]["AddImageInChanges"]
      ) {
  ...
  window["asc_docs_api"].prototype["asc_nativeGetFile"] = function () {
    var oBinaryFileWriter = new AscCommonWord.BinaryFileWriter(
      this.WordControl.m_oLogicDocument
    );
  ...
  window["asc_docs_api"].prototype.asc_nativeGetFile3 = function () {
    ...
    return {
      data: oBinaryFileWriter.Write(true, true),
      header:
        AscCommon.c_oSerFormat.Signature +
        ";v" +
        Asc.c_nVersionNoBase64 +
        ";" +
  ...
  window["asc_docs_api"].prototype["asc_nativeGetHtml"] = function () {
    ...
    if (oCore) {
      ...
      if (oCore.asc_getDescription()) {
        var description = AscCommon.escapeHtmlCharacters(
          oCore.asc_getDescription()
        );
      ...
      if (oCore.asc_getIdentifier()) {
        var identifier = AscCommon.escapeHtmlCharacters(
          oCore.asc_getIdentifier()
        );
  ...
  window["asc_docs_api"].prototype["asc_AddHtml"] = function (_iframeId) {
    ...
    if (frameWindow) {
      if (
        null != frameWindow.document &&
        null != frameWindow.document.body &&
        this.WordControl.m_oLogicDocument.CanPerformAction()
      ) {
  ...
  window["asc_docs_api"].prototype["asc_nativePrint"] = function (
    _printer,
    _page,
    _options
  ) {
    ...
    if (undefined === _printer && _page === undefined) {
      if (undefined !== window["AscDesktopEditor"]) {
        var isSelection =
          ...
          _options["printOptions"]["selection"]
            ? true
            : false;
        var _drawing_document = this.WordControl.m_oDrawingDocument;
        if (isSelection) _drawing_document.GenerateSelectionPrint();

        var _drawing_document_print = _drawing_document.printedDocument
          ? _drawing_document.printedDocument.DrawingDocument
          : _drawing_document;
        var pagescount = Math.min(
          _drawing_document_print.m_lPagesCount,
          _drawing_document_print.m_lCountCalculatePages
        );

        window["AscDesktopEditor"]["Print_Start"](
          this.DocumentUrl,
          pagescount,
          "",
          _drawing_document.printedDocument ? 0 : this.getCurrentPage()
        );
        ...
        for (var i = 0; i < pagescount; i++) {
          ...
          window["AscDesktopEditor"]["Print_Page"](
            oDocRenderer.Memory.GetBase64Memory(),
            page.width_mm,
            page.height_mm
          );
        }
      ...
      if (this.watermarkDraw)
        this.watermarkDraw.DrawOnRenderer(
          _printer,
          page.width_mm,
          page.height_mm
        );
  ...
  window["asc_docs_api"].prototype["asc_nativeGetPDF"] = function (options) {
    if (options && options["watermark"]) {
      this.watermarkDraw = new AscCommon.CWatermarkOnDraw(
        options["watermark"],
        this
      );
    ...
    if (
      options &&
      (options["saveFormat"] === "image" || options["isPrint"] === true)
    )
    ...
    let pages = nativeOptions
      ? AscCommon.getNativePrintRanges(
          nativeOptions["pages"],
          nativeOptions["currentPage"],
          pagescount
        )
      : undefined;

    for (var i = 0; i < pagescount; i++) {
      if (pages !== undefined && !pages[i]) continue;
  ...
  window["asc_docs_api"].prototype["asc_nativeGetWatermark"] = function (
    options
  ) {
    if (options && options["watermark"]) {
      if (!this.User) {
  ...
  window["asc_docs_api"].prototype["Add_NewParagraph"] = function () {
    ...
    if (
      false ===
      LogicDocument.Document_Is_SelectionLocked(
        AscCommon.changestype_Document_Content_Add
      )
    ) {
  ...
  window["asc_docs_api"].prototype["asc_IsSpellCheckCurrentWord"] =
    function () {
      return this.IsSpellCheckCurrentWord;
    };
  window["asc_docs_api"].prototype["asc_putSpellCheckCurrentWord"] = function (
    value
  ) {
    this.IsSpellCheckCurrentWord = value;
  };
  window["asc_docs_api"].prototype["asc_setParagraphStylesSizes"] = function (
    width,
    height
  ) {
  ...
  asc_docs_api.prototype.SetDrawImagePlaceTableOfFigures = function (
    id,
    props
  ) {
    if (this.WordControl.m_oDrawingDocument)
      this.WordControl.m_oDrawingDocument.SetDrawImagePlaceTableOfFigures(
        id,
        props
      );
  };
  ...
  asc_docs_api.prototype.SetDrawImagePreviewBullet = function (
    sDivId,
    oProps,
    nCurrentLvl,
    bIsMultiLvl
  ) {
    const oDrawer = new AscCommon.CBulletPreviewDrawerAdvancedOptions(
      sDivId,
      oProps,
      nCurrentLvl,
      bIsMultiLvl
  ...
  asc_docs_api.prototype.SetDrawImagePreviewBulletChangeListLevel = function (
    arrId,
    oProps
  ) {
  ...
  asc_docs_api.prototype.asc_ConvertTableToText = function (
    sep_type,
    sep,
    nested
  ) {
    ...
    return oLogicDocument.ConvertTableToText({
      type: sep_type,
      separator: sep,
      nested: nested,
    });
  ...
  asc_docs_api.prototype.asc_GetPossibleNumberingLanguage = function () {
    ...
    if (oLogicDocument) {
      ...
      if (oFirstParagraph) {
        ...
        const oTempTextPr =
          oFirstParagraph.TextPr && oFirstParagraph.TextPr.Value.Copy();
        if (oTempTextPr) {
  ...
  asc_docs_api.prototype.CheckDeprecatedBulletPreviewInfo = function (
    arrDrawingInfo,
    nTypeOfPreview
  ) {
    return arrDrawingInfo;
  };
  asc_docs_api.prototype.ParseBulletPreviewInformation = function (
    arrDrawingInfo
  ) {
  ...
  asc_docs_api.prototype["asc_getButtonsTOC"] = function (
    id1,
    id2,
    styleWidth
  ) {
  ...
  asc_docs_api.prototype.asc_getAppProps = function () {
    return (
      (this.WordControl &&
        this.WordControl.m_oLogicDocument &&
        this.WordControl.m_oLogicDocument.App) ||
      null
    );
  };
  ...
  asc_docs_api.prototype.getInternalCoreProps = function () {
    return (
      this.WordControl &&
      this.WordControl.m_oLogicDocument &&
      this.WordControl.m_oLogicDocument.Core
    );
  };
  ...
  asc_docs_api.prototype.asc_isCompatibilityMode = function () {
    if (null !== this.WordControl.m_oLogicDocument) {
      return (
        AscCommon.document_compatibility_mode_Word15 !==
        this.WordControl.m_oLogicDocument.GetCompatibilityMode()
      );
    }
    return false;
  };
  ...
  asc_docs_api.prototype.onUpdateRestrictions = function (restrictionSettings) {
    if (this.WordControl) this.WordControl.checkMouseHandMode();
    ...
    if (this.WordControl && this.WordControl.m_oDrawingDocument) {
      ...
      if (
        contentControls &&
        contentControls.ContentControlObjects.length !== 0
      ) {
    ...
    if (
      !oLogicDocument.IsFillingFormMode() &&
      oLogicDocument.FocusCC &&
      oLogicDocument.FocusCC.IsForm()
    )
  ...
  asc_docs_api.prototype.isShowShapeAdjustments = function () {
    var oLogicDocument = this.private_GetLogicDocument();
    if (oLogicDocument) return oLogicDocument.IsShowShapeAdjustments();

    return true;
  };
  asc_docs_api.prototype.isShowTableAdjustments = function () {
    var oLogicDocument = this.private_GetLogicDocument();
    if (oLogicDocument) return oLogicDocument.IsShowTableAdjustments();

    return true;
  };
  asc_docs_api.prototype.isShowEquationTrack = function () {
    var oLogicDocument = this.private_GetLogicDocument();
    if (oLogicDocument) return oLogicDocument.IsShowEquationTrack();
  ...
  asc_docs_api.prototype.updateDarkMode = function () {
    if (!this.WordControl || !this.WordControl.m_oDrawingDocument) return;
  ...
  asc_docs_api.prototype.getPageBackgroundColor = function () {
    ...
    if (this.isDarkMode) return { R: 0x3a, G: 0x3a, B: 0x3a };
    return { R: 0xff, G: 0xff, B: 0xff };
  };
  asc_docs_api.prototype.getPageStrokeColor = function () {
    // TODO: get color from theme
    if (this.isDarkMode) return "#616161";
  ...
  asc_docs_api.prototype.asc_GetSelectionBounds = function () {
    ...
    var oMatrix = oCurrentParagraph
      ? oCurrentParagraph.Get_ParentTextTransform()
      : null;
    if (oMatrix && !AscCommon.global_MatrixTransformer.IsIdentity(oMatrix)) {
      x0 = oMatrix.TransformPointX(
        oSelectBounds.Start.X,
        oSelectBounds.Start.Y
      );
      y0 = oMatrix.TransformPointY(
        oSelectBounds.Start.X,
        oSelectBounds.Start.Y
      );
      x1 = oMatrix.TransformPointX(
        oSelectBounds.Start.X,
        oSelectBounds.Start.Y + oSelectBounds.Start.H
      );
      y1 = oMatrix.TransformPointY(
        oSelectBounds.Start.X,
        oSelectBounds.Start.Y + oSelectBounds.Start.H
      );
      x2 = oMatrix.TransformPointX(
        oSelectBounds.End.X + oSelectBounds.End.W,
        oSelectBounds.End.Y
      );
      y2 = oMatrix.TransformPointY(
        oSelectBounds.End.X + oSelectBounds.End.W,
        oSelectBounds.End.Y
      );
      x3 = oMatrix.TransformPointX(
        oSelectBounds.End.X + oSelectBounds.End.W,
        oSelectBounds.End.Y + oSelectBounds.End.H
      );
      y3 = oMatrix.TransformPointY(
        oSelectBounds.End.X + oSelectBounds.End.W,
        oSelectBounds.End.Y + oSelectBounds.End.H
      );
    }

    var oPos0 = oDrawingDocument.ConvertCoordsToCursorWR(
      x0,
      y0,
      oSelectBounds.Start.Page,
      undefined,
      false
    );
    var oPos1 = oDrawingDocument.ConvertCoordsToCursorWR(
      x1,
      y1,
      oSelectBounds.Start.Page,
      undefined,
    ...
    var oPos2 = oDrawingDocument.ConvertCoordsToCursorWR(
      x2,
      y2,
      oSelectBounds.End.Page,
      undefined,
      false
    );
    var oPos3 = oDrawingDocument.ConvertCoordsToCursorWR(
      x3,
      y3,
      oSelectBounds.End.Page,
      undefined,
  ...
  asc_docs_api.prototype.putImageToSelection = function (
    sImageSrc,
    nWidth,
    nHeight,
    replaceMode
    ...
    return oDocument.PutImageToSelection(
      sImageSrc,
      nWidth,
      nHeight,
      replaceMode
  ...
  asc_docs_api.prototype.getPluginContextMenuInfo = function (e) {
    let logicDocument = this.private_GetLogicDocument();
    if (!logicDocument) return new AscCommon.CPluginCtxMenuInfo();

    let menuInfo;
    if (!logicDocument.IsSelectionUse()) {
      menuInfo = new AscCommon.CPluginCtxMenuInfo(
        Asc.c_oPluginContextMenuTypes.Target
      );
    } else {
      let drawingObjects = logicDocument.getDrawingObjects();
      if (
        drawingObjects.selectedObjects &&
        drawingObjects.selectedObjects.length > 0
      )
        menuInfo = drawingObjects.getPluginSelectionInfo();
      else
        menuInfo = new AscCommon.CPluginCtxMenuInfo(
          Asc.c_oPluginContextMenuTypes.Selection
        );
    }

    if (logicDocument.isHeaderEditing()) menuInfo.setHdrFtr(true);
    else if (logicDocument.isFooterEditing()) menuInfo.setHdrFtr(false);
  ...
  asc_docs_api.prototype.asc_getDocumentProtection = function () {
    let logicDocument = this.private_GetLogicDocument();
    if (!logicDocument || !logicDocument.IsDocumentEditor()) return null;

    let docProtection = logicDocument.GetDocumentSettings().DocumentProtection;
    if (!docProtection) return null;
  ...
  asc_docs_api.prototype.asc_setDocumentProtection = function (props) {
    ...
    let curDocProtection =
      oDocument.Settings && oDocument.Settings.DocumentProtection;
    if (curDocProtection) {
      //пытаемся выставить такие же настройки
      let curIsProtect =
        curDocProtection.edit != null &&
        curDocProtection.edit !== Asc.c_oAscEDocProtect.None &&
        curDocProtection.enforcement !== false;
      let isPropsProtect =
        props.edit != null &&
        props.edit !== Asc.c_oAscEDocProtect.None &&
        props.enforcement !== false;
    ...
    let callback = function (res) {
      ...
      if (res) {
        if (
          false ===
          oDocument.Document_Is_SelectionLocked(
            AscCommon.changestype_DocumentProtection,
            null,
            null,
            true
          )
          ...
          oDocument.StartAction(
            AscDFH.historydescription_Document_DocumentProtection
          );
        ...
        t.sendEvent(
          "asc_onError",
          c_oAscError.ID.PasswordIsNotCorrect,
          c_oAscError.Level.NoCritical
        );
      }
    };
      ...
      if (doNotCheckPassword) {
        ...
        if (
          ...
          if (
            documentProtection &&
            hash &&
            (hash[0] === documentHashValue || hash[1] === documentHashValue)
          ) {
            salt = null;
            alg = null;
            spinCount = null;
      ...
      if (password === "") {
        ...
        if (hashPassword) {
          hashArr.push({
            ...
            salt: salt,
            spinCount: spinCount,
            alg: AscCommon.fromModelCryptAlgorithmSid(alg),
          });
        }
        hashArr.push({
          password: password,
  ...
  // print-preview
  asc_docs_api.prototype.asc_initPrintPreview = function (
    containerId,
    options
  ) {
  ...
  asc_docs_api.prototype.asc_isAutoHyphenation = function () {
    ...
    return logicDocument
      ? logicDocument.getDocumentSettings().isAutoHyphenation()
      : false;
  };
  ...
  asc_docs_api.prototype.asc_isHyphenateCaps = function () {
    let logicDocument = this.private_GetLogicDocument();
    return logicDocument
      ? logicDocument.getDocumentSettings().isHyphenateCaps()
      : true;
  };
  ...
  asc_docs_api.prototype.asc_getConsecutiveHyphenLimit = function () {
    let logicDocument = this.private_GetLogicDocument();
    return logicDocument
      ? logicDocument.getDocumentSettings().getConsecutiveHyphenLimit()
      : 0;
  };
  asc_docs_api.prototype.asc_getAutoHyphenationSettings = function () {
    let logicDocument = this.private_GetLogicDocument();
    return logicDocument
      ? logicDocument.getAutoHyphenationSettings()
      : new AscCommon.AutoHyphenationSettings();
  };
  ...
  asc_docs_api.prototype.asc_putPageColor = function (color) {
    ...
    if (!color) {
      ...
      if (
        ...
        logicDocument.setBackgroundColor(
          new AscCommonWord.CDocumentColor(color.r, color.g, color.b, false),
          null
        );
      else
        logicDocument.setBackgroundColor(
          null,
          AscFormat.CreateUnifillFromAscColor(color)
        );
    }
  ...
  asc_docs_api.prototype.asc_insertTextFromFile = function () {
    const insertDocumentManager = new AscCommonWord.CInsertDocumentManager(
      this
    );
  ...
  asc_docs_api.prototype.asc_showDeletedTextInVersionHistory = function () {
    if (!this.getVersionHistory()) return false;
  ...
  asc_docs_api.prototype.asc_hideDeletedTextInVersionHistory = function () {
    if (!this.getVersionHistory()) return;
  ...
  asc_docs_api.prototype.modifyCustomProperty = function (
    idx,
    name,
    type,
    value
  ...
  asc_docs_api.prototype.onPluginClose = function (guid) {
    ...
    if (
      this.WordControl &&
      this.WordControl.m_oLogicDocument &&
      this.WordControl.m_oLogicDocument.DrawingDocument
    )
      this.WordControl.m_oLogicDocument.DrawingDocument.contentControls.removePluginButtons(
        guid
      );
  };
  asc_docs_api.prototype.onAttachPluginEvent = function (guid, name) {
    AscCommon.baseEditorsApi.prototype.onAttachPluginEvent.call(
      this,
      guid,
      name
    );
    ...
    if (
      "onShowContentControlTrack" === name &&
      this.WordControl &&
      this.WordControl.m_oDrawingDocument
    )
      this.WordControl.m_oDrawingDocument.contentControls.onAttachPluginEvent(
        guid
      );
  };
  ...
  asc_docs_api.prototype.asc_setNumeralType = function (type) {
    ...
    if (!symbols) redraw();
    else AscFonts.FontPickerByCharacter.checkText(symbols, this, redraw);
  };
  /**
  ...
  asc_docs_api.prototype.asc_getNumeralType = function () {
    let logicDocument = this.private_GetLogicDocument();
    return logicDocument
      ? logicDocument.GetNumeralType()
      : Asc.c_oNumeralType.arabic;
  };

  asc_docs_api.prototype.asc_isFinalizedVersion = function () {
    let logicDocument = this.private_GetLogicDocument();
    let oform = logicDocument ? logicDocument.GetOFormDocument() : null;
    if (oform && oform.isAllRolesFilled()) return true;
    return false;
  };
  ...
  CAscSection.prototype["get_PageHeight"] =
    CAscSection.prototype.get_PageHeight;
  CAscSection.prototype["get_MarginLeft"] =
    CAscSection.prototype.get_MarginLeft;
  CAscSection.prototype["get_MarginRight"] =
    CAscSection.prototype.get_MarginRight;
  CAscSection.prototype["get_MarginTop"] = CAscSection.prototype.get_MarginTop;
  CAscSection.prototype["get_MarginBottom"] =
    CAscSection.prototype.get_MarginBottom;
  ...
  CHeaderProp.prototype["get_DifferentFirst"] =
    CHeaderProp.prototype.get_DifferentFirst;
  CHeaderProp.prototype["put_DifferentFirst"] =
    CHeaderProp.prototype.put_DifferentFirst;
  CHeaderProp.prototype["get_DifferentEvenOdd"] =
    CHeaderProp.prototype.get_DifferentEvenOdd;
  CHeaderProp.prototype["put_DifferentEvenOdd"] =
    CHeaderProp.prototype.put_DifferentEvenOdd;
  CHeaderProp.prototype["get_LinkToPrevious"] =
    CHeaderProp.prototype.get_LinkToPrevious;
  CHeaderProp.prototype["get_Locked"] = CHeaderProp.prototype.get_Locked;
  CHeaderProp.prototype["get_StartPageNumber"] =
    CHeaderProp.prototype.get_StartPageNumber;
  CHeaderProp.prototype["put_StartPageNumber"] =
    CHeaderProp.prototype.put_StartPageNumber;
  ...
  window["Asc"]["CMailMergeSendData"] = window["Asc"].CMailMergeSendData =
    CMailMergeSendData;
  CMailMergeSendData.prototype["get_From"] =
    CMailMergeSendData.prototype.get_From;
  CMailMergeSendData.prototype["put_From"] =
    CMailMergeSendData.prototype.put_From;
  ...
  CMailMergeSendData.prototype["get_Subject"] =
    CMailMergeSendData.prototype.get_Subject;
  CMailMergeSendData.prototype["put_Subject"] =
    CMailMergeSendData.prototype.put_Subject;
  CMailMergeSendData.prototype["get_MailFormat"] =
    CMailMergeSendData.prototype.get_MailFormat;
  CMailMergeSendData.prototype["put_MailFormat"] =
    CMailMergeSendData.prototype.put_MailFormat;
  CMailMergeSendData.prototype["get_FileName"] =
    CMailMergeSendData.prototype.get_FileName;
  CMailMergeSendData.prototype["put_FileName"] =
    CMailMergeSendData.prototype.put_FileName;
  CMailMergeSendData.prototype["get_Message"] =
    CMailMergeSendData.prototype.get_Message;
  CMailMergeSendData.prototype["put_Message"] =
    CMailMergeSendData.prototype.put_Message;
  CMailMergeSendData.prototype["get_RecordFrom"] =
    CMailMergeSendData.prototype.get_RecordFrom;
  CMailMergeSendData.prototype["put_RecordFrom"] =
    CMailMergeSendData.prototype.put_RecordFrom;
  CMailMergeSendData.prototype["get_RecordTo"] =
    CMailMergeSendData.prototype.get_RecordTo;
  CMailMergeSendData.prototype["put_RecordTo"] =
    CMailMergeSendData.prototype.put_RecordTo;
  CMailMergeSendData.prototype["get_RecordCount"] =
    CMailMergeSendData.prototype.get_RecordCount;
  CMailMergeSendData.prototype["put_RecordCount"] =
    CMailMergeSendData.prototype.put_RecordCount;
  CMailMergeSendData.prototype["get_UserId"] =
    CMailMergeSendData.prototype.get_UserId;
  CMailMergeSendData.prototype["put_UserId"] =
    CMailMergeSendData.prototype.put_UserId;
  window["Asc"]["CAscFootnotePr"] = window["Asc"].CAscFootnotePr =
    CAscFootnotePr;
  ...
  CAscFootnotePr.prototype["get_NumStart"] =
    CAscFootnotePr.prototype.get_NumStart;
  CAscFootnotePr.prototype["put_NumStart"] =
    CAscFootnotePr.prototype.put_NumStart;
  CAscFootnotePr.prototype["get_NumFormat"] =
    CAscFootnotePr.prototype.get_NumFormat;
  CAscFootnotePr.prototype["put_NumFormat"] =
    CAscFootnotePr.prototype.put_NumFormat;
  CAscFootnotePr.prototype["get_NumRestart"] =
    CAscFootnotePr.prototype.get_NumRestart;
  CAscFootnotePr.prototype["put_NumRestart"] =
    CAscFootnotePr.prototype.put_NumRestart;
  window["Asc"]["asc_docs_api"] = window["Asc"].asc_docs_api = asc_docs_api;
  asc_docs_api.prototype["SetCollaborativeMarksShowType"] =
    asc_docs_api.prototype.SetCollaborativeMarksShowType;
  asc_docs_api.prototype["GetCollaborativeMarksShowType"] =
    asc_docs_api.prototype.GetCollaborativeMarksShowType;
  asc_docs_api.prototype["Clear_CollaborativeMarks"] =
    asc_docs_api.prototype.Clear_CollaborativeMarks;
  asc_docs_api.prototype["SetLanguage"] = asc_docs_api.prototype.SetLanguage;
  asc_docs_api.prototype["asc_GetFontThumbnailsPath"] =
    asc_docs_api.prototype.asc_GetFontThumbnailsPath;
  asc_docs_api.prototype["TranslateStyleName"] =
    asc_docs_api.prototype.TranslateStyleName;
  asc_docs_api.prototype["CheckChangedDocument"] =
    asc_docs_api.prototype.CheckChangedDocument;
  asc_docs_api.prototype["SetUnchangedDocument"] =
    asc_docs_api.prototype.SetUnchangedDocument;
  asc_docs_api.prototype["SetDocumentModified"] =
    asc_docs_api.prototype.SetDocumentModified;
  asc_docs_api.prototype["isDocumentModified"] =
    asc_docs_api.prototype.isDocumentModified;
  asc_docs_api.prototype["asc_isDocumentCanSave"] =
    asc_docs_api.prototype.asc_isDocumentCanSave;
  asc_docs_api.prototype["asc_getCanUndo"] =
    asc_docs_api.prototype.asc_getCanUndo;
  asc_docs_api.prototype["asc_getCanRedo"] =
    asc_docs_api.prototype.asc_getCanRedo;
  asc_docs_api.prototype["sync_BeginCatchSelectedElements"] =
    asc_docs_api.prototype.sync_BeginCatchSelectedElements;
  asc_docs_api.prototype["sync_EndCatchSelectedElements"] =
    asc_docs_api.prototype.sync_EndCatchSelectedElements;
  asc_docs_api.prototype["getSelectedElements"] =
    asc_docs_api.prototype.getSelectedElements;
  asc_docs_api.prototype["sync_ChangeLastSelectedElement"] =
    asc_docs_api.prototype.sync_ChangeLastSelectedElement;
  asc_docs_api.prototype["asc_getEditorPermissions"] =
    asc_docs_api.prototype.asc_getEditorPermissions;
  asc_docs_api.prototype["asc_setDocInfo"] =
    asc_docs_api.prototype.asc_setDocInfo;
  asc_docs_api.prototype["asc_changeDocInfo"] =
    asc_docs_api.prototype.asc_changeDocInfo;
  asc_docs_api.prototype["asc_setLocale"] =
    asc_docs_api.prototype.asc_setLocale;
  asc_docs_api.prototype["asc_getLocale"] =
    asc_docs_api.prototype.asc_getLocale;
  asc_docs_api.prototype["asc_LoadDocument"] =
    asc_docs_api.prototype.asc_LoadDocument;
  asc_docs_api.prototype["SetTextBoxInputMode"] =
    asc_docs_api.prototype.SetTextBoxInputMode;
  asc_docs_api.prototype["GetTextBoxInputMode"] =
    asc_docs_api.prototype.GetTextBoxInputMode;
  asc_docs_api.prototype["ChangeReaderMode"] =
    asc_docs_api.prototype.ChangeReaderMode;
  asc_docs_api.prototype["SetReaderModeOnly"] =
    asc_docs_api.prototype.SetReaderModeOnly;
  asc_docs_api.prototype["IncreaseReaderFontSize"] =
    asc_docs_api.prototype.IncreaseReaderFontSize;
  asc_docs_api.prototype["DecreaseReaderFontSize"] =
    asc_docs_api.prototype.DecreaseReaderFontSize;
  asc_docs_api.prototype["SetMobileTopOffset"] =
    asc_docs_api.prototype.SetMobileTopOffset;
  asc_docs_api.prototype["CreateCSS"] = asc_docs_api.prototype.CreateCSS;
  asc_docs_api.prototype["GetCopyPasteDivId"] =
    asc_docs_api.prototype.GetCopyPasteDivId;
  asc_docs_api.prototype["ContentToHTML"] =
    asc_docs_api.prototype.ContentToHTML;
  ...
  asc_docs_api.prototype["OpenDocumentFromBin"] =
    asc_docs_api.prototype.OpenDocumentFromBin;
  asc_docs_api.prototype["OpenDocumentFromZip"] =
    asc_docs_api.prototype.OpenDocumentFromZip;
  asc_docs_api.prototype["asc_getDocumentName"] =
    asc_docs_api.prototype.asc_getDocumentName;
  asc_docs_api.prototype["asc_getAppProps"] =
    asc_docs_api.prototype.asc_getAppProps;
  asc_docs_api.prototype["asc_getCoreProps"] =
    asc_docs_api.prototype.asc_getCoreProps;
  asc_docs_api.prototype["asc_setCoreProps"] =
    asc_docs_api.prototype.asc_setCoreProps;
  asc_docs_api.prototype["asc_getPdfProps"] =
    asc_docs_api.prototype.asc_getPdfProps;
  asc_docs_api.prototype["asc_isCompatibilityMode"] =
    asc_docs_api.prototype.asc_isCompatibilityMode;
  asc_docs_api.prototype["asc_registerCallback"] =
    asc_docs_api.prototype.asc_registerCallback;
  asc_docs_api.prototype["asc_unregisterCallback"] =
    asc_docs_api.prototype.asc_unregisterCallback;
  asc_docs_api.prototype["asc_checkNeedCallback"] =
    asc_docs_api.prototype.asc_checkNeedCallback;
  asc_docs_api.prototype["asc_getPropertyEditorShapes"] =
    asc_docs_api.prototype.asc_getPropertyEditorShapes;
  asc_docs_api.prototype["asc_getPropertyEditorTextArts"] =
    asc_docs_api.prototype.asc_getPropertyEditorTextArts;
  asc_docs_api.prototype["get_PropertyThemeColors"] =
    asc_docs_api.prototype.get_PropertyThemeColors;
  asc_docs_api.prototype["_coAuthoringSetChange"] =
    asc_docs_api.prototype._coAuthoringSetChange;
  asc_docs_api.prototype["_coAuthoringSetChanges"] =
    asc_docs_api.prototype._coAuthoringSetChanges;
  asc_docs_api.prototype["asc_coAuthoringChatSendMessage"] =
    asc_docs_api.prototype.asc_coAuthoringChatSendMessage;
  asc_docs_api.prototype["asc_coAuthoringChatGetMessages"] =
    asc_docs_api.prototype.asc_coAuthoringChatGetMessages;
  asc_docs_api.prototype["asc_coAuthoringGetUsers"] =
    asc_docs_api.prototype.asc_coAuthoringGetUsers;
  asc_docs_api.prototype["asc_coAuthoringDisconnect"] =
    asc_docs_api.prototype.asc_coAuthoringDisconnect;
  asc_docs_api.prototype["asc_SpellCheckDisconnect"] =
    asc_docs_api.prototype.asc_SpellCheckDisconnect;
  asc_docs_api.prototype["_onUpdateDocumentCanSave"] =
    asc_docs_api.prototype._onUpdateDocumentCanSave;
  asc_docs_api.prototype["put_FramePr"] = asc_docs_api.prototype.put_FramePr;
  asc_docs_api.prototype["asyncFontEndLoaded_MathDraw"] =
    asc_docs_api.prototype.asyncFontEndLoaded_MathDraw;
  asc_docs_api.prototype["sendMathTypesToMenu"] =
    asc_docs_api.prototype.sendMathTypesToMenu;
  asc_docs_api.prototype["asyncFontEndLoaded_DropCap"] =
    asc_docs_api.prototype.asyncFontEndLoaded_DropCap;
  asc_docs_api.prototype["asc_addDropCap"] =
    asc_docs_api.prototype.asc_addDropCap;
  asc_docs_api.prototype["removeDropcap"] =
    asc_docs_api.prototype.removeDropcap;
  asc_docs_api.prototype["get_TextProps"] =
    asc_docs_api.prototype.get_TextProps;
  asc_docs_api.prototype["GetJSONLogicDocument"] =
    asc_docs_api.prototype.GetJSONLogicDocument;
  asc_docs_api.prototype["get_ContentCount"] =
    asc_docs_api.prototype.get_ContentCount;
  asc_docs_api.prototype["select_Element"] =
    asc_docs_api.prototype.select_Element;
  asc_docs_api.prototype["UpdateTextPr"] = asc_docs_api.prototype.UpdateTextPr;
  asc_docs_api.prototype["UpdateParagraphProp"] =
    asc_docs_api.prototype.UpdateParagraphProp;
  ...
  asc_docs_api.prototype["Update_ParaTab"] =
    asc_docs_api.prototype.Update_ParaTab;
  ...
  asc_docs_api.prototype["asc_setIsForceSaveOnUserSave"] =
    asc_docs_api.prototype.asc_setIsForceSaveOnUserSave;
  asc_docs_api.prototype["asc_DownloadAs"] =
    asc_docs_api.prototype.asc_DownloadAs;
  asc_docs_api.prototype["asc_DownloadAsMailMerge"] =
    asc_docs_api.prototype.asc_DownloadAsMailMerge;
  asc_docs_api.prototype["asc_DownloadOrigin"] =
    asc_docs_api.prototype.asc_DownloadOrigin;
  ...
  asc_docs_api.prototype["asc_setAdvancedOptions"] =
    asc_docs_api.prototype.asc_setAdvancedOptions;
  asc_docs_api.prototype["asc_decodeBuffer"] =
    asc_docs_api.prototype.asc_decodeBuffer;
  asc_docs_api.prototype["SetFontRenderingMode"] =
    asc_docs_api.prototype.SetFontRenderingMode;
  asc_docs_api.prototype["startGetDocInfo"] =
    asc_docs_api.prototype.startGetDocInfo;
  asc_docs_api.prototype["stopGetDocInfo"] =
    asc_docs_api.prototype.stopGetDocInfo;
  asc_docs_api.prototype["sync_DocInfoCallback"] =
    asc_docs_api.prototype.sync_DocInfoCallback;
  asc_docs_api.prototype["sync_GetDocInfoStartCallback"] =
    asc_docs_api.prototype.sync_GetDocInfoStartCallback;
  asc_docs_api.prototype["sync_GetDocInfoStopCallback"] =
    asc_docs_api.prototype.sync_GetDocInfoStopCallback;
  asc_docs_api.prototype["sync_GetDocInfoEndCallback"] =
    asc_docs_api.prototype.sync_GetDocInfoEndCallback;
  ...
  asc_docs_api.prototype["sync_CanCopyCutCallback"] =
    asc_docs_api.prototype.sync_CanCopyCutCallback;
  asc_docs_api.prototype["setStartPointHistory"] =
    asc_docs_api.prototype.setStartPointHistory;
  asc_docs_api.prototype["setEndPointHistory"] =
    asc_docs_api.prototype.setEndPointHistory;
  asc_docs_api.prototype["sync_CursorLockCallBack"] =
    asc_docs_api.prototype.sync_CursorLockCallBack;
  asc_docs_api.prototype["sync_UndoCallBack"] =
    asc_docs_api.prototype.sync_UndoCallBack;
  asc_docs_api.prototype["sync_RedoCallBack"] =
    asc_docs_api.prototype.sync_RedoCallBack;
  asc_docs_api.prototype["sync_CopyCallBack"] =
    asc_docs_api.prototype.sync_CopyCallBack;
  asc_docs_api.prototype["sync_CutCallBack"] =
    asc_docs_api.prototype.sync_CutCallBack;
  asc_docs_api.prototype["sync_PasteCallBack"] =
    asc_docs_api.prototype.sync_PasteCallBack;
  asc_docs_api.prototype["sync_ShareCallBack"] =
    asc_docs_api.prototype.sync_ShareCallBack;
  asc_docs_api.prototype["sync_SaveCallBack"] =
    asc_docs_api.prototype.sync_SaveCallBack;
  asc_docs_api.prototype["sync_DownloadAsCallBack"] =
    asc_docs_api.prototype.sync_DownloadAsCallBack;
  asc_docs_api.prototype["sync_StartAction"] =
    asc_docs_api.prototype.sync_StartAction;
  asc_docs_api.prototype["sync_EndAction"] =
    asc_docs_api.prototype.sync_EndAction;
  asc_docs_api.prototype["sync_AddURLCallback"] =
    asc_docs_api.prototype.sync_AddURLCallback;
  asc_docs_api.prototype["sync_ErrorCallback"] =
    asc_docs_api.prototype.sync_ErrorCallback;
  asc_docs_api.prototype["sync_HelpCallback"] =
    asc_docs_api.prototype.sync_HelpCallback;
  asc_docs_api.prototype["sync_UpdateZoom"] =
    asc_docs_api.prototype.sync_UpdateZoom;
  asc_docs_api.prototype["ClearPropObjCallback"] =
    asc_docs_api.prototype.ClearPropObjCallback;
  asc_docs_api.prototype["CollectHeaders"] =
    asc_docs_api.prototype.CollectHeaders;
  asc_docs_api.prototype["GetActiveHeader"] =
    asc_docs_api.prototype.GetActiveHeader;
  asc_docs_api.prototype["gotoHeader"] = asc_docs_api.prototype.gotoHeader;
  asc_docs_api.prototype["sync_ChangeActiveHeaderCallback"] =
    asc_docs_api.prototype.sync_ChangeActiveHeaderCallback;
  asc_docs_api.prototype["sync_ReturnHeadersCallback"] =
    asc_docs_api.prototype.sync_ReturnHeadersCallback;
  asc_docs_api.prototype["asc_searchEnabled"] =
    asc_docs_api.prototype.asc_searchEnabled;
  asc_docs_api.prototype["asc_findText"] = asc_docs_api.prototype.asc_findText;
  asc_docs_api.prototype["asc_endFindText"] =
    asc_docs_api.prototype.asc_endFindText;
  asc_docs_api.prototype["asc_replaceText"] =
    asc_docs_api.prototype.asc_replaceText;
  asc_docs_api.prototype["asc_GetErrorForReplaceString"] =
    asc_docs_api.prototype.asc_GetErrorForReplaceString;
  asc_docs_api.prototype["asc_isSelectSearchingResults"] =
    asc_docs_api.prototype.asc_isSelectSearchingResults;
  asc_docs_api.prototype["asc_StartTextAroundSearch"] =
    asc_docs_api.prototype.asc_StartTextAroundSearch;
  asc_docs_api.prototype["asc_SelectSearchElement"] =
    asc_docs_api.prototype.asc_SelectSearchElement;
  asc_docs_api.prototype["sync_ReplaceAllCallback"] =
    asc_docs_api.prototype.sync_ReplaceAllCallback;
  asc_docs_api.prototype["sync_SearchEndCallback"] =
    asc_docs_api.prototype.sync_SearchEndCallback;
  asc_docs_api.prototype["put_TextPrFontName"] =
    asc_docs_api.prototype.put_TextPrFontName;
  asc_docs_api.prototype["put_TextPrFontSize"] =
    asc_docs_api.prototype.put_TextPrFontSize;
  asc_docs_api.prototype["put_TextPrBold"] =
    asc_docs_api.prototype.put_TextPrBold;
  asc_docs_api.prototype["put_TextPrItalic"] =
    asc_docs_api.prototype.put_TextPrItalic;
  asc_docs_api.prototype["put_TextPrUnderline"] =
    asc_docs_api.prototype.put_TextPrUnderline;
  asc_docs_api.prototype["put_TextPrStrikeout"] =
    asc_docs_api.prototype.put_TextPrStrikeout;
  asc_docs_api.prototype["put_TextPrDStrikeout"] =
    asc_docs_api.prototype.put_TextPrDStrikeout;
  asc_docs_api.prototype["put_TextPrSpacing"] =
    asc_docs_api.prototype.put_TextPrSpacing;
  asc_docs_api.prototype["put_TextPrCaps"] =
    asc_docs_api.prototype.put_TextPrCaps;
  asc_docs_api.prototype["put_TextPrSmallCaps"] =
    asc_docs_api.prototype.put_TextPrSmallCaps;
  asc_docs_api.prototype["put_TextPrPosition"] =
    asc_docs_api.prototype.put_TextPrPosition;
  asc_docs_api.prototype["put_TextPrLang"] =
    asc_docs_api.prototype.put_TextPrLang;
  asc_docs_api.prototype["asc_setRtlTextDirection"] =
    asc_docs_api.prototype.asc_setRtlTextDirection;
  asc_docs_api.prototype["asc_isRtlTextDirection"] =
    asc_docs_api.prototype.asc_isRtlTextDirection;
  asc_docs_api.prototype["asc_addSpaceBeforeParagraph"] =
    asc_docs_api.prototype.asc_addSpaceBeforeParagraph;
  asc_docs_api.prototype["asc_addSpaceAfterParagraph"] =
    asc_docs_api.prototype.asc_addSpaceAfterParagraph;
  asc_docs_api.prototype["asc_removeSpaceBeforeParagraph"] =
    asc_docs_api.prototype.asc_removeSpaceBeforeParagraph;
  asc_docs_api.prototype["asc_removeSpaceAfterParagraph"] =
    asc_docs_api.prototype.asc_removeSpaceAfterParagraph;
  asc_docs_api.prototype["asc_haveSpaceBeforeParagraph"] =
    asc_docs_api.prototype.asc_haveSpaceBeforeParagraph;
  asc_docs_api.prototype["asc_haveSpaceAfterParagraph"] =
    asc_docs_api.prototype.asc_haveSpaceAfterParagraph;
  asc_docs_api.prototype["put_PrLineSpacing"] =
    asc_docs_api.prototype.put_PrLineSpacing;
  asc_docs_api.prototype["put_LineSpacingBeforeAfter"] =
    asc_docs_api.prototype.put_LineSpacingBeforeAfter;
  ...
  asc_docs_api.prototype["sync_BoldCallBack"] =
    asc_docs_api.prototype.sync_BoldCallBack;
  asc_docs_api.prototype["sync_ItalicCallBack"] =
    asc_docs_api.prototype.sync_ItalicCallBack;
  asc_docs_api.prototype["sync_UnderlineCallBack"] =
    asc_docs_api.prototype.sync_UnderlineCallBack;
  asc_docs_api.prototype["sync_StrikeoutCallBack"] =
    asc_docs_api.prototype.sync_StrikeoutCallBack;
  asc_docs_api.prototype["sync_TextPrFontFamilyCallBack"] =
    asc_docs_api.prototype.sync_TextPrFontFamilyCallBack;
  asc_docs_api.prototype["sync_TextPrFontSizeCallBack"] =
    asc_docs_api.prototype.sync_TextPrFontSizeCallBack;
  asc_docs_api.prototype["sync_PrLineSpacingCallBack"] =
    asc_docs_api.prototype.sync_PrLineSpacingCallBack;
  ...
  asc_docs_api.prototype["put_TextPrBaseline"] =
    asc_docs_api.prototype.put_TextPrBaseline;
  asc_docs_api.prototype["asc_IsShowListIndentsSettings"] =
    asc_docs_api.prototype.asc_IsShowListIndentsSettings;
  asc_docs_api.prototype["put_ListType"] = asc_docs_api.prototype.put_ListType;
  asc_docs_api.prototype["put_ListTypeCustom"] =
    asc_docs_api.prototype.put_ListTypeCustom;
  asc_docs_api.prototype["asc_GetCurrentNumberingJson"] =
    asc_docs_api.prototype.asc_GetCurrentNumberingJson;
  asc_docs_api.prototype["asc_IsCurrentNumberingPreset"] =
    asc_docs_api.prototype.asc_IsCurrentNumberingPreset;
  asc_docs_api.prototype["asc_CompareNumberingPresets"] =
    asc_docs_api.prototype.asc_CompareNumberingPresets;
  asc_docs_api.prototype["asc_ContinueNumbering"] =
    asc_docs_api.prototype.asc_ContinueNumbering;
  asc_docs_api.prototype["asc_RestartNumbering"] =
    asc_docs_api.prototype.asc_RestartNumbering;
  asc_docs_api.prototype["asc_GetCurrentNumberingId"] =
    asc_docs_api.prototype.asc_GetCurrentNumberingId;
  asc_docs_api.prototype["asc_GetCurrentNumberingLvl"] =
    asc_docs_api.prototype.asc_GetCurrentNumberingLvl;
  asc_docs_api.prototype["asc_GetCalculatedNumberingValue"] =
    asc_docs_api.prototype.asc_GetCalculatedNumberingValue;
  asc_docs_api.prototype["asc_GetNumberingPr"] =
    asc_docs_api.prototype.asc_GetNumberingPr;
  asc_docs_api.prototype["asc_AddNewNumbering"] =
    asc_docs_api.prototype.asc_AddNewNumbering;
  asc_docs_api.prototype["asc_ChangeNumberingLvl"] =
    asc_docs_api.prototype.asc_ChangeNumberingLvl;
  asc_docs_api.prototype["asc_SetNumberingLvl"] =
    asc_docs_api.prototype.asc_SetNumberingLvl;
  asc_docs_api.prototype["put_Style"] = asc_docs_api.prototype.put_Style;
  asc_docs_api.prototype["asc_SetParagraphSuppressLineNumbers"] =
    asc_docs_api.prototype.asc_SetParagraphSuppressLineNumbers;
  asc_docs_api.prototype["SetDeviceInputHelperId"] =
    asc_docs_api.prototype.SetDeviceInputHelperId;
  asc_docs_api.prototype["put_ShowSnapLines"] =
    asc_docs_api.prototype.put_ShowSnapLines;
  asc_docs_api.prototype["get_ShowSnapLines"] =
    asc_docs_api.prototype.get_ShowSnapLines;
  asc_docs_api.prototype["put_ShowSmartGuides"] =
    asc_docs_api.prototype.put_ShowSmartGuides;
  asc_docs_api.prototype["get_ShowSmartGuides"] =
    asc_docs_api.prototype.get_ShowSmartGuides;
  asc_docs_api.prototype["put_ShowParaMarks"] =
    asc_docs_api.prototype.put_ShowParaMarks;
  asc_docs_api.prototype["get_ShowParaMarks"] =
    asc_docs_api.prototype.get_ShowParaMarks;
  asc_docs_api.prototype["put_ShowTableEmptyLine"] =
    asc_docs_api.prototype.put_ShowTableEmptyLine;
  asc_docs_api.prototype["get_ShowTableEmptyLine"] =
    asc_docs_api.prototype.get_ShowTableEmptyLine;
  asc_docs_api.prototype["put_PageBreak"] =
    asc_docs_api.prototype.put_PageBreak;
  asc_docs_api.prototype["put_WidowControl"] =
    asc_docs_api.prototype.put_WidowControl;
  asc_docs_api.prototype["put_KeepLines"] =
    asc_docs_api.prototype.put_KeepLines;
  asc_docs_api.prototype["put_KeepNext"] = asc_docs_api.prototype.put_KeepNext;
  asc_docs_api.prototype["put_AddSpaceBetweenPrg"] =
    asc_docs_api.prototype.put_AddSpaceBetweenPrg;
  asc_docs_api.prototype["put_LineHighLight"] =
    asc_docs_api.prototype.put_LineHighLight;
  asc_docs_api.prototype["put_TextColor"] =
    asc_docs_api.prototype.put_TextColor;
  asc_docs_api.prototype["put_ParagraphShade"] =
    asc_docs_api.prototype.put_ParagraphShade;
  asc_docs_api.prototype["put_PrIndent"] = asc_docs_api.prototype.put_PrIndent;
  asc_docs_api.prototype["put_ParagraphOutlineLvl"] =
    asc_docs_api.prototype.put_ParagraphOutlineLvl;
  asc_docs_api.prototype["IncreaseIndent"] =
    asc_docs_api.prototype.IncreaseIndent;
  asc_docs_api.prototype["DecreaseIndent"] =
    asc_docs_api.prototype.DecreaseIndent;
  asc_docs_api.prototype["put_PrIndentRight"] =
    asc_docs_api.prototype.put_PrIndentRight;
  asc_docs_api.prototype["put_PrFirstLineIndent"] =
    asc_docs_api.prototype.put_PrFirstLineIndent;
  asc_docs_api.prototype["put_Margins"] = asc_docs_api.prototype.put_Margins;
  asc_docs_api.prototype["getFocusObject"] =
    asc_docs_api.prototype.getFocusObject;
  asc_docs_api.prototype["sync_VerticalAlign"] =
    asc_docs_api.prototype.sync_VerticalAlign;
  asc_docs_api.prototype["sync_PrAlignCallBack"] =
    asc_docs_api.prototype.sync_PrAlignCallBack;
  asc_docs_api.prototype["sync_TextColor"] =
    asc_docs_api.prototype.sync_TextColor;
  asc_docs_api.prototype["sync_TextHighLight"] =
    asc_docs_api.prototype.sync_TextHighLight;
  asc_docs_api.prototype["sync_TextSpacing"] =
    asc_docs_api.prototype.sync_TextSpacing;
  asc_docs_api.prototype["sync_TextDStrikeout"] =
    asc_docs_api.prototype.sync_TextDStrikeout;
  asc_docs_api.prototype["sync_TextCaps"] =
    asc_docs_api.prototype.sync_TextCaps;
  asc_docs_api.prototype["sync_TextSmallCaps"] =
    asc_docs_api.prototype.sync_TextSmallCaps;
  asc_docs_api.prototype["sync_TextPosition"] =
    asc_docs_api.prototype.sync_TextPosition;
  asc_docs_api.prototype["sync_TextLangCallBack"] =
    asc_docs_api.prototype.sync_TextLangCallBack;
  asc_docs_api.prototype["sync_ParaStyleName"] =
    asc_docs_api.prototype.sync_ParaStyleName;
  asc_docs_api.prototype["sync_ParaSpacingLine"] =
    asc_docs_api.prototype.sync_ParaSpacingLine;
  asc_docs_api.prototype["sync_PageBreakCallback"] =
    asc_docs_api.prototype.sync_PageBreakCallback;
  asc_docs_api.prototype["sync_WidowControlCallback"] =
    asc_docs_api.prototype.sync_WidowControlCallback;
  asc_docs_api.prototype["sync_KeepNextCallback"] =
    asc_docs_api.prototype.sync_KeepNextCallback;
  asc_docs_api.prototype["sync_KeepLinesCallback"] =
    asc_docs_api.prototype.sync_KeepLinesCallback;
  asc_docs_api.prototype["sync_ShowParaMarksCallback"] =
    asc_docs_api.prototype.sync_ShowParaMarksCallback;
  asc_docs_api.prototype["sync_SpaceBetweenPrgCallback"] =
    asc_docs_api.prototype.sync_SpaceBetweenPrgCallback;
  asc_docs_api.prototype["sync_RangePermPropCallback"] =
    asc_docs_api.prototype.sync_RangePermPropCallback;
  asc_docs_api.prototype["sync_PrPropCallback"] =
    asc_docs_api.prototype.sync_PrPropCallback;
  asc_docs_api.prototype["sync_MathPropCallback"] =
    asc_docs_api.prototype.sync_MathPropCallback;
  asc_docs_api.prototype["sync_EndAddShape"] =
    asc_docs_api.prototype.sync_EndAddShape;
  asc_docs_api.prototype["SetDrawingFreeze"] =
    asc_docs_api.prototype.SetDrawingFreeze;
  asc_docs_api.prototype["change_PageOrient"] =
    asc_docs_api.prototype.change_PageOrient;
  asc_docs_api.prototype["get_DocumentOrientation"] =
    asc_docs_api.prototype.get_DocumentOrientation;
  asc_docs_api.prototype["change_DocSize"] =
    asc_docs_api.prototype.change_DocSize;
  asc_docs_api.prototype["get_DocumentWidth"] =
    asc_docs_api.prototype.get_DocumentWidth;
  asc_docs_api.prototype["get_DocumentHeight"] =
    asc_docs_api.prototype.get_DocumentHeight;
  asc_docs_api.prototype["put_AddPageBreak"] =
    asc_docs_api.prototype.put_AddPageBreak;
  asc_docs_api.prototype["put_AddColumnBreak"] =
    asc_docs_api.prototype.put_AddColumnBreak;
  asc_docs_api.prototype["Update_ParaInd"] =
    asc_docs_api.prototype.Update_ParaInd;
  asc_docs_api.prototype["Internal_Update_Ind_FirstLine"] =
    asc_docs_api.prototype.Internal_Update_Ind_FirstLine;
  asc_docs_api.prototype["Internal_Update_Ind_Left"] =
    asc_docs_api.prototype.Internal_Update_Ind_Left;
  asc_docs_api.prototype["Internal_Update_Ind_Right"] =
    asc_docs_api.prototype.Internal_Update_Ind_Right;
  asc_docs_api.prototype["put_PageNum"] = asc_docs_api.prototype.put_PageNum;
  asc_docs_api.prototype["put_HeadersAndFootersDistance"] =
    asc_docs_api.prototype.put_HeadersAndFootersDistance;
  asc_docs_api.prototype["HeadersAndFooters_DifferentFirstPage"] =
    asc_docs_api.prototype.HeadersAndFooters_DifferentFirstPage;
  asc_docs_api.prototype["HeadersAndFooters_DifferentOddandEvenPage"] =
    asc_docs_api.prototype.HeadersAndFooters_DifferentOddandEvenPage;
  asc_docs_api.prototype["HeadersAndFooters_LinkToPrevious"] =
    asc_docs_api.prototype.HeadersAndFooters_LinkToPrevious;
  asc_docs_api.prototype["asc_SetSectionStartPage"] =
    asc_docs_api.prototype.asc_SetSectionStartPage;
  asc_docs_api.prototype["asc_SetSectionPageNumFormat"] =
    asc_docs_api.prototype.asc_SetSectionPageNumFormat;
  asc_docs_api.prototype["sync_DocSizeCallback"] =
    asc_docs_api.prototype.sync_DocSizeCallback;
  asc_docs_api.prototype["sync_PageOrientCallback"] =
    asc_docs_api.prototype.sync_PageOrientCallback;
  asc_docs_api.prototype["sync_HeadersAndFootersPropCallback"] =
    asc_docs_api.prototype.sync_HeadersAndFootersPropCallback;
  ...
  asc_docs_api.prototype["addColumnLeft"] =
    asc_docs_api.prototype.addColumnLeft;
  asc_docs_api.prototype["addColumnRight"] =
    asc_docs_api.prototype.addColumnRight;
  ...
  asc_docs_api.prototype["setColumnWidth"] =
    asc_docs_api.prototype.setColumnWidth;
  asc_docs_api.prototype["setRowHeight"] = asc_docs_api.prototype.setRowHeight;
  asc_docs_api.prototype["set_TblDistanceFromText"] =
    asc_docs_api.prototype.set_TblDistanceFromText;
  ...
  asc_docs_api.prototype["asc_DistributeTableCells"] =
    asc_docs_api.prototype.asc_DistributeTableCells;
  asc_docs_api.prototype["asc_RemoveTableCells"] =
    asc_docs_api.prototype.asc_RemoveTableCells;
  ...
  asc_docs_api.prototype["set_TableBackground"] =
    asc_docs_api.prototype.set_TableBackground;
  asc_docs_api.prototype["set_AlignCell"] =
    asc_docs_api.prototype.set_AlignCell;
  asc_docs_api.prototype["set_TblAlign"] = asc_docs_api.prototype.set_TblAlign;
  asc_docs_api.prototype["set_SpacingBetweenCells"] =
    asc_docs_api.prototype.set_SpacingBetweenCells;
  asc_docs_api.prototype["tblApply"] = asc_docs_api.prototype.tblApply;
  asc_docs_api.prototype["sync_AddTableCallback"] =
    asc_docs_api.prototype.sync_AddTableCallback;
  asc_docs_api.prototype["sync_AlignCellCallback"] =
    asc_docs_api.prototype.sync_AlignCellCallback;
  asc_docs_api.prototype["sync_TblPropCallback"] =
    asc_docs_api.prototype.sync_TblPropCallback;
  asc_docs_api.prototype["sync_TblWrapStyleChangedCallback"] =
    asc_docs_api.prototype.sync_TblWrapStyleChangedCallback;
  asc_docs_api.prototype["sync_TblAlignChangedCallback"] =
    asc_docs_api.prototype.sync_TblAlignChangedCallback;
  asc_docs_api.prototype["ChangeImageFromFile"] =
    asc_docs_api.prototype.ChangeImageFromFile;
  asc_docs_api.prototype["ChangeShapeImageFromFile"] =
    asc_docs_api.prototype.ChangeShapeImageFromFile;
  ...
  asc_docs_api.prototype["AddImageUrlAction"] =
    asc_docs_api.prototype.AddImageUrlAction;
  asc_docs_api.prototype["AddImageToPage"] =
    asc_docs_api.prototype.AddImageToPage;
  asc_docs_api.prototype["asc_getSelectedDrawingObjectsCount"] =
    asc_docs_api.prototype.asc_getSelectedDrawingObjectsCount;
  asc_docs_api.prototype["put_ShapesAlign"] =
    asc_docs_api.prototype.put_ShapesAlign;
  asc_docs_api.prototype["DistributeHorizontally"] =
    asc_docs_api.prototype.DistributeHorizontally;
  asc_docs_api.prototype["DistributeVertically"] =
    asc_docs_api.prototype.DistributeVertically;
  ...
  asc_docs_api.prototype["set_ConstProportions"] =
    asc_docs_api.prototype.set_ConstProportions;
  asc_docs_api.prototype["set_WrapStyle"] =
    asc_docs_api.prototype.set_WrapStyle;
  asc_docs_api.prototype["deleteImage"] = asc_docs_api.prototype.deleteImage;
  asc_docs_api.prototype["set_ImgDistanceFromText"] =
    asc_docs_api.prototype.set_ImgDistanceFromText;
  asc_docs_api.prototype["set_PositionOnPage"] =
    asc_docs_api.prototype.set_PositionOnPage;
  asc_docs_api.prototype["get_OriginalSizeImage"] =
    asc_docs_api.prototype.get_OriginalSizeImage;
  asc_docs_api.prototype["asc_getCropOriginalImageSize"] =
    asc_docs_api.prototype.asc_getCropOriginalImageSize;
  asc_docs_api.prototype["ShapeApply"] = asc_docs_api.prototype.ShapeApply;
  asc_docs_api.prototype["sync_AddImageCallback"] =
    asc_docs_api.prototype.sync_AddImageCallback;
  asc_docs_api.prototype["sync_ImgPropCallback"] =
    asc_docs_api.prototype.sync_ImgPropCallback;
  asc_docs_api.prototype["sync_ImgWrapStyleChangedCallback"] =
    asc_docs_api.prototype.sync_ImgWrapStyleChangedCallback;
  asc_docs_api.prototype["sync_ContextMenuCallback"] =
    asc_docs_api.prototype.sync_ContextMenuCallback;
  asc_docs_api.prototype["sync_MouseMoveStartCallback"] =
    asc_docs_api.prototype.sync_MouseMoveStartCallback;
  asc_docs_api.prototype["sync_MouseMoveEndCallback"] =
    asc_docs_api.prototype.sync_MouseMoveEndCallback;
  asc_docs_api.prototype["sync_MouseMoveCallback"] =
    asc_docs_api.prototype.sync_MouseMoveCallback;
  asc_docs_api.prototype["can_AddHyperlink"] =
    asc_docs_api.prototype.can_AddHyperlink;
  asc_docs_api.prototype["add_Hyperlink"] =
    asc_docs_api.prototype.add_Hyperlink;
  asc_docs_api.prototype["change_Hyperlink"] =
    asc_docs_api.prototype.change_Hyperlink;
  asc_docs_api.prototype["remove_Hyperlink"] =
    asc_docs_api.prototype.remove_Hyperlink;
  asc_docs_api.prototype["asc_GetHyperlinkAnchors"] =
    asc_docs_api.prototype.asc_GetHyperlinkAnchors;
  asc_docs_api.prototype["sync_HyperlinkPropCallback"] =
    asc_docs_api.prototype.sync_HyperlinkPropCallback;
  asc_docs_api.prototype["sync_HyperlinkClickCallback"] =
    asc_docs_api.prototype.sync_HyperlinkClickCallback;
  asc_docs_api.prototype["sync_CanAddHyperlinkCallback"] =
    asc_docs_api.prototype.sync_CanAddHyperlinkCallback;
  asc_docs_api.prototype["sync_DialogAddHyperlink"] =
    asc_docs_api.prototype.sync_DialogAddHyperlink;
  asc_docs_api.prototype["sync_DialogAddHyperlink"] =
    asc_docs_api.prototype.sync_DialogAddHyperlink;
  asc_docs_api.prototype["sync_SpellCheckCallback"] =
    asc_docs_api.prototype.sync_SpellCheckCallback;
  asc_docs_api.prototype["sync_SpellCheckVariantsFound"] =
    asc_docs_api.prototype.sync_SpellCheckVariantsFound;
  asc_docs_api.prototype["asc_replaceMisspelledWord"] =
    asc_docs_api.prototype.asc_replaceMisspelledWord;
  asc_docs_api.prototype["asc_ignoreMisspelledWord"] =
    asc_docs_api.prototype.asc_ignoreMisspelledWord;
  asc_docs_api.prototype["asc_spellCheckAddToDictionary"] =
    asc_docs_api.prototype.asc_spellCheckAddToDictionary;
  asc_docs_api.prototype["asc_spellCheckClearDictionary"] =
    asc_docs_api.prototype.asc_spellCheckClearDictionary;
  asc_docs_api.prototype["asc_setDefaultLanguage"] =
    asc_docs_api.prototype.asc_setDefaultLanguage;
  asc_docs_api.prototype["asc_getDefaultLanguage"] =
    asc_docs_api.prototype.asc_getDefaultLanguage;
  asc_docs_api.prototype["asc_getKeyboardLanguage"] =
    asc_docs_api.prototype.asc_getKeyboardLanguage;
  asc_docs_api.prototype["asc_getInputLanguage"] =
    asc_docs_api.prototype.asc_getInputLanguage;
  asc_docs_api.prototype["asc_setSpellCheckSettings"] =
    asc_docs_api.prototype.asc_setSpellCheckSettings;
  asc_docs_api.prototype["asc_getSpellCheckSettings"] =
    asc_docs_api.prototype.asc_getSpellCheckSettings;
  asc_docs_api.prototype["asc_setSpellCheck"] =
    asc_docs_api.prototype.asc_setSpellCheck;
  asc_docs_api.prototype["asc_showComments"] =
    asc_docs_api.prototype.asc_showComments;
  asc_docs_api.prototype["asc_hideComments"] =
    asc_docs_api.prototype.asc_hideComments;
  asc_docs_api.prototype["asc_addComment"] =
    asc_docs_api.prototype.asc_addComment;
  asc_docs_api.prototype["asc_removeComment"] =
    asc_docs_api.prototype.asc_removeComment;
  asc_docs_api.prototype["asc_changeComment"] =
    asc_docs_api.prototype.asc_changeComment;
  asc_docs_api.prototype["asc_selectComment"] =
    asc_docs_api.prototype.asc_selectComment;
  asc_docs_api.prototype["asc_showComment"] =
    asc_docs_api.prototype.asc_showComment;
  asc_docs_api.prototype["asc_GetCommentsReportByAuthors"] =
    asc_docs_api.prototype.asc_GetCommentsReportByAuthors;
  asc_docs_api.prototype["can_AddQuotedComment"] =
    asc_docs_api.prototype.can_AddQuotedComment;
  asc_docs_api.prototype["sync_RemoveComment"] =
    asc_docs_api.prototype.sync_RemoveComment;
  asc_docs_api.prototype["sync_AddComment"] =
    asc_docs_api.prototype.sync_AddComment;
  asc_docs_api.prototype["sync_ShowComment"] =
    asc_docs_api.prototype.sync_ShowComment;
  asc_docs_api.prototype["sync_HideComment"] =
    asc_docs_api.prototype.sync_HideComment;
  asc_docs_api.prototype["sync_UpdateCommentPosition"] =
    asc_docs_api.prototype.sync_UpdateCommentPosition;
  asc_docs_api.prototype["sync_ChangeCommentData"] =
    asc_docs_api.prototype.sync_ChangeCommentData;
  asc_docs_api.prototype["sync_LockComment"] =
    asc_docs_api.prototype.sync_LockComment;
  asc_docs_api.prototype["sync_UnLockComment"] =
    asc_docs_api.prototype.sync_UnLockComment;
  asc_docs_api.prototype["asc_RemoveAllComments"] =
    asc_docs_api.prototype.asc_RemoveAllComments;
  asc_docs_api.prototype["asc_ResolveAllComments"] =
    asc_docs_api.prototype.asc_ResolveAllComments;
  asc_docs_api.prototype["asc_GetCommentLogicPosition"] =
    asc_docs_api.prototype.asc_GetCommentLogicPosition;
  asc_docs_api.prototype["sync_LockHeaderFooters"] =
    asc_docs_api.prototype.sync_LockHeaderFooters;
  asc_docs_api.prototype["sync_LockDocumentProps"] =
    asc_docs_api.prototype.sync_LockDocumentProps;
  asc_docs_api.prototype["sync_UnLockHeaderFooters"] =
    asc_docs_api.prototype.sync_UnLockHeaderFooters;
  asc_docs_api.prototype["sync_UnLockDocumentProps"] =
    asc_docs_api.prototype.sync_UnLockDocumentProps;
  asc_docs_api.prototype["sync_CollaborativeChanges"] =
    asc_docs_api.prototype.sync_CollaborativeChanges;
  asc_docs_api.prototype["sync_LockDocumentSchema"] =
    asc_docs_api.prototype.sync_LockDocumentSchema;
  asc_docs_api.prototype["sync_UnLockDocumentSchema"] =
    asc_docs_api.prototype.sync_UnLockDocumentSchema;
  asc_docs_api.prototype["zoomIn"] = asc_docs_api.prototype.zoomIn;
  asc_docs_api.prototype["zoomOut"] = asc_docs_api.prototype.zoomOut;
  asc_docs_api.prototype["zoomFitToPage"] =
    asc_docs_api.prototype.zoomFitToPage;
  asc_docs_api.prototype["zoomFitToWidth"] =
    asc_docs_api.prototype.zoomFitToWidth;
  ...
  asc_docs_api.prototype["getCountPages"] =
    asc_docs_api.prototype.getCountPages;
  asc_docs_api.prototype["getCurrentPage"] =
    asc_docs_api.prototype.getCurrentPage;
  asc_docs_api.prototype["sync_countPagesCallback"] =
    asc_docs_api.prototype.sync_countPagesCallback;
  asc_docs_api.prototype["sync_currentPageCallback"] =
    asc_docs_api.prototype.sync_currentPageCallback;
  asc_docs_api.prototype["asc_enableKeyEvents"] =
    asc_docs_api.prototype.asc_enableKeyEvents;
  asc_docs_api.prototype["GenerateStyles"] =
    asc_docs_api.prototype.GenerateStyles;
  asc_docs_api.prototype["asyncFontsDocumentEndLoaded"] =
    asc_docs_api.prototype.asyncFontsDocumentEndLoaded;
  asc_docs_api.prototype["CreateFontsCharMap"] =
    asc_docs_api.prototype.CreateFontsCharMap;
  asc_docs_api.prototype["sync_SendThemeColors"] =
    asc_docs_api.prototype.sync_SendThemeColors;
  asc_docs_api.prototype["ChangeColorScheme"] =
    asc_docs_api.prototype.ChangeColorScheme;
  asc_docs_api.prototype["asc_ChangeColorSchemeByIdx"] =
    asc_docs_api.prototype.asc_ChangeColorSchemeByIdx;
  asc_docs_api.prototype["UpdateInterfaceState"] =
    asc_docs_api.prototype.UpdateInterfaceState;
  asc_docs_api.prototype["asyncFontEndLoaded"] =
    asc_docs_api.prototype.asyncFontEndLoaded;
  asc_docs_api.prototype["asyncImageEndLoaded"] =
    asc_docs_api.prototype.asyncImageEndLoaded;
  asc_docs_api.prototype["asyncImageEndLoadedBackground"] =
    asc_docs_api.prototype.asyncImageEndLoadedBackground;
  asc_docs_api.prototype["IsAsyncOpenDocumentImages"] =
    asc_docs_api.prototype.IsAsyncOpenDocumentImages;
  ...
  asc_docs_api.prototype["SyncLoadImages"] =
    asc_docs_api.prototype.SyncLoadImages;
  asc_docs_api.prototype["SyncLoadImages_callback"] =
    asc_docs_api.prototype.SyncLoadImages_callback;
  asc_docs_api.prototype["ViewScrollToX"] =
    asc_docs_api.prototype.ViewScrollToX;
  asc_docs_api.prototype["ViewScrollToY"] =
    asc_docs_api.prototype.ViewScrollToY;
  asc_docs_api.prototype["GetDocWidthPx"] =
    asc_docs_api.prototype.GetDocWidthPx;
  asc_docs_api.prototype["GetDocHeightPx"] =
    asc_docs_api.prototype.GetDocHeightPx;
  asc_docs_api.prototype["ClearSearch"] = asc_docs_api.prototype.ClearSearch;
  asc_docs_api.prototype["GetCurrentVisiblePage"] =
    asc_docs_api.prototype.GetCurrentVisiblePage;
  asc_docs_api.prototype["GetCurrentVisiblePages"] =
    asc_docs_api.prototype.GetCurrentVisiblePages;
  asc_docs_api.prototype["asc_setAutoSaveGap"] =
    asc_docs_api.prototype.asc_setAutoSaveGap;
  asc_docs_api.prototype["asc_SetDocumentPlaceChangedEnabled"] =
    asc_docs_api.prototype.asc_SetDocumentPlaceChangedEnabled;
  asc_docs_api.prototype["asc_SetViewRulers"] =
    asc_docs_api.prototype.asc_SetViewRulers;
  ...
  asc_docs_api.prototype["ExitHeader_Footer"] =
    asc_docs_api.prototype.ExitHeader_Footer;
  asc_docs_api.prototype["asc_RemoveHeader"] =
    asc_docs_api.prototype.asc_RemoveHeader;
  asc_docs_api.prototype["asc_RemoveFooter"] =
    asc_docs_api.prototype.asc_RemoveFooter;
  asc_docs_api.prototype["GetCurrentPixOffsetY"] =
    asc_docs_api.prototype.GetCurrentPixOffsetY;
  asc_docs_api.prototype["SetPaintFormat"] =
    asc_docs_api.prototype.SetPaintFormat;
  asc_docs_api.prototype["ChangeShapeType"] =
    asc_docs_api.prototype.ChangeShapeType;
  asc_docs_api.prototype["sync_PaintFormatCallback"] =
    asc_docs_api.prototype.sync_PaintFormatCallback;
  asc_docs_api.prototype["SetMarkerFormat"] =
    asc_docs_api.prototype.SetMarkerFormat;
  asc_docs_api.prototype["sync_MarkerFormatCallback"] =
    asc_docs_api.prototype.sync_MarkerFormatCallback;
  asc_docs_api.prototype["StartAddShape"] =
    asc_docs_api.prototype.StartAddShape;
  asc_docs_api.prototype["AddShapeOnCurrentPage"] =
    asc_docs_api.prototype.AddShapeOnCurrentPage;
  asc_docs_api.prototype["AddTextArt"] = asc_docs_api.prototype.AddTextArt;
  asc_docs_api.prototype["asc_canEditCrop"] =
    asc_docs_api.prototype.asc_canEditCrop;
  asc_docs_api.prototype["asc_startEditCrop"] =
    asc_docs_api.prototype.asc_startEditCrop;
  ...
  asc_docs_api.prototype["asc_GetWatermarkProps"] =
    asc_docs_api.prototype.asc_GetWatermarkProps;
  asc_docs_api.prototype["asc_SetWatermarkProps"] =
    asc_docs_api.prototype.asc_SetWatermarkProps;
  asc_docs_api.prototype["asc_WatermarkRemove"] =
    asc_docs_api.prototype.asc_WatermarkRemove;
  asc_docs_api.prototype["asc_canMergeSelectedShapes"] =
    asc_docs_api.prototype.asc_canMergeSelectedShapes;
  asc_docs_api.prototype["sync_StartAddShapeCallback"] =
    asc_docs_api.prototype.sync_StartAddShapeCallback;
  ...
  asc_docs_api.prototype["CanChangeWrapPolygon"] =
    asc_docs_api.prototype.CanChangeWrapPolygon;
  asc_docs_api.prototype["StartChangeWrapPolygon"] =
    asc_docs_api.prototype.StartChangeWrapPolygon;
  asc_docs_api.prototype["ClearFormating"] =
    asc_docs_api.prototype.ClearFormating;
  asc_docs_api.prototype["GetSectionInfo"] =
    asc_docs_api.prototype.GetSectionInfo;
  asc_docs_api.prototype["add_SectionBreak"] =
    asc_docs_api.prototype.add_SectionBreak;
  asc_docs_api.prototype["asc_GetSectionsCount"] =
    asc_docs_api.prototype.asc_GetSectionsCount;
  asc_docs_api.prototype["asc_setViewMode"] =
    asc_docs_api.prototype.asc_setViewMode;
  asc_docs_api.prototype["OnMouseUp"] = asc_docs_api.prototype.OnMouseUp;
  asc_docs_api.prototype["asyncImageEndLoaded2"] =
    asc_docs_api.prototype.asyncImageEndLoaded2;
  asc_docs_api.prototype["SetDrawImagePlaceParagraph"] =
    asc_docs_api.prototype.SetDrawImagePlaceParagraph;
  asc_docs_api.prototype["asc_getMasterCommentId"] =
    asc_docs_api.prototype.asc_getMasterCommentId;
  asc_docs_api.prototype["asc_getAnchorPosition"] =
    asc_docs_api.prototype.asc_getAnchorPosition;
  asc_docs_api.prototype["asc_createSmartArt"] =
    asc_docs_api.prototype.asc_createSmartArt;
  asc_docs_api.prototype["asc_getChartObject"] =
    asc_docs_api.prototype.asc_getChartObject;
  asc_docs_api.prototype["asc_addChartDrawingObject"] =
    asc_docs_api.prototype.asc_addChartDrawingObject;
  asc_docs_api.prototype["asc_doubleClickOnChart"] =
    asc_docs_api.prototype.asc_doubleClickOnChart;
  asc_docs_api.prototype["asc_onCloseChartFrame"] =
    asc_docs_api.prototype.asc_onCloseChartFrame;
  asc_docs_api.prototype["asc_editChartDrawingObject"] =
    asc_docs_api.prototype.asc_editChartDrawingObject;
  asc_docs_api.prototype["asc_getChartPreviews"] =
    asc_docs_api.prototype.asc_getChartPreviews;
  asc_docs_api.prototype["asc_getTextArtPreviews"] =
    asc_docs_api.prototype.asc_getTextArtPreviews;
  asc_docs_api.prototype["sync_closeOleEditor"] =
    asc_docs_api.prototype.sync_closeOleEditor;
  asc_docs_api.prototype["asc_setDrawCollaborationMarks"] =
    asc_docs_api.prototype.asc_setDrawCollaborationMarks;
  ...
  asc_docs_api.prototype["asc_ConvertMathView"] =
    asc_docs_api.prototype.asc_ConvertMathView;
  asc_docs_api.prototype["asc_AddPageCount"] =
    asc_docs_api.prototype.asc_AddPageCount;
  asc_docs_api.prototype["asc_StartMailMerge"] =
    asc_docs_api.prototype.asc_StartMailMerge;
  asc_docs_api.prototype["asc_StartMailMergeByList"] =
    asc_docs_api.prototype.asc_StartMailMergeByList;
  asc_docs_api.prototype["asc_GetReceptionsCount"] =
    asc_docs_api.prototype.asc_GetReceptionsCount;
  asc_docs_api.prototype["asc_GetMailMergeFieldsNameList"] =
    asc_docs_api.prototype.asc_GetMailMergeFieldsNameList;
  asc_docs_api.prototype["asc_AddMailMergeField"] =
    asc_docs_api.prototype.asc_AddMailMergeField;
  asc_docs_api.prototype["asc_SetHighlightMailMergeFields"] =
    asc_docs_api.prototype.asc_SetHighlightMailMergeFields;
  asc_docs_api.prototype["asc_PreviewMailMergeResult"] =
    asc_docs_api.prototype.asc_PreviewMailMergeResult;
  asc_docs_api.prototype["asc_EndPreviewMailMergeResult"] =
    asc_docs_api.prototype.asc_EndPreviewMailMergeResult;
  asc_docs_api.prototype["sync_StartMailMerge"] =
    asc_docs_api.prototype.sync_StartMailMerge;
  asc_docs_api.prototype["sync_PreviewMailMergeResult"] =
    asc_docs_api.prototype.sync_PreviewMailMergeResult;
  asc_docs_api.prototype["sync_EndPreviewMailMergeResult"] =
    asc_docs_api.prototype.sync_EndPreviewMailMergeResult;
  asc_docs_api.prototype["sync_HighlightMailMergeFields"] =
    asc_docs_api.prototype.sync_HighlightMailMergeFields;
  asc_docs_api.prototype["asc_getMailMergeData"] =
    asc_docs_api.prototype.asc_getMailMergeData;
  asc_docs_api.prototype["asc_setMailMergeData"] =
    asc_docs_api.prototype.asc_setMailMergeData;
  asc_docs_api.prototype["asc_sendMailMergeData"] =
    asc_docs_api.prototype.asc_sendMailMergeData;
  asc_docs_api.prototype["asc_GetMailMergeFiledValue"] =
    asc_docs_api.prototype.asc_GetMailMergeFiledValue;
  asc_docs_api.prototype["asc_GetStyleFromFormatting"] =
    asc_docs_api.prototype.asc_GetStyleFromFormatting;
  asc_docs_api.prototype["asc_AddNewStyle"] =
    asc_docs_api.prototype.asc_AddNewStyle;
  asc_docs_api.prototype["asc_RemoveStyle"] =
    asc_docs_api.prototype.asc_RemoveStyle;
  asc_docs_api.prototype["asc_RemoveAllCustomStyles"] =
    asc_docs_api.prototype.asc_RemoveAllCustomStyles;
  asc_docs_api.prototype["asc_IsStyleDefault"] =
    asc_docs_api.prototype.asc_IsStyleDefault;
  asc_docs_api.prototype["asc_IsDefaultStyleChanged"] =
    asc_docs_api.prototype.asc_IsDefaultStyleChanged;
  asc_docs_api.prototype["asc_GetStyleNameById"] =
    asc_docs_api.prototype.asc_GetStyleNameById;
  asc_docs_api.prototype["asc_SetTrackRevisions"] =
    asc_docs_api.prototype.asc_SetTrackRevisions;
  asc_docs_api.prototype["asc_IsTrackRevisions"] =
    asc_docs_api.prototype.asc_IsTrackRevisions;
  asc_docs_api.prototype["asc_SetLocalTrackRevisions"] =
    asc_docs_api.prototype.asc_SetLocalTrackRevisions;
  asc_docs_api.prototype["asc_GetLocalTrackRevisions"] =
    asc_docs_api.prototype.asc_GetLocalTrackRevisions;
  asc_docs_api.prototype["asc_SetGlobalTrackRevisions"] =
    asc_docs_api.prototype.asc_SetGlobalTrackRevisions;
  asc_docs_api.prototype["asc_GetGlobalTrackRevisions"] =
    asc_docs_api.prototype.asc_GetGlobalTrackRevisions;
  asc_docs_api.prototype["sync_BeginCatchRevisionsChanges"] =
    asc_docs_api.prototype.sync_BeginCatchRevisionsChanges;
  asc_docs_api.prototype["sync_EndCatchRevisionsChanges"] =
    asc_docs_api.prototype.sync_EndCatchRevisionsChanges;
  asc_docs_api.prototype["asc_GetRevisionsChangesStack"] =
    asc_docs_api.prototype.asc_GetRevisionsChangesStack;
  asc_docs_api.prototype["sync_AddRevisionsChange"] =
    asc_docs_api.prototype.sync_AddRevisionsChange;
  asc_docs_api.prototype["asc_AcceptChanges"] =
    asc_docs_api.prototype.asc_AcceptChanges;
  asc_docs_api.prototype["asc_RejectChanges"] =
    asc_docs_api.prototype.asc_RejectChanges;
  asc_docs_api.prototype["asc_AcceptChangesBySelection"] =
    asc_docs_api.prototype.asc_AcceptChangesBySelection;
  asc_docs_api.prototype["asc_RejectChangesBySelection"] =
    asc_docs_api.prototype.asc_RejectChangesBySelection;
  asc_docs_api.prototype["asc_HaveRevisionsChanges"] =
    asc_docs_api.prototype.asc_HaveRevisionsChanges;
  asc_docs_api.prototype["asc_HaveNewRevisionsChanges"] =
    asc_docs_api.prototype.asc_HaveNewRevisionsChanges;
  asc_docs_api.prototype["asc_GetNextRevisionsChange"] =
    asc_docs_api.prototype.asc_GetNextRevisionsChange;
  asc_docs_api.prototype["asc_GetPrevRevisionsChange"] =
    asc_docs_api.prototype.asc_GetPrevRevisionsChange;
  asc_docs_api.prototype["sync_UpdateRevisionsChangesPosition"] =
    asc_docs_api.prototype.sync_UpdateRevisionsChangesPosition;
  asc_docs_api.prototype["asc_AcceptAllChanges"] =
    asc_docs_api.prototype.asc_AcceptAllChanges;
  asc_docs_api.prototype["asc_RejectAllChanges"] =
    asc_docs_api.prototype.asc_RejectAllChanges;
  asc_docs_api.prototype["asc_GetTrackRevisionsReportByAuthors"] =
    asc_docs_api.prototype.asc_GetTrackRevisionsReportByAuthors;
  asc_docs_api.prototype["asc_FollowRevisionMove"] =
    asc_docs_api.prototype.asc_FollowRevisionMove;
  asc_docs_api.prototype["asc_stopSaving"] =
    asc_docs_api.prototype.asc_stopSaving;
  asc_docs_api.prototype["asc_continueSaving"] =
    asc_docs_api.prototype.asc_continueSaving;
  asc_docs_api.prototype["asc_undoAllChanges"] =
    asc_docs_api.prototype.asc_undoAllChanges;
  asc_docs_api.prototype["asc_CloseFile"] =
    asc_docs_api.prototype.asc_CloseFile;
  asc_docs_api.prototype["asc_SetFastCollaborative"] =
    asc_docs_api.prototype.asc_SetFastCollaborative;
  asc_docs_api.prototype["asc_isOffline"] =
    asc_docs_api.prototype.asc_isOffline;
  asc_docs_api.prototype["asc_getUrlType"] =
    asc_docs_api.prototype.asc_getUrlType;
  asc_docs_api.prototype["asc_prepareUrl"] =
    asc_docs_api.prototype.asc_prepareUrl;
  asc_docs_api.prototype["asc_getSessionToken"] =
    asc_docs_api.prototype.asc_getSessionToken;
  asc_docs_api.prototype["asc_setInterfaceDrawImagePlaceShape"] =
    asc_docs_api.prototype.asc_setInterfaceDrawImagePlaceShape;
  asc_docs_api.prototype["asc_pluginsRegister"] =
    asc_docs_api.prototype.asc_pluginsRegister;
  asc_docs_api.prototype["asc_pluginRun"] =
    asc_docs_api.prototype.asc_pluginRun;
  asc_docs_api.prototype["asc_pluginStop"] =
    asc_docs_api.prototype.asc_pluginStop;
  asc_docs_api.prototype["asc_pluginResize"] =
    asc_docs_api.prototype.asc_pluginResize;
  asc_docs_api.prototype["asc_pluginButtonClick"] =
    asc_docs_api.prototype.asc_pluginButtonClick;
  asc_docs_api.prototype["asc_pluginEnableMouseEvents"] =
    asc_docs_api.prototype.asc_pluginEnableMouseEvents;

  asc_docs_api.prototype["asc_nativeInitBuilder"] =
    asc_docs_api.prototype.asc_nativeInitBuilder;
  asc_docs_api.prototype["asc_SetSilentMode"] =
    asc_docs_api.prototype.asc_SetSilentMode;
  asc_docs_api.prototype["asc_startEditCurrentOleObject"] =
    asc_docs_api.prototype.asc_startEditCurrentOleObject;
  asc_docs_api.prototype["asc_doubleClickOnTableOleObject"] =
    asc_docs_api.prototype.asc_doubleClickOnTableOleObject;
  asc_docs_api.prototype["asc_editOleObjectAction"] =
    asc_docs_api.prototype.asc_editOleObjectAction;
  asc_docs_api.prototype["asc_addOleObjectAction"] =
    asc_docs_api.prototype.asc_addOleObjectAction;
  asc_docs_api.prototype["asc_InputClearKeyboardElement"] =
    asc_docs_api.prototype.asc_InputClearKeyboardElement;
  asc_docs_api.prototype["asc_SpecialPaste"] =
    asc_docs_api.prototype.asc_SpecialPaste;

  asc_docs_api.prototype["SetDrawImagePlaceContents"] =
    asc_docs_api.prototype.SetDrawImagePlaceContents;
  asc_docs_api.prototype["SetDrawImagePlaceTableOfFigures"] =
    asc_docs_api.prototype.SetDrawImagePlaceTableOfFigures;
  asc_docs_api.prototype["SetDrawImagePreviewMargins"] =
    asc_docs_api.prototype.SetDrawImagePreviewMargins;
  asc_docs_api.prototype["SetDrawImagePreviewBullet"] =
    asc_docs_api.prototype.SetDrawImagePreviewBullet;
  asc_docs_api.prototype["ConvertTextToTable"] =
    asc_docs_api.prototype.ConvertTextToTable;
  asc_docs_api.prototype["ConvertTableToText"] =
    asc_docs_api.prototype.ConvertTableToText;
  asc_docs_api.prototype["SetDrawImagePreviewBulletChangeListLevel"] =
    asc_docs_api.prototype.SetDrawImagePreviewBulletChangeListLevel;
  asc_docs_api.prototype["SetDrawImagePreviewBulletForMenu"] =
    asc_docs_api.prototype.SetDrawImagePreviewBulletForMenu;
  asc_docs_api.prototype["asc_GetPossibleNumberingLanguage"] =
    asc_docs_api.prototype.asc_GetPossibleNumberingLanguage;

  asc_docs_api.prototype["asc_AddContentControl"] =
    asc_docs_api.prototype.asc_AddContentControl;
  asc_docs_api.prototype["asc_AddContentControlCheckBox"] =
    asc_docs_api.prototype.asc_AddContentControlCheckBox;
  asc_docs_api.prototype["asc_AddContentControlPicture"] =
    asc_docs_api.prototype.asc_AddContentControlPicture;
  asc_docs_api.prototype["asc_AddContentControlList"] =
    asc_docs_api.prototype.asc_AddContentControlList;
  asc_docs_api.prototype["asc_AddContentControlDatePicker"] =
    asc_docs_api.prototype.asc_AddContentControlDatePicker;
  asc_docs_api.prototype["asc_RemoveContentControl"] =
    asc_docs_api.prototype.asc_RemoveContentControl;
  asc_docs_api.prototype["asc_RemoveContentControlWrapper"] =
    asc_docs_api.prototype.asc_RemoveContentControlWrapper;
  asc_docs_api.prototype["asc_SetContentControlProperties"] =
    asc_docs_api.prototype.asc_SetContentControlProperties;
  asc_docs_api.prototype["asc_IsContentControl"] =
    asc_docs_api.prototype.asc_IsContentControl;
  asc_docs_api.prototype["asc_GetContentControlProperties"] =
    asc_docs_api.prototype.asc_GetContentControlProperties;
  asc_docs_api.prototype["asc_GetCurrentContentControl"] =
    asc_docs_api.prototype.asc_GetCurrentContentControl;
  asc_docs_api.prototype["asc_ClearContentControl"] =
    asc_docs_api.prototype.asc_ClearContentControl;
  asc_docs_api.prototype["asc_GetContentControlRightAnchorPosition"] =
    asc_docs_api.prototype.asc_GetContentControlRightAnchorPosition;
  asc_docs_api.prototype["asc_GetContentControlBoundingRect"] =
    asc_docs_api.prototype.asc_GetContentControlBoundingRect;
  asc_docs_api.prototype["asc_UncheckContentControlButtons"] =
    asc_docs_api.prototype.asc_UncheckContentControlButtons;
  asc_docs_api.prototype["asc_SetGlobalContentControlHighlightColor"] =
    asc_docs_api.prototype.asc_SetGlobalContentControlHighlightColor;
  asc_docs_api.prototype["asc_GetGlobalContentControlHighlightColor"] =
    asc_docs_api.prototype.asc_GetGlobalContentControlHighlightColor;
  asc_docs_api.prototype["asc_SetGlobalContentControlShowHighlight"] =
    asc_docs_api.prototype.asc_SetGlobalContentControlShowHighlight;
  asc_docs_api.prototype["asc_GetGlobalContentControlShowHighlight"] =
    asc_docs_api.prototype.asc_GetGlobalContentControlShowHighlight;
  asc_docs_api.prototype["asc_SetContentControlCheckBoxPr"] =
    asc_docs_api.prototype.asc_SetContentControlCheckBoxPr;
  asc_docs_api.prototype["asc_SetContentControlCheckBoxChecked"] =
    asc_docs_api.prototype.asc_SetContentControlCheckBoxChecked;
  asc_docs_api.prototype["asc_IsContentControlCheckBoxChecked"] =
    asc_docs_api.prototype.asc_IsContentControlCheckBoxChecked;
  asc_docs_api.prototype["asc_SetContentControlPictureUrl"] =
    asc_docs_api.prototype.asc_SetContentControlPictureUrl;
  asc_docs_api.prototype["asc_SetContentControlListPr"] =
    asc_docs_api.prototype.asc_SetContentControlListPr;
  asc_docs_api.prototype["asc_SelectContentControlListItem"] =
    asc_docs_api.prototype.asc_SelectContentControlListItem;
  asc_docs_api.prototype["asc_GetContentControlListCurrentValue"] =
    asc_docs_api.prototype.asc_GetContentControlListCurrentValue;
  asc_docs_api.prototype["asc_SetContentControlDatePickerPr"] =
    asc_docs_api.prototype.asc_SetContentControlDatePickerPr;
  asc_docs_api.prototype["asc_SetContentControlDatePickerDate"] =
    asc_docs_api.prototype.asc_SetContentControlDatePickerDate;
  asc_docs_api.prototype["asc_SetContentControlTextPlaceholder"] =
    asc_docs_api.prototype.asc_SetContentControlTextPlaceholder;
  asc_docs_api.prototype["asc_SetContentControlText"] =
    asc_docs_api.prototype.asc_SetContentControlText;
  asc_docs_api.prototype["asc_GetTextFormKeys"] =
    asc_docs_api.prototype.asc_GetTextFormKeys;
  asc_docs_api.prototype["asc_GetPictureFormKeys"] =
    asc_docs_api.prototype.asc_GetPictureFormKeys;
  asc_docs_api.prototype["asc_GetCheckBoxFormKeys"] =
    asc_docs_api.prototype.asc_GetCheckBoxFormKeys;
  asc_docs_api.prototype["asc_GetRadioButtonGroupKeys"] =
    asc_docs_api.prototype.asc_GetRadioButtonGroupKeys;
  asc_docs_api.prototype["asc_GetFormKeysByType"] =
    asc_docs_api.prototype.asc_GetFormKeysByType;
  asc_docs_api.prototype["asc_ClearAllSpecialForms"] =
    asc_docs_api.prototype.asc_ClearAllSpecialForms;
  asc_docs_api.prototype["asc_SetSpecialFormsHighlightColor"] =
    asc_docs_api.prototype.asc_SetSpecialFormsHighlightColor;
  asc_docs_api.prototype["asc_GetSpecialFormsHighlightColor"] =
    asc_docs_api.prototype.asc_GetSpecialFormsHighlightColor;
  asc_docs_api.prototype["asc_SetPerformContentControlActionByClick"] =
    asc_docs_api.prototype.asc_SetPerformContentControlActionByClick;
  asc_docs_api.prototype["asc_GetTextFormAutoWidth"] =
    asc_docs_api.prototype.asc_GetTextFormAutoWidth;
  asc_docs_api.prototype["asc_GetFormsCountByKey"] =
    asc_docs_api.prototype.asc_GetFormsCountByKey;
  asc_docs_api.prototype["asc_MoveToFillingForm"] =
    asc_docs_api.prototype.asc_MoveToFillingForm;
  asc_docs_api.prototype["asc_IsAllRequiredFormsFilled"] =
    asc_docs_api.prototype.asc_IsAllRequiredFormsFilled;
  asc_docs_api.prototype["asc_SendForm"] = asc_docs_api.prototype.asc_SendForm;
  asc_docs_api.prototype["asc_SetFixedForm"] =
    asc_docs_api.prototype.asc_SetFixedForm;
  asc_docs_api.prototype["asc_IsHighlightRequiredFields"] =
    asc_docs_api.prototype.asc_IsHighlightRequiredFields;
  asc_docs_api.prototype["asc_SetHighlightRequiredFields"] =
    asc_docs_api.prototype.asc_SetHighlightRequiredFields;
  asc_docs_api.prototype["asc_GetAllFormsData"] =
    asc_docs_api.prototype.asc_GetAllFormsData;
  asc_docs_api.prototype["asc_GetOForm"] = asc_docs_api.prototype.asc_GetOForm;
  asc_docs_api.prototype["asc_DisconnectEveryone"] =
    asc_docs_api.prototype.asc_DisconnectEveryone;
  asc_docs_api.prototype["asc_CompletePreparingOForm"] =
    asc_docs_api.prototype.asc_CompletePreparingOForm;

  asc_docs_api.prototype["asc_BeginViewModeInReview"] =
    asc_docs_api.prototype.asc_BeginViewModeInReview;
  asc_docs_api.prototype["asc_EndViewModeInReview"] =
    asc_docs_api.prototype.asc_EndViewModeInReview;
  asc_docs_api.prototype["asc_SetDisplayModeInReview"] =
    asc_docs_api.prototype.asc_SetDisplayModeInReview;
  asc_docs_api.prototype["asc_GetDisplayModeInReview"] =
    asc_docs_api.prototype.asc_GetDisplayModeInReview;

  asc_docs_api.prototype["asc_GetDocumentOutlineManager"] =
    asc_docs_api.prototype.asc_GetDocumentOutlineManager;
  asc_docs_api.prototype["asc_ShowDocumentOutline"] =
    asc_docs_api.prototype.asc_ShowDocumentOutline;
  asc_docs_api.prototype["asc_HideDocumentOutline"] =
    asc_docs_api.prototype.asc_HideDocumentOutline;
  asc_docs_api.prototype["sync_OnDocumentOutlineUpdate"] =
    asc_docs_api.prototype.sync_OnDocumentOutlineUpdate;
  asc_docs_api.prototype["sync_OnDocumentOutlineCurrentPosition"] =
    asc_docs_api.prototype.sync_OnDocumentOutlineCurrentPosition;

  asc_docs_api.prototype["asc_AddTableOfContents"] =
    asc_docs_api.prototype.asc_AddTableOfContents;
  asc_docs_api.prototype["asc_RemoveTableOfContents"] =
    asc_docs_api.prototype.asc_RemoveTableOfContents;
  asc_docs_api.prototype["asc_GetTableOfContentsPr"] =
    asc_docs_api.prototype.asc_GetTableOfContentsPr;
  asc_docs_api.prototype["asc_SetTableOfContentsPr"] =
    asc_docs_api.prototype.asc_SetTableOfContentsPr;
  asc_docs_api.prototype["asc_UpdateTableOfContents"] =
    asc_docs_api.prototype.asc_UpdateTableOfContents;
  asc_docs_api.prototype["asc_AddParagraphToTOC"] =
    asc_docs_api.prototype.asc_AddParagraphToTOC;
  asc_docs_api.prototype["asc_GetCurrentLevelTOC"] =
    asc_docs_api.prototype.asc_GetCurrentLevelTOC;

  asc_docs_api.prototype["asc_getAllUsedParagraphStyles"] =
    asc_docs_api.prototype.asc_getAllUsedParagraphStyles;
  asc_docs_api.prototype["asc_CanUpdateTablesOfFigures"] =
    asc_docs_api.prototype.asc_CanUpdateTablesOfFigures;
  asc_docs_api.prototype["asc_UpdateTablesOfFigures"] =
    asc_docs_api.prototype.asc_UpdateTablesOfFigures;
  asc_docs_api.prototype["asc_AddTableOfFigures"] =
    asc_docs_api.prototype.asc_AddTableOfFigures;
  asc_docs_api.prototype["asc_GetTableOfFiguresPr"] =
    asc_docs_api.prototype.asc_GetTableOfFiguresPr;

  asc_docs_api.prototype["asc_AddComplexFieldWithInstruction"] =
    asc_docs_api.prototype.asc_AddComplexFieldWithInstruction;
  asc_docs_api.prototype["asc_GetComplexFieldInstruction"] =
    asc_docs_api.prototype.asc_GetComplexFieldInstruction;
  asc_docs_api.prototype["asc_EditComplexFieldInstruction"] =
    asc_docs_api.prototype.asc_EditComplexFieldInstruction;
  asc_docs_api.prototype["asc_GetCurrentComplexField"] =
    asc_docs_api.prototype.asc_GetCurrentComplexField;
  asc_docs_api.prototype["asc_UpdateComplexField"] =
    asc_docs_api.prototype.asc_UpdateComplexField;
  asc_docs_api.prototype["asc_RemoveComplexField"] =
    asc_docs_api.prototype.asc_RemoveComplexField;
  asc_docs_api.prototype["asc_SetComplexFieldPr"] =
    asc_docs_api.prototype.asc_SetComplexFieldPr;
  asc_docs_api.prototype["asc_AddTableFormula"] =
    asc_docs_api.prototype.asc_AddTableFormula;
  asc_docs_api.prototype["asc_GetTableFormula"] =
    asc_docs_api.prototype.asc_GetTableFormula;
  asc_docs_api.prototype["asc_GetTableFormulaFormats"] =
    asc_docs_api.prototype.asc_GetTableFormulaFormats;
  asc_docs_api.prototype["asc_ParseTableFormulaInstrLine"] =
    asc_docs_api.prototype.asc_ParseTableFormulaInstrLine;
  asc_docs_api.prototype["asc_CreateInstructionLine"] =
    asc_docs_api.prototype.asc_CreateInstructionLine;
  ...
  asc_docs_api.prototype["asc_addDateTime"] =
    asc_docs_api.prototype.asc_addDateTime;

  asc_docs_api.prototype["asc_AddObjectCaption"] =
    asc_docs_api.prototype.asc_AddObjectCaption;

  asc_docs_api.prototype["asc_GetBookmarksManager"] =
    asc_docs_api.prototype.asc_GetBookmarksManager;
  asc_docs_api.prototype["asc_OnBookmarksUpdate"] =
    asc_docs_api.prototype.asc_OnBookmarksUpdate;

  asc_docs_api.prototype["asc_GetHeadingLevel"] =
    asc_docs_api.prototype.asc_GetHeadingLevel;
  asc_docs_api.prototype["asc_GetStylesArray"] =
    asc_docs_api.prototype.asc_GetStylesArray;

  asc_docs_api.prototype["asc_SetAutomaticBulletedLists"] =
    asc_docs_api.prototype.asc_SetAutomaticBulletedLists;
  asc_docs_api.prototype["asc_SetAutomaticNumberedLists"] =
    asc_docs_api.prototype.asc_SetAutomaticNumberedLists;
  asc_docs_api.prototype["asc_SetAutoCorrectSmartQuotes"] =
    asc_docs_api.prototype.asc_SetAutoCorrectSmartQuotes;
  asc_docs_api.prototype["asc_SetAutoCorrectHyphensWithDash"] =
    asc_docs_api.prototype.asc_SetAutoCorrectHyphensWithDash;
  asc_docs_api.prototype["asc_SetAutoCorrectFirstLetterOfSentences"] =
    asc_docs_api.prototype.asc_SetAutoCorrectFirstLetterOfSentences;
  asc_docs_api.prototype["asc_SetAutoCorrectHyperlinks"] =
    asc_docs_api.prototype.asc_SetAutoCorrectHyperlinks;
  asc_docs_api.prototype["asc_SetAutoCorrectFirstLetterOfCells"] =
    asc_docs_api.prototype.asc_SetAutoCorrectFirstLetterOfCells;
  asc_docs_api.prototype["asc_SetAutoCorrectDoubleSpaceWithPeriod"] =
    asc_docs_api.prototype.asc_SetAutoCorrectDoubleSpaceWithPeriod;

  asc_docs_api.prototype["asc_SetFirstLetterAutoCorrectExceptions"] =
    asc_docs_api.prototype.asc_SetFirstLetterAutoCorrectExceptions;
  ...
  asc_docs_api.prototype["asc_RemoveSelection"] =
    asc_docs_api.prototype.asc_RemoveSelection;
  asc_docs_api.prototype["asc_AddText"] = asc_docs_api.prototype.asc_AddText;
  asc_docs_api.prototype["asc_GetCurrentWord"] =
    asc_docs_api.prototype.asc_GetCurrentWord;
  asc_docs_api.prototype["asc_ReplaceCurrentWord"] =
    asc_docs_api.prototype.asc_ReplaceCurrentWord;
  asc_docs_api.prototype["asc_GetSelectedText"] =
    asc_docs_api.prototype.asc_GetSelectedText;
  asc_docs_api.prototype["asc_AddBlankPage"] =
    asc_docs_api.prototype.asc_AddBlankPage;
  asc_docs_api.prototype["asc_EditSelectAll"] =
    asc_docs_api.prototype.asc_EditSelectAll;
  ...
  asc_docs_api.prototype["asc_ConvertEquationToMath"] =
    asc_docs_api.prototype.asc_ConvertEquationToMath;
  asc_docs_api.prototype["asc_ConvertMathDisplayMode"] =
    asc_docs_api.prototype.asc_ConvertMathDisplayMode;
  asc_docs_api.prototype["asc_IsInlineMath"] =
    asc_docs_api.prototype.asc_IsInlineMath;
  asc_docs_api.prototype["asc_AddMathML"] =
    asc_docs_api.prototype.asc_AddMathML;

  //cross-references
  asc_docs_api.prototype["asc_GetAllNumberedParagraphs"] =
    asc_docs_api.prototype.asc_GetAllNumberedParagraphs;
  asc_docs_api.prototype["asc_AddCrossRefToParagraph"] =
    asc_docs_api.prototype.asc_AddCrossRefToParagraph;
  asc_docs_api.prototype["asc_GetAllHeadingParagraphs"] =
    asc_docs_api.prototype.asc_GetAllHeadingParagraphs;
  asc_docs_api.prototype["asc_AddCrossRefToBookmark"] =
    asc_docs_api.prototype.asc_AddCrossRefToBookmark;
  asc_docs_api.prototype["asc_GetAllFootNoteParagraphs"] =
    asc_docs_api.prototype.asc_GetAllFootNoteParagraphs;
  asc_docs_api.prototype["asc_AddCrossRefToNote"] =
    asc_docs_api.prototype.asc_AddCrossRefToNote;
  asc_docs_api.prototype["asc_GetAllEndNoteParagraphs"] =
    asc_docs_api.prototype.asc_GetAllEndNoteParagraphs;
  asc_docs_api.prototype["asc_GetAllCaptionParagraphs"] =
    asc_docs_api.prototype.asc_GetAllCaptionParagraphs;
  asc_docs_api.prototype["asc_AddCrossRefToCaption"] =
    asc_docs_api.prototype.asc_AddCrossRefToCaption;

  asc_docs_api.prototype["asc_ChangeTextCase"] =
    asc_docs_api.prototype.asc_ChangeTextCase;
  asc_docs_api.prototype["asc_putSmartParagraphSelection"] =
    asc_docs_api.prototype.asc_SetSmartParagraphSelection;
  asc_docs_api.prototype["asc_isSmartParagraphSelection"] =
    asc_docs_api.prototype.asc_IsSmartParagraphSelection;

  asc_docs_api.prototype["SetTableDrawMode"] =
    asc_docs_api.prototype.SetTableDrawMode;
  asc_docs_api.prototype["SetTableEraseMode"] =
    asc_docs_api.prototype.SetTableEraseMode;

  asc_docs_api.prototype["asc_PreConvertTextToTable"] =
    asc_docs_api.prototype.asc_PreConvertTextToTable;
  asc_docs_api.prototype["asc_ConvertTextToTable"] =
    asc_docs_api.prototype.asc_ConvertTextToTable;
  asc_docs_api.prototype["asc_ConvertTableToText"] =
    asc_docs_api.prototype.asc_ConvertTableToText;

  asc_docs_api.prototype["asc_GetSelectionBounds"] =
    asc_docs_api.prototype.asc_GetSelectionBounds;

  // mobile
  asc_docs_api.prototype["asc_GetDefaultTableStyles"] =
    asc_docs_api.prototype.asc_GetDefaultTableStyles;
  asc_docs_api.prototype["asc_Remove"] = asc_docs_api.prototype.asc_Remove;
  asc_docs_api.prototype["asc_OnHideContextMenu"] =
    asc_docs_api.prototype.asc_OnHideContextMenu;
  asc_docs_api.prototype["asc_OnShowContextMenu"] =
    asc_docs_api.prototype.asc_OnShowContextMenu;

  // signatures
  asc_docs_api.prototype["asc_addSignatureLine"] =
    asc_docs_api.prototype.asc_addSignatureLine;
  asc_docs_api.prototype["asc_CallSignatureDblClickEvent"] =
    asc_docs_api.prototype.asc_CallSignatureDblClickEvent;
  asc_docs_api.prototype["asc_getRequestSignatures"] =
    asc_docs_api.prototype.asc_getRequestSignatures;
  asc_docs_api.prototype["asc_AddSignatureLine2"] =
    asc_docs_api.prototype.asc_AddSignatureLine2;
  asc_docs_api.prototype["asc_Sign"] = asc_docs_api.prototype.asc_Sign;
  asc_docs_api.prototype["asc_RequestSign"] =
    asc_docs_api.prototype.asc_RequestSign;
  asc_docs_api.prototype["asc_ViewCertificate"] =
    asc_docs_api.prototype.asc_ViewCertificate;
  asc_docs_api.prototype["asc_SelectCertificate"] =
    asc_docs_api.prototype.asc_SelectCertificate;
  asc_docs_api.prototype["asc_GetDefaultCertificate"] =
    asc_docs_api.prototype.asc_GetDefaultCertificate;
  asc_docs_api.prototype["asc_getSignatures"] =
    asc_docs_api.prototype.asc_getSignatures;
  asc_docs_api.prototype["asc_isSignaturesSupport"] =
    asc_docs_api.prototype.asc_isSignaturesSupport;
  asc_docs_api.prototype["asc_isProtectionSupport"] =
    asc_docs_api.prototype.asc_isProtectionSupport;
  asc_docs_api.prototype["asc_isAnonymousSupport"] =
    asc_docs_api.prototype.asc_isAnonymousSupport;
  asc_docs_api.prototype["asc_RemoveSignature"] =
    asc_docs_api.prototype.asc_RemoveSignature;
  asc_docs_api.prototype["asc_RemoveAllSignatures"] =
    asc_docs_api.prototype.asc_RemoveAllSignatures;
  asc_docs_api.prototype["asc_gotoSignature"] =
    asc_docs_api.prototype.asc_gotoSignature;
  asc_docs_api.prototype["asc_getSignatureSetup"] =
    asc_docs_api.prototype.asc_getSignatureSetup;

  // view modes
  asc_docs_api.prototype["asc_setContentDarkMode"] =
    asc_docs_api.prototype.asc_setContentDarkMode;

  //comparison
  asc_docs_api.prototype["asc_CompareDocumentUrl"] =
    asc_docs_api.prototype.asc_CompareDocumentUrl;
  asc_docs_api.prototype["asc_CompareDocumentFile"] =
    asc_docs_api.prototype.asc_CompareDocumentFile;
  asc_docs_api.prototype["asc_CompareDocumentUrl_local"] =
    asc_docs_api.prototype.asc_CompareDocumentUrl_local;
  asc_docs_api.prototype["asc_CompareDocumentFile_local"] =
    asc_docs_api.prototype.asc_CompareDocumentFile_local;

  //merge
  asc_docs_api.prototype["asc_MergeDocumentUrl"] =
    asc_docs_api.prototype.asc_MergeDocumentUrl;
  asc_docs_api.prototype["asc_MergeDocumentFile"] =
    asc_docs_api.prototype.asc_MergeDocumentFile;
  asc_docs_api.prototype["asc_MergeDocumentUrl_local"] =
    asc_docs_api.prototype.asc_MergeDocumentUrl_local;
  asc_docs_api.prototype["asc_MergeDocumentFile_local"] =
    asc_docs_api.prototype.asc_MergeDocumentFile_local;
  ...
  asc_docs_api.prototype["asc_getTableStylesPreviews"] =
    asc_docs_api.prototype.asc_getTableStylesPreviews;
  asc_docs_api.prototype["asc_generateTableStylesPreviews"] =
    asc_docs_api.prototype.asc_generateTableStylesPreviews;
  asc_docs_api.prototype["asc_getDocumentProtection"] =
    asc_docs_api.prototype.asc_getDocumentProtection;
  asc_docs_api.prototype["asc_setDocumentProtection"] =
    asc_docs_api.prototype.asc_setDocumentProtection;

  // print-preview
  asc_docs_api.prototype["asc_initPrintPreview"] =
    asc_docs_api.prototype.asc_initPrintPreview;
  asc_docs_api.prototype["asc_drawPrintPreview"] =
    asc_docs_api.prototype.asc_drawPrintPreview;
  asc_docs_api.prototype["asc_closePrintPreview"] =
    asc_docs_api.prototype.asc_closePrintPreview;
  asc_docs_api.prototype["asc_getPageSize"] =
    asc_docs_api.prototype.asc_getPageSize;

  // auto hyphenation
  asc_docs_api.prototype["asc_setAutoHyphenation"] =
    asc_docs_api.prototype.asc_setAutoHyphenation;
  asc_docs_api.prototype["asc_isAutoHyphenation"] =
    asc_docs_api.prototype.asc_isAutoHyphenation;
  asc_docs_api.prototype["asc_setHyphenateCaps"] =
    asc_docs_api.prototype.asc_setHyphenateCaps;
  asc_docs_api.prototype["asc_isHyphenateCaps"] =
    asc_docs_api.prototype.asc_isHyphenateCaps;
  asc_docs_api.prototype["asc_setConsecutiveHyphenLimit"] =
    asc_docs_api.prototype.asc_setConsecutiveHyphenLimit;
  asc_docs_api.prototype["asc_getConsecutiveHyphenLimit"] =
    asc_docs_api.prototype.asc_getConsecutiveHyphenLimit;
  asc_docs_api.prototype["asc_setAutoHyphenationSettings"] =
    asc_docs_api.prototype.asc_setAutoHyphenationSettings;
  asc_docs_api.prototype["asc_getAutoHyphenationSettings"] =
    asc_docs_api.prototype.asc_getAutoHyphenationSettings;

  asc_docs_api.prototype["asc_putPageColor"] =
    asc_docs_api.prototype.asc_putPageColor;
  asc_docs_api.prototype["asc_getPageColor"] =
    asc_docs_api.prototype.asc_getPageColor;

  asc_docs_api.prototype["asc_insertTextFromFile"] =
    asc_docs_api.prototype.asc_insertTextFromFile;
  asc_docs_api.prototype["asc_insertTextFromUrl"] =
    asc_docs_api.prototype.asc_insertTextFromUrl;

  asc_docs_api.prototype["asc_showDeletedTextInVersionHistory"] =
    asc_docs_api.prototype.asc_showDeletedTextInVersionHistory;
  ...
  asc_docs_api.prototype["asc_setNumeralType"] =
    asc_docs_api.prototype.asc_setNumeralType;
  asc_docs_api.prototype["asc_getNumeralType"] =
    asc_docs_api.prototype.asc_getNumeralType;

  CDocInfoProp.prototype["get_PageCount"] =
    CDocInfoProp.prototype.get_PageCount;
  CDocInfoProp.prototype["put_PageCount"] =
    CDocInfoProp.prototype.put_PageCount;
  CDocInfoProp.prototype["get_WordsCount"] =
    CDocInfoProp.prototype.get_WordsCount;
  CDocInfoProp.prototype["put_WordsCount"] =
    CDocInfoProp.prototype.put_WordsCount;
  CDocInfoProp.prototype["get_ParagraphCount"] =
    CDocInfoProp.prototype.get_ParagraphCount;
  CDocInfoProp.prototype["put_ParagraphCount"] =
    CDocInfoProp.prototype.put_ParagraphCount;
  CDocInfoProp.prototype["get_SymbolsCount"] =
    CDocInfoProp.prototype.get_SymbolsCount;
  CDocInfoProp.prototype["put_SymbolsCount"] =
    CDocInfoProp.prototype.put_SymbolsCount;
  CDocInfoProp.prototype["get_SymbolsWSCount"] =
    CDocInfoProp.prototype.get_SymbolsWSCount;
  CDocInfoProp.prototype["put_SymbolsWSCount"] =
    CDocInfoProp.prototype.put_SymbolsWSCount;
  ...
  CContextMenuData.prototype["get_PageNum"] =
    CContextMenuData.prototype.get_PageNum;
  CContextMenuData.prototype["is_Header"] =
    CContextMenuData.prototype.is_Header;
  window["Asc"]["asc_CCommentDataWord"] = window["Asc"].asc_CCommentDataWord =
    asc_CCommentDataWord;
  asc_CCommentDataWord.prototype["asc_getText"] =
    asc_CCommentDataWord.prototype.asc_getText;
  asc_CCommentDataWord.prototype["asc_putText"] =
    asc_CCommentDataWord.prototype.asc_putText;
  asc_CCommentDataWord.prototype["asc_getTime"] =
    asc_CCommentDataWord.prototype.asc_getTime;
  asc_CCommentDataWord.prototype["asc_putTime"] =
    asc_CCommentDataWord.prototype.asc_putTime;
  asc_CCommentDataWord.prototype["asc_getOnlyOfficeTime"] =
    asc_CCommentDataWord.prototype.asc_getOnlyOfficeTime;
  asc_CCommentDataWord.prototype["asc_putOnlyOfficeTime"] =
    asc_CCommentDataWord.prototype.asc_putOnlyOfficeTime;
  asc_CCommentDataWord.prototype["asc_getUserId"] =
    asc_CCommentDataWord.prototype.asc_getUserId;
  asc_CCommentDataWord.prototype["asc_putUserId"] =
    asc_CCommentDataWord.prototype.asc_putUserId;
  asc_CCommentDataWord.prototype["asc_getProviderId"] =
    asc_CCommentDataWord.prototype.asc_getProviderId;
  asc_CCommentDataWord.prototype["asc_putProviderId"] =
    asc_CCommentDataWord.prototype.asc_putProviderId;
  asc_CCommentDataWord.prototype["asc_getUserName"] =
    asc_CCommentDataWord.prototype.asc_getUserName;
  asc_CCommentDataWord.prototype["asc_putUserName"] =
    asc_CCommentDataWord.prototype.asc_putUserName;
  asc_CCommentDataWord.prototype["asc_getInitials"] =
    asc_CCommentDataWord.prototype.asc_getInitials;
  asc_CCommentDataWord.prototype["asc_putInitials"] =
    asc_CCommentDataWord.prototype.asc_putInitials;
  asc_CCommentDataWord.prototype["asc_getQuoteText"] =
    asc_CCommentDataWord.prototype.asc_getQuoteText;
  asc_CCommentDataWord.prototype["asc_putQuoteText"] =
    asc_CCommentDataWord.prototype.asc_putQuoteText;
  asc_CCommentDataWord.prototype["asc_getSolved"] =
    asc_CCommentDataWord.prototype.asc_getSolved;
  asc_CCommentDataWord.prototype["asc_putSolved"] =
    asc_CCommentDataWord.prototype.asc_putSolved;
  asc_CCommentDataWord.prototype["asc_getGuid"] =
    asc_CCommentDataWord.prototype.asc_getGuid;
  asc_CCommentDataWord.prototype["asc_putGuid"] =
    asc_CCommentDataWord.prototype.asc_putGuid;
  asc_CCommentDataWord.prototype["asc_getReply"] =
    asc_CCommentDataWord.prototype.asc_getReply;
  asc_CCommentDataWord.prototype["asc_addReply"] =
    asc_CCommentDataWord.prototype.asc_addReply;
  asc_CCommentDataWord.prototype["asc_getRepliesCount"] =
    asc_CCommentDataWord.prototype.asc_getRepliesCount;
  asc_CCommentDataWord.prototype["asc_getDocumentFlag"] =
    asc_CCommentDataWord.prototype.asc_getDocumentFlag;
  asc_CCommentDataWord.prototype["asc_putDocumentFlag"] =
    asc_CCommentDataWord.prototype.asc_putDocumentFlag;
  asc_CCommentDataWord.prototype["asc_getUserData"] =
    asc_CCommentDataWord.prototype.asc_getUserData;
  asc_CCommentDataWord.prototype["asc_putUserData"] =
    asc_CCommentDataWord.prototype.asc_putUserData;
  ...
  AscCommon.setUpAllFonts = function () {
    ...
    function logFont(font, name) {
      ...
      if (!face.os2 || face.os2.version == 0xffff) return;
      ...
      if (
        !isTypo &&
        face.height != face.os2.usWinAscent + face.os2.usWinDescent
      ) {
        console.log("[" + face.family_name + "] win");
        console.log(face.ascender + ", " + face.descender + ", " + face.height);
        console.log(
          face.os2.usWinAscent +
            ", " +
            face.os2.usWinDescent +
            ", " +
            (face.os2.usWinAscent + face.os2.usWinDescent)
        );
      }
    }
    ...
    editor.asyncMethodCallback = function () {
      testFontsInterval = setInterval(function () {
        ...
        if (_info.indexR != -1) {
          ...
          var pFontFile = AscCommon.g_fontManager.LoadFont(
            fontfile,
            _info.faceIndexR,
            12,
            false,
