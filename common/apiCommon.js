...
function (window, undefined) {
	...
	asc_CFormatCellsInfo.prototype.asc_setCalendarType = function (val) {
		this.calendarType = val;
	};
	asc_CFormatCellsInfo.prototype.asc_setCurrentEra = function (val) {
		this.inputSelectedCalendar = val;
	};
	...
	asc_CFormatCellsInfo.prototype.asc_getCurrentEra = function () {
		return this.inputSelectedCalendar;
	};
	asc_CFormatCellsInfo.prototype.asc_getCalendarType = function () {
