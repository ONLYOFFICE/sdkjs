...
(function(window)
{
	...
	// 1. FlushGrapheme - main function that MUST be implemented in the derived class
	// 2. Shape - simple function for text shaping
	// 3. GetFontInfo - get font information at the time of grapheme composition
	// 4. GetCodePoint - this function is needed so that the buffer can store not the unicode itself, but a class containing it
	...
	CTextShaper.prototype.FlushWord = function()
	{
		...
		// This means the font was substituted, restore the renderer state
