...
var EditorSkins = {
	"theme-light" : {
		...
		AnimPaneControlOutline              : "#2A2A2A",
		AnimPaneControlOutlineActive        : "#ADADAD",
		AnimPaneControlOutlineHovered       : "#CFCFCF",
		AnimPaneItemFillSelected            : "#ADADAD",
		AnimPaneItemFillHovered             : "#999999",
		AnimPaneButtonFill                  : null,
		AnimPaneButtonFillActive            : "#CCCCCC",
...
function updateGlobalSkinColors(theme)
{
	...
	var colorMap = {
		...
		AnimPaneBackground                  : "anim-pane-background",
		AnimPaneControlFill                 : "anim-pane-control-fill",
		AnimPaneControlFillActive           : "anim-pane-control-fill-active",
		AnimPaneControlFillHovered          : "anim-pane-control-fill-hovered",
		AnimPaneControlOutline              : "anim-pane-control-outline",
		AnimPaneControlOutlineActive        : "anim-pane-control-outline-active",
		AnimPaneControlOutlineHovered       : "anim-pane-control-outline-hovered",
		AnimPaneItemFillSelected            : "anim-pane-item-fill-selected",
		AnimPaneItemFillHovered             : "anim-pane-item-fill-hovered",
		AnimPaneButtonFill                  : "anim-pane-button-fill",
		AnimPaneButtonFillActive            : "anim-pane-button-fill-active",
		AnimPaneButtonFillHovered           : "anim-pane-button-fill-hovered",
		AnimPaneButtonFillDisabled          : "anim-pane-button-fill-disabled",
		AnimPanePlayButtonFill              : "anim-pane-play-button-fill",
		AnimPanePlayButtonOutline           : "anim-pane-play-button-outline",
		AnimPaneEffectBarFillEntrance       : "anim-pane-effect-bar-entrance",
		AnimPaneEffectBarOutlineEntrance    : "anim-pane-effect-bar-entrance",
		AnimPaneEffectBarFillEmphasis       : "anim-pane-effect-bar-emphasis",
		AnimPaneEffectBarOutlineEmphasis    : "anim-pane-effect-bar-emphasis",
		AnimPaneEffectBarFillExit           : "anim-pane-effect-bar-exit-fill",
		AnimPaneEffectBarOutlineExit        : "anim-pane-effect-bar-exit-outline",
		AnimPaneEffectBarFillPath           : "anim-pane-effect-bar-path-fill",
		AnimPaneEffectBarOutlinePath        : "anim-pane-effect-bar-path-outline",
		AnimPaneTimelineRulerOutline        : "anim-pane-timeline-ruler-outline",
		AnimPaneTimelineRulerTick           : "anim-pane-timeline-ruler-tick",
		AnimPaneTimelineScrollerFill        : "anim-pane-timeline-scroller",
		AnimPaneTimelineScrollerOutline     : "anim-pane-timeline-scroller-outline",
		AnimPaneTimelineScrollerFillActive  : "anim-pane-timeline-scroller-active",
		AnimPaneTimelineScrollerFillHovered : "anim-pane-timeline-scroller-hovered",
