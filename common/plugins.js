...
(function(window, undefined)
{
	...
	function onMessage(event, channel, isObj)
	{
		...
		else if ("lockMouse" == name) {
			window.g_asc_plugins.isLockMouse = value;
		}
	}
