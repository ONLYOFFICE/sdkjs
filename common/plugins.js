...
(function(window, undefined)
{
	...
	CPluginsManager.prototype =
	{
		...
		onExternalMouseMove : function(e)
		{
			var runObject = this.runnedPluginsMap[this.lockMouseGuid];
			...
			var obj = {
				...
				movementY : (e.movementY / coef)
			};
			runObject.startData.setAttribute("data", obj);
			...
			if (_iframe)
			{
				runObject.startData.setAttribute("guid", this.lockMouseGuid);
				_iframe.contentWindow.postMessage(runObject.startData.serialize(), "*");
			}
		},
