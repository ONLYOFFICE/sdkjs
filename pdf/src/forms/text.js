...
(function(){
    ...
    function CGIDWriter(memory) {
        AscCommon.CGraphicsBase.call(this, AscCommon.RendererType.PDF, true);
        this.m_oTransform = new AscCommon.CMatrix();
        this.Memory = memory;
    }
    CGIDWriter.prototype = Object.create(AscCommon.CGraphicsBase.prototype);
	CGIDWriter.prototype.constructor = CGIDWriter;

    CGIDWriter.prototype.tg = function(gid, x, y, codePoints) {
        this.Memory.WriteLong(gid);
        let count = codePoints ? codePoints.length : 0;
	...
	window["AscPDF"].CGIDWriter                            = CGIDWriter;
})();
